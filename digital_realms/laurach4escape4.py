...
def show_intro():
    screen.fill(BLACK)
    intro_lines = [
        "Welcome to Quantum Tunnel Chase!",
        "You are Laura, piloting a CH4 drone.",
        "Avoid falling qubits and defeat enemy drones.",
        "Rescue Caterina from the ion trap to earn points.",
        f"Win by defeating {TARGET_DRONES} drones and rescuing {TARGET_CATERINA} Caterinas.",
...
while not game_over and not victory:
    ...
    # Aggiorna qubits e controlla Caterina
    frame_count += 1
