...
caterina_timer = 300  # Tempo limite per raggiungerla
...
def draw_caterina():
    if caterina_spawned:
        ...
        pygame.draw.circle(screen, WHITE, caterina_position, caterina_radius + 5, 2)  # Effetto trappola

# Funzione per controllare la collisione con Caterina
def check_caterina_collision():
    global caterina_spawned, score, caterina_timer
