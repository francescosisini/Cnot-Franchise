...
voxels += generate_line((23, 17, 1), (0, 1, 0), 30, "ff0000")

voxels += generate_line((23, 1, 2), (0, 1, 0), 13, "ff0000")
voxels += generate_line((23, 17, 2), (0, 1, 0), 30, "ff0000")

voxels += generate_line((23, 1, 3), (0, 1, 0), 13, "ff0000")
voxels += generate_line((23, 17, 3), (0, 1, 0), 30, "ff0000")

voxels += generate_line((23, 1, 4), (0, 1, 0), 13, "ff0000")
voxels += generate_line((23, 17, 4), (0, 1, 0), 30, "ff0000")

voxels += generate_line((23, 1, 5), (0, 1, 0), 13, "ff0000")
voxels += generate_line((23, 17, 5), (0, 1, 0), 30, "ff0000")

voxels += generate_line((23, 1, 6), (0, 1, 0), 13, "ff0000")
voxels += generate_line((23, 17, 6), (0, 1, 0), 30, "ff0000")
