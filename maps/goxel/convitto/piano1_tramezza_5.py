...
# Due porte
voxels += generate_line((56, 1, 1), (0, 1, 0), 26, "ff0000")
voxels += generate_line((56, 30, 1), (0, 1, 0), 8, "ff0000")
voxels += generate_line((56, 40, 1), (0, 1, 0), 7, "ff0000")



voxels += generate_line((56, 1, 2), (0, 1, 0), 26, "ff0000")
voxels += generate_line((56, 30, 2), (0, 1, 0), 8, "ff0000")
voxels += generate_line((56, 40, 2), (0, 1, 0), 7, "ff0000")


voxels += generate_line((56, 1, 3), (0, 1, 0), 26, "ff0000")
voxels += generate_line((56, 30, 3), (0, 1, 0), 8, "ff0000")
voxels += generate_line((56, 40, 3), (0, 1, 0), 7, "ff0000")


voxels += generate_line((56, 1, 4), (0, 1, 0), 26, "ff0000")
voxels += generate_line((56, 30, 4), (0, 1, 0), 8, "ff0000")
voxels += generate_line((56, 40, 4), (0, 1, 0), 7, "ff0000")


voxels += generate_line((56, 1, 5), (0, 1, 0), 26, "ff0000")
voxels += generate_line((56, 30, 5), (0, 1, 0), 8, "ff0000")
voxels += generate_line((56, 40, 5), (0, 1, 0), 7, "ff0000")

voxels += generate_line((56, 1, 6), (0, 1, 0), 26, "ff0000")
voxels += generate_line((56, 30, 6), (0, 1, 0), 8, "ff0000")
voxels += generate_line((56, 40, 6), (0, 1, 0), 7, "ff0000")


voxels += generate_line((56, 1, 6), (0, 1, 0), 46, "ff0000")
voxels += generate_line((56, 1, 7), (0, 1, 0), 46, "ff0000")
voxels += generate_line((56, 1, 8), (0, 1, 0), 46, "ff0000")
voxels += generate_line((56, 1, 9), (0, 1, 0), 46, "ff0000")
voxels += generate_line((56, 1, 10), (0, 1, 0), 46, "ff0000")
...
# salva il file
output_file = "piano1_tramezza_5.txt"
