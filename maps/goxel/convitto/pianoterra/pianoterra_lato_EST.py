...
voxels += generate_line((79, 0, 1), (0, 1, 0), 48, "ff0000")
voxels += generate_line((79, 0, 2), (0, 1, 0), 48, "ff0000")
voxels += generate_line((79, 0, 3), (0, 1, 0), 48, "ff0000")
voxels += generate_line((79, 0, 4), (0, 1, 0), 48, "ff0000")
voxels += generate_line((79, 0, 5), (0, 1, 0), 48, "ff0000")
voxels += generate_line((79, 0, 6), (0, 1, 0), 48, "ff0000")

#Finestre
#1
voxels += generate_line((79, 0, 7), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 6, 7), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 12, 7), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 18, 7), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 24, 7), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 30, 7), (0, 1, 0), 12, "ff0000")
voxels += generate_line((79, 44, 7), (0, 1, 0), 4, "ff0000")
#2
voxels += generate_line((79, 0, 8), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 6, 8), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 12, 8), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 18, 8), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 24, 8), (0, 1, 0), 4, "ff0000")
voxels += generate_line((79, 30, 8), (0, 1, 0), 12, "ff0000")
voxels += generate_line((79, 44, 8), (0, 1, 0), 4, "ff0000")
# linea e rettangolo di prima (per confronto)
voxels += generate_line((79, 0, 9), (0, 1, 0), 48, "ff0000")
voxels += generate_line((79, 0, 10), (0, 1, 0), 48, "ff0000")
...
# salva il file
output_file = "pianoterra_EST.txt"
