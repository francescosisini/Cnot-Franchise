...
voxels = []
# Due porte
voxels += generate_line((23, 32, 1), (-1, 0, 0), 3, "ff0000")
voxels += generate_line((17, 32, 1), (-1, 0, 0), 17, "ff0000")

voxels += generate_line((23, 32, 2), (-1, 0, 0), 3, "ff0000")
voxels += generate_line((17, 32, 2), (-1, 0, 0), 17, "ff0000")

voxels += generate_line((23, 32, 3), (-1, 0, 0), 3, "ff0000")
voxels += generate_line((17, 32, 3), (-1, 0, 0), 17, "ff0000")

voxels += generate_line((23, 32, 4), (-1, 0, 0), 3, "ff0000")
voxels += generate_line((17, 32, 4), (-1, 0, 0), 17, "ff0000")

voxels += generate_line((23, 32, 5), (-1, 0, 0), 3, "ff0000")
voxels += generate_line((17, 32, 5), (-1, 0, 0), 17, "ff0000")

voxels += generate_line((23, 32, 6), (-1, 0, 0), 23, "ff0000")
voxels += generate_line((23, 32, 7), (-1, 0, 0), 23, "ff0000")
voxels += generate_line((23, 32, 8), (-1, 0, 0), 23, "ff0000")
voxels += generate_line((23, 32, 9), (-1, 0, 0), 23, "ff0000")
voxels += generate_line((23, 32, 10), (-1, 0, 0), 23, "ff0000")
...
# salva il file
output_file = "piano1_tramezza_10.txt"
