...
voxels = []
#Bagno Femmine
voxels += generate_line((34, 36, 1), (1, 0, 0), 5, "ffffaa")
voxels += generate_line((34, 37, 2), (1, 0, 0), 5, "ffffaa")
voxels += generate_line((34, 38, 3), (1, 0, 0), 5, "ffbbaa")
voxels += generate_line((34, 39, 4), (1, 0, 0), 5, "ffbbaa")
voxels += generate_line((34, 40, 5), (1, 0, 0), 5, "ffbaa")
voxels += generate_line((34, 41, 6), (1, 0, 0), 5, "ffbaa")
voxels += generate_line((34, 42, 7), (1, 0, 0), 5, "ffbaa")
voxels += generate_line((34, 43, 8), (1, 0, 0), 5, "ffbaa")
voxels += generate_line((34, 44, 9), (1, 0, 0), 5, "ffbaa")
voxels += generate_line((34, 45, 10), (1, 0, 0), 12, "ffbaa")
voxels += generate_line((34, 46, 10), (1, 0, 0), 12, "ffbaa")
voxels += generate_line((34, 47, 10), (1, 0, 0), 12, "ffbaa")

#muro scale

voxels += generate_rectangle((39,37,1), (0,1,0), (0,0,1), 8, 10, "aabbff")
