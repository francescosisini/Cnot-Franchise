...
voxels += generate_rectangle((0,0,11), (1,0,0), (0,1,0), 34, 48, "00bbff")
voxels += generate_rectangle((34,0,11), (1,0,0), (0,1,0), 12, 34, "00bbff")
voxels += generate_rectangle((46,0,11), (1,0,0), (0,1,0), 34, 48, "00bbff")
...
# salva il file
output_file = "piano1_pavimento.txt"
