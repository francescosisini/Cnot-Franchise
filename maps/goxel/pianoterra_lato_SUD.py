...
voxels = []
# Due porte
voxels += generate_line((0, 0, 1), (1, 0, 0), 37, "ff0000")
voxels += generate_line((43, 0, 1), (1, 0, 0), 37, "ff0000")

voxels += generate_line((0, 0, 2), (1, 0, 0), 37, "ff0000")
voxels += generate_line((43, 0, 2), (1, 0, 0), 37, "ff0000")

voxels += generate_line((0, 0, 3), (1, 0, 0), 37, "ff0000")
voxels += generate_line((43, 0, 3), (1, 0, 0), 37, "ff0000")

voxels += generate_line((0, 0, 4), (1, 0, 0), 37, "ff0000")
voxels += generate_line((43, 0, 4), (1, 0, 0), 37, "ff0000")

voxels += generate_line((0, 0, 5), (1, 0, 0), 37, "ff0000")
voxels += generate_line((43, 0, 5), (1, 0, 0), 37, "ff0000")

voxels += generate_line((0, 0, 6), (1, 0, 0), 80, "ff0000")
voxels += generate_line((0, 0, 7), (1, 0, 0), 80, "ff0000")
voxels += generate_line((0, 0, 8), (1, 0, 0), 80, "ff0000")
voxels += generate_line((0, 0, 9), (1, 0, 0), 80, "ff0000")
voxels += generate_line((0, 0, 10), (1, 0, 0), 80, "ff0000")
...
# salva il file
output_file = "pianoterra_SUD.txt"
