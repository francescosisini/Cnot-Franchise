...
var format_casa_caterina_0 = new ol.format.GeoJSON();
var features_casa_caterina_0 = format_casa_caterina_0.readFeatures(json_casa_caterina_0, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_casa_caterina_0 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_casa_caterina_0.addFeatures(features_casa_caterina_0);
var lyr_casa_caterina_0 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_casa_caterina_0, 
                style: style_casa_caterina_0,
                popuplayertitle: 'casa_caterina',
                interactive: true,
                title: '<img src="styles/legend/casa_caterina_0.png" /> casa_caterina'
            });
...
var format_tiny_laura_2 = new ol.format.GeoJSON();
var features_tiny_laura_2 = format_tiny_laura_2.readFeatures(json_tiny_laura_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_tiny_laura_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tiny_laura_2.addFeatures(features_tiny_laura_2);
var lyr_tiny_laura_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tiny_laura_2, 
                style: style_tiny_laura_2,
                popuplayertitle: 'tiny_laura',
                interactive: true,
                title: '<img src="styles/legend/tiny_laura_2.png" /> tiny_laura'
            });
...
var format_stanza_Alicetiny_laura_4 = new ol.format.GeoJSON();
var features_stanza_Alicetiny_laura_4 = format_stanza_Alicetiny_laura_4.readFeatures(json_stanza_Alicetiny_laura_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_stanza_Alicetiny_laura_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_stanza_Alicetiny_laura_4.addFeatures(features_stanza_Alicetiny_laura_4);
var lyr_stanza_Alicetiny_laura_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_stanza_Alicetiny_laura_4, 
                style: style_stanza_Alicetiny_laura_4,
                popuplayertitle: 'stanza_Alice — tiny_laura',
                interactive: true,
                title: '<img src="styles/legend/stanza_Alicetiny_laura_4.png" /> stanza_Alice — tiny_laura'
            });
var format_stanza_Alicetiny_laura_5 = new ol.format.GeoJSON();
var features_stanza_Alicetiny_laura_5 = format_stanza_Alicetiny_laura_5.readFeatures(json_stanza_Alicetiny_laura_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_stanza_Alicetiny_laura_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_stanza_Alicetiny_laura_5.addFeatures(features_stanza_Alicetiny_laura_5);
var lyr_stanza_Alicetiny_laura_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_stanza_Alicetiny_laura_5, 
                style: style_stanza_Alicetiny_laura_5,
                popuplayertitle: 'stanza_Alice — tiny_laura',
                interactive: true,
                title: '<img src="styles/legend/stanza_Alicetiny_laura_5.png" /> stanza_Alice — tiny_laura'
            });
var format_legacy_infrastructure_2050_6 = new ol.format.GeoJSON();
var features_legacy_infrastructure_2050_6 = format_legacy_infrastructure_2050_6.readFeatures(json_legacy_infrastructure_2050_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_legacy_infrastructure_2050_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_legacy_infrastructure_2050_6.addFeatures(features_legacy_infrastructure_2050_6);
var lyr_legacy_infrastructure_2050_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_legacy_infrastructure_2050_6, 
                style: style_legacy_infrastructure_2050_6,
                popuplayertitle: 'legacy_infrastructure_2050',
                interactive: true,
                title: '<img src="styles/legend/legacy_infrastructure_2050_6.png" /> legacy_infrastructure_2050'
            });
var format_cnot17_events_7 = new ol.format.GeoJSON();
var features_cnot17_events_7 = format_cnot17_events_7.readFeatures(json_cnot17_events_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnot17_events_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnot17_events_7.addFeatures(features_cnot17_events_7);
var lyr_cnot17_events_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnot17_events_7, 
                style: style_cnot17_events_7,
                popuplayertitle: 'cnot17_events',
                interactive: true,
                title: '<img src="styles/legend/cnot17_events_7.png" /> cnot17_events'
            });
var format_visa_data_flows_8 = new ol.format.GeoJSON();
var features_visa_data_flows_8 = format_visa_data_flows_8.readFeatures(json_visa_data_flows_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_visa_data_flows_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_visa_data_flows_8.addFeatures(features_visa_data_flows_8);
var lyr_visa_data_flows_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_visa_data_flows_8, 
                style: style_visa_data_flows_8,
                popuplayertitle: 'visa_data_flows',
                interactive: true,
                title: '<img src="styles/legend/visa_data_flows_8.png" /> visa_data_flows'
            });
var format_building_9 = new ol.format.GeoJSON();
var features_building_9 = format_building_9.readFeatures(json_building_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_building_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_building_9.addFeatures(features_building_9);
var lyr_building_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_building_9, 
                style: style_building_9,
                popuplayertitle: 'building',
                interactive: true,
                title: '<img src="styles/legend/building_9.png" /> building'
            });
var format_cnotscuole_10 = new ol.format.GeoJSON();
var features_cnotscuole_10 = format_cnotscuole_10.readFeatures(json_cnotscuole_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotscuole_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotscuole_10.addFeatures(features_cnotscuole_10);
var lyr_cnotscuole_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotscuole_10, 
                style: style_cnotscuole_10,
                popuplayertitle: 'cnot — scuole',
                interactive: true,
                title: '<img src="styles/legend/cnotscuole_10.png" /> cnot — scuole'
            });
var format_convitto_base_localConvittoCardinalMoraesempiobase_11 = new ol.format.GeoJSON();
var features_convitto_base_localConvittoCardinalMoraesempiobase_11 = format_convitto_base_localConvittoCardinalMoraesempiobase_11.readFeatures(json_convitto_base_localConvittoCardinalMoraesempiobase_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_11.addFeatures(features_convitto_base_localConvittoCardinalMoraesempiobase_11);
var lyr_convitto_base_localConvittoCardinalMoraesempiobase_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_11, 
                style: style_convitto_base_localConvittoCardinalMoraesempiobase_11,
                popuplayertitle: 'convitto_base_local — Convitto Cardinal Mora - esempio base',
                interactive: true,
                title: '<img src="styles/legend/convitto_base_localConvittoCardinalMoraesempiobase_11.png" /> convitto_base_local — Convitto Cardinal Mora - esempio base'
            });
...
var format_cnotstrade_1_13 = new ol.format.GeoJSON();
var features_cnotstrade_1_13 = format_cnotstrade_1_13.readFeatures(json_cnotstrade_1_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_1_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_1_13.addFeatures(features_cnotstrade_1_13);
var lyr_cnotstrade_1_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_1_13, 
                style: style_cnotstrade_1_13,
                popuplayertitle: 'cnot — strade_1',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_1_13.png" /> cnot — strade_1'
            });
var format_cnotbuilding_14 = new ol.format.GeoJSON();
var features_cnotbuilding_14 = format_cnotbuilding_14.readFeatures(json_cnotbuilding_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotbuilding_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotbuilding_14.addFeatures(features_cnotbuilding_14);
var lyr_cnotbuilding_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotbuilding_14, 
                style: style_cnotbuilding_14,
                popuplayertitle: 'cnot — building',
                interactive: true,
                title: '<img src="styles/legend/cnotbuilding_14.png" /> cnot — building'
            });
var format_cnotstrade_2_15 = new ol.format.GeoJSON();
var features_cnotstrade_2_15 = format_cnotstrade_2_15.readFeatures(json_cnotstrade_2_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_2_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_2_15.addFeatures(features_cnotstrade_2_15);
var lyr_cnotstrade_2_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_2_15, 
                style: style_cnotstrade_2_15,
                popuplayertitle: 'cnot — strade_2',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_2_15.png" /> cnot — strade_2'
            });
var format_highway_16 = new ol.format.GeoJSON();
var features_highway_16 = format_highway_16.readFeatures(json_highway_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_highway_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_highway_16.addFeatures(features_highway_16);
var lyr_highway_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_highway_16, 
                style: style_highway_16,
                popuplayertitle: 'highway',
                interactive: true,
                title: '<img src="styles/legend/highway_16.png" /> highway'
            });
...
var format_cnotEdifici_21 = new ol.format.GeoJSON();
var features_cnotEdifici_21 = format_cnotEdifici_21.readFeatures(json_cnotEdifici_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotEdifici_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotEdifici_21.addFeatures(features_cnotEdifici_21);
var lyr_cnotEdifici_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotEdifici_21, 
                style: style_cnotEdifici_21,
                popuplayertitle: 'cnot — Edifici',
                interactive: true,
                title: '<img src="styles/legend/cnotEdifici_21.png" /> cnot — Edifici'
            });
var format_Telecamere_22 = new ol.format.GeoJSON();
var features_Telecamere_22 = format_Telecamere_22.readFeatures(json_Telecamere_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Telecamere_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Telecamere_22.addFeatures(features_Telecamere_22);
var lyr_Telecamere_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Telecamere_22, 
                style: style_Telecamere_22,
                popuplayertitle: 'Telecamere',
                interactive: true,
                title: '<img src="styles/legend/Telecamere_22.png" /> Telecamere'
            });
var format_Semafori_23 = new ol.format.GeoJSON();
var features_Semafori_23 = format_Semafori_23.readFeatures(json_Semafori_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Semafori_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Semafori_23.addFeatures(features_Semafori_23);
var lyr_Semafori_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Semafori_23, 
                style: style_Semafori_23,
                popuplayertitle: 'Semafori',
                interactive: true,
                title: '<img src="styles/legend/Semafori_23.png" /> Semafori'
            });
var format_cnotTinyhouses_24 = new ol.format.GeoJSON();
var features_cnotTinyhouses_24 = format_cnotTinyhouses_24.readFeatures(json_cnotTinyhouses_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotTinyhouses_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotTinyhouses_24.addFeatures(features_cnotTinyhouses_24);
var lyr_cnotTinyhouses_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotTinyhouses_24, 
                style: style_cnotTinyhouses_24,
                popuplayertitle: 'cnot — Tiny houses',
                interactive: true,
                title: '<img src="styles/legend/cnotTinyhouses_24.png" /> cnot — Tiny houses'
            });
var format_cnotparcheggiodroni_25 = new ol.format.GeoJSON();
var features_cnotparcheggiodroni_25 = format_cnotparcheggiodroni_25.readFeatures(json_cnotparcheggiodroni_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotparcheggiodroni_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotparcheggiodroni_25.addFeatures(features_cnotparcheggiodroni_25);
var lyr_cnotparcheggiodroni_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotparcheggiodroni_25, 
                style: style_cnotparcheggiodroni_25,
                popuplayertitle: 'cnot — parcheggio droni',
                interactive: true,
                title: '<img src="styles/legend/cnotparcheggiodroni_25.png" /> cnot — parcheggio droni'
            });
var format_cnoteurope_26 = new ol.format.GeoJSON();
var features_cnoteurope_26 = format_cnoteurope_26.readFeatures(json_cnoteurope_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnoteurope_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnoteurope_26.addFeatures(features_cnoteurope_26);
var lyr_cnoteurope_26 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnoteurope_26, 
                style: style_cnoteurope_26,
                popuplayertitle: 'cnot — europe',
                interactive: true,
                title: '<img src="styles/legend/cnoteurope_26.png" /> cnot — europe'
            });
...
var group_tinyhouses = new ol.layer.Group({
                                layers: [lyr_cnotTinyhouses_24,lyr_cnotparcheggiodroni_25,],
                                fold: 'open',
                                title: 'tiny houses'});
var group_Sorveglianza = new ol.layer.Group({
                                layers: [lyr_Telecamere_22,lyr_Semafori_23,],
                                fold: 'close',
                                title: 'Sorveglianza'});
var group_Zonadimenticata = new ol.layer.Group({
                                layers: [lyr_cnotEdifici_21,],
                                fold: 'close',
                                title: 'Zona dimenticata'});
var group_Topografia = new ol.layer.Group({
                                layers: [lyr_cnotstrade_1_13,lyr_cnotbuilding_14,lyr_cnotstrade_2_15,lyr_highway_16,lyr_highway_17,lyr_highway_18,lyr_building_19,lyr_building_20,],
                                fold: 'open',
                                title: 'Topografia'});
var group_Strutture_dismesse = new ol.layer.Group({
                                layers: [lyr_cnotscuole_10,lyr_convitto_base_localConvittoCardinalMoraesempiobase_11,lyr_convitto_base_localConvittoCardinalMoraesempiobase_12,],
                                fold: 'open',
                                title: 'Strutture_dismesse'});
var group_Narrativa = new ol.layer.Group({
                                layers: [lyr_building_9,],
                                fold: 'open',
                                title: 'Narrativa'});
var group_TimelineCNOT17 = new ol.layer.Group({
                                layers: [lyr_legacy_infrastructure_2050_6,lyr_cnot17_events_7,lyr_visa_data_flows_8,],
                                fold: 'open',
                                title: 'Timeline CNOT 1.7'});
var group_casepersonaggi = new ol.layer.Group({
                                layers: [lyr_casa_caterina_0,lyr_casa_caterina_1,lyr_tiny_laura_2,lyr_tiny_laura_3,lyr_stanza_Alicetiny_laura_4,lyr_stanza_Alicetiny_laura_5,],
                                fold: 'open',
                                title: 'case personaggi'});

lyr_casa_caterina_0.setVisible(true);lyr_casa_caterina_1.setVisible(true);lyr_tiny_laura_2.setVisible(true);lyr_tiny_laura_3.setVisible(true);lyr_stanza_Alicetiny_laura_4.setVisible(true);lyr_stanza_Alicetiny_laura_5.setVisible(true);lyr_legacy_infrastructure_2050_6.setVisible(true);lyr_cnot17_events_7.setVisible(true);lyr_visa_data_flows_8.setVisible(true);lyr_building_9.setVisible(true);lyr_cnotscuole_10.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_11.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_12.setVisible(true);lyr_cnotstrade_1_13.setVisible(true);lyr_cnotbuilding_14.setVisible(true);lyr_cnotstrade_2_15.setVisible(true);lyr_highway_16.setVisible(true);lyr_highway_17.setVisible(true);lyr_highway_18.setVisible(true);lyr_building_19.setVisible(true);lyr_building_20.setVisible(true);lyr_cnotEdifici_21.setVisible(true);lyr_Telecamere_22.setVisible(true);lyr_Semafori_23.setVisible(true);lyr_cnotTinyhouses_24.setVisible(true);lyr_cnotparcheggiodroni_25.setVisible(true);lyr_cnoteurope_26.setVisible(true);
var layersList = [group_casepersonaggi,group_TimelineCNOT17,group_Narrativa,group_Strutture_dismesse,group_Topografia,group_Zonadimenticata,group_Sorveglianza,group_tinyhouses,lyr_cnoteurope_26];
lyr_casa_caterina_0.set('fieldAliases', {'label': 'label', 'segmento': 'segmento', 'tipo': 'tipo', 'universo': 'universo', 'descrizione': 'descrizione', 'show_label': 'show_label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', });
...
lyr_tiny_laura_2.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'show_label': 'show_label', });
...
lyr_stanza_Alicetiny_laura_4.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'show_label': 'show_label', });
lyr_stanza_Alicetiny_laura_5.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'show_label': 'show_label', });
lyr_legacy_infrastructure_2050_6.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'stato': 'stato', 'proprietario': 'proprietario', 'livello_rischio': 'livello_rischio', 'funzione_narrativa': 'funzione_narrativa', 'note': 'note', 'anno_obsolescenza': 'anno_obsolescenza', 'anno_origine': 'anno_origine', });
lyr_cnot17_events_7.set('fieldAliases', {'fid': 'fid', 'event_id': 'event_id', 'titolo': 'titolo', 'timestamp_story': 'timestamp_story', 'capitolo': 'capitolo', 'luogo': 'luogo', 'personaggi': 'personaggi', 'tipo_evento': 'tipo_evento', 'oggetto_coinvolto': 'oggetto_coinvolto', 'stato_prima': 'stato_prima', 'stato_dopo': 'stato_dopo', 'conseguenza': 'conseguenza', 'visibile_al_lettore': 'visibile_al_lettore', 'note': 'note', 'artifact_json': 'artifact_json', });
lyr_visa_data_flows_8.set('fieldAliases', {'fid': 'fid', 'flow_id': 'flow_id', 'nome': 'nome', 'origine': 'origine', 'destinazione': 'destinazione', 'timestamp_story': 'timestamp_story', 'protocollo_narrativo': 'protocollo_narrativo', 'criticita': 'criticita', 'stato': 'stato', 'funzione_narrativa': 'funzione_narrativa', 'Note': 'Note', });
lyr_building_9.set('fieldAliases', {});
lyr_cnotscuole_10.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'amenity': 'amenity', 'roof:colour': 'roof:colour', 'addr:housename': 'addr:housename', 'barrier': 'barrier', 'religion': 'religion', 'grades': 'grades', 'wheelchair': 'wheelchair', 'toilets:wheelchair': 'toilets:wheelchair', 'name_1': 'name_1', 'website': 'website', 'roof:levels': 'roof:levels', 'addr:postcode': 'addr:postcode', 'isced:level': 'isced:level', 'addr:hamlet': 'addr:hamlet', 'addr:street': 'addr:street', 'addr:housenumber': 'addr:housenumber', 'addr:city': 'addr:city', 'name:etymology:wikidata': 'name:etymology:wikidata', 'wikidata': 'wikidata', 'roof:shape': 'roof:shape', 'roof:material': 'roof:material', 'operator:type': 'operator:type', 'height': 'height', 'building:material': 'building:material', 'building:levels': 'building:levels', 'type': 'type', 'name': 'name', 'education': 'education', 'building': 'building', });
lyr_convitto_base_localConvittoCardinalMoraesempiobase_11.set('fieldAliases', {'nome': 'nome', 'tipo': 'tipo', 'piano': 'piano', 'funzione': 'funzione', 'spatial_url': 'spatial_url', 'url_label': 'url_label', 'note': 'note', });
...
lyr_tiny_laura_2.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'show_label': 'CheckBox', });
...
lyr_stanza_Alicetiny_laura_4.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'show_label': 'CheckBox', });
lyr_stanza_Alicetiny_laura_5.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'show_label': 'CheckBox', });
lyr_legacy_infrastructure_2050_6.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'stato': 'TextEdit', 'proprietario': 'TextEdit', 'livello_rischio': 'TextEdit', 'funzione_narrativa': 'TextEdit', 'note': 'TextEdit', 'anno_obsolescenza': 'Range', 'anno_origine': 'Range', });
lyr_cnot17_events_7.set('fieldImages', {'fid': '', 'event_id': '', 'titolo': '', 'timestamp_story': '', 'capitolo': '', 'luogo': '', 'personaggi': '', 'tipo_evento': '', 'oggetto_coinvolto': '', 'stato_prima': '', 'stato_dopo': '', 'conseguenza': '', 'visibile_al_lettore': '', 'note': '', 'artifact_json': '', });
lyr_visa_data_flows_8.set('fieldImages', {'fid': 'TextEdit', 'flow_id': 'TextEdit', 'nome': 'TextEdit', 'origine': 'TextEdit', 'destinazione': 'TextEdit', 'timestamp_story': 'TextEdit', 'protocollo_narrativo': 'TextEdit', 'criticita': 'TextEdit', 'stato': 'TextEdit', 'funzione_narrativa': 'TextEdit', 'Note': 'TextEdit', });
lyr_building_9.set('fieldImages', {});
lyr_cnotscuole_10.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'amenity': '', 'roof:colour': '', 'addr:housename': '', 'barrier': '', 'religion': '', 'grades': '', 'wheelchair': '', 'toilets:wheelchair': '', 'name_1': '', 'website': '', 'roof:levels': '', 'addr:postcode': '', 'isced:level': '', 'addr:hamlet': '', 'addr:street': '', 'addr:housenumber': '', 'addr:city': '', 'name:etymology:wikidata': '', 'wikidata': '', 'roof:shape': '', 'roof:material': '', 'operator:type': '', 'height': '', 'building:material': '', 'building:levels': '', 'type': '', 'name': '', 'education': '', 'building': '', });
lyr_convitto_base_localConvittoCardinalMoraesempiobase_11.set('fieldImages', {'nome': 'TextEdit', 'tipo': 'TextEdit', 'piano': 'Range', 'funzione': 'TextEdit', 'spatial_url': 'TextEdit', 'url_label': 'TextEdit', 'note': 'TextEdit', });
...
lyr_tiny_laura_2.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'show_label': 'no label', });
...
lyr_stanza_Alicetiny_laura_4.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'show_label': 'no label', });
lyr_stanza_Alicetiny_laura_5.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'show_label': 'no label', });
lyr_legacy_infrastructure_2050_6.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'nome': 'no label', 'tipo': 'no label', 'stato': 'no label', 'proprietario': 'no label', 'livello_rischio': 'no label', 'funzione_narrativa': 'no label', 'note': 'no label', 'anno_obsolescenza': 'no label', 'anno_origine': 'no label', });
lyr_cnot17_events_7.set('fieldLabels', {'fid': 'no label', 'event_id': 'no label', 'titolo': 'no label', 'timestamp_story': 'no label', 'capitolo': 'no label', 'luogo': 'no label', 'personaggi': 'no label', 'tipo_evento': 'no label', 'oggetto_coinvolto': 'no label', 'stato_prima': 'no label', 'stato_dopo': 'no label', 'conseguenza': 'no label', 'visibile_al_lettore': 'no label', 'note': 'no label', 'artifact_json': 'no label', });
lyr_visa_data_flows_8.set('fieldLabels', {'fid': 'no label', 'flow_id': 'no label', 'nome': 'no label', 'origine': 'no label', 'destinazione': 'no label', 'timestamp_story': 'no label', 'protocollo_narrativo': 'no label', 'criticita': 'no label', 'stato': 'no label', 'funzione_narrativa': 'no label', 'Note': 'no label', });
lyr_building_9.set('fieldLabels', {});
lyr_cnotscuole_10.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'amenity': 'no label', 'roof:colour': 'no label', 'addr:housename': 'no label', 'barrier': 'no label', 'religion': 'no label', 'grades': 'no label', 'wheelchair': 'no label', 'toilets:wheelchair': 'no label', 'name_1': 'no label', 'website': 'no label', 'roof:levels': 'no label', 'addr:postcode': 'no label', 'isced:level': 'no label', 'addr:hamlet': 'no label', 'addr:street': 'no label', 'addr:housenumber': 'no label', 'addr:city': 'no label', 'name:etymology:wikidata': 'no label', 'wikidata': 'no label', 'roof:shape': 'no label', 'roof:material': 'no label', 'operator:type': 'no label', 'height': 'no label', 'building:material': 'no label', 'building:levels': 'no label', 'type': 'no label', 'name': 'no label', 'education': 'no label', 'building': 'no label', });
lyr_convitto_base_localConvittoCardinalMoraesempiobase_11.set('fieldLabels', {'nome': 'no label', 'tipo': 'no label', 'piano': 'no label', 'funzione': 'no label', 'spatial_url': 'no label', 'url_label': 'no label', 'note': 'no label', });
