...
var format_ai_compute_relations_72 = new ol.format.GeoJSON();
var features_ai_compute_relations_72 = format_ai_compute_relations_72.readFeatures(json_ai_compute_relations_72, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_compute_relations_72 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_compute_relations_72.addFeatures(features_ai_compute_relations_72);
var lyr_ai_compute_relations_72 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_compute_relations_72, 
                style: style_ai_compute_relations_72,
                popuplayertitle: 'ai_compute_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_compute_relations_72.png" /> ai_compute_relations'
            });
var format_ai_supercomputers_73 = new ol.format.GeoJSON();
var features_ai_supercomputers_73 = format_ai_supercomputers_73.readFeatures(json_ai_supercomputers_73, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_supercomputers_73 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_supercomputers_73.addFeatures(features_ai_supercomputers_73);
var lyr_ai_supercomputers_73 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_supercomputers_73, 
                style: style_ai_supercomputers_73,
                popuplayertitle: 'ai_supercomputers',
                interactive: true,
                title: '<img src="styles/legend/ai_supercomputers_73.png" /> ai_supercomputers'
            });
var format_ai_relations_74 = new ol.format.GeoJSON();
var features_ai_relations_74 = format_ai_relations_74.readFeatures(json_ai_relations_74, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_relations_74 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_relations_74.addFeatures(features_ai_relations_74);
var lyr_ai_relations_74 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_relations_74, 
                style: style_ai_relations_74,
                popuplayertitle: 'ai_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_relations_74.png" /> ai_relations'
            });
var format_ai_factories_75 = new ol.format.GeoJSON();
var features_ai_factories_75 = format_ai_factories_75.readFeatures(json_ai_factories_75, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_factories_75 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_factories_75.addFeatures(features_ai_factories_75);
var lyr_ai_factories_75 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_factories_75, 
                style: style_ai_factories_75,
                popuplayertitle: 'ai_factories',
                interactive: true,
                title: '<img src="styles/legend/ai_factories_75.png" /> ai_factories'
            });
var format_ai_actors_76 = new ol.format.GeoJSON();
var features_ai_actors_76 = format_ai_actors_76.readFeatures(json_ai_actors_76, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_actors_76 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_actors_76.addFeatures(features_ai_actors_76);
var lyr_ai_actors_76 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_actors_76, 
                style: style_ai_actors_76,
                popuplayertitle: 'ai_actors',
                interactive: true,
    title: 'ai_actors<br />\
    <img src="styles/legend/ai_actors_76_0.png" /> <br />\
    <img src="styles/legend/ai_actors_76_1.png" /> ai_hpc_integration<br />\
    <img src="styles/legend/ai_actors_76_2.png" /> ai_policy_regulation<br />\
    <img src="styles/legend/ai_actors_76_3.png" /> hpc_ai_infrastructure<br />' });
var format_qt_relations_77 = new ol.format.GeoJSON();
var features_qt_relations_77 = format_qt_relations_77.readFeatures(json_qt_relations_77, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_relations_77 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_relations_77.addFeatures(features_qt_relations_77);
var lyr_qt_relations_77 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_relations_77, 
                style: style_qt_relations_77,
                popuplayertitle: 'qt_relations',
                interactive: true,
    title: 'qt_relations<br />\
    <img src="styles/legend/qt_relations_77_0.png" /> component_supplier_for<br />\
    <img src="styles/legend/qt_relations_77_1.png" /> hosts<br />\
    <img src="styles/legend/qt_relations_77_2.png" /> hosts_or_operates<br />\
    <img src="styles/legend/qt_relations_77_3.png" /> supplier_of<br />\
    <img src="styles/legend/qt_relations_77_4.png" /> <br />' });
var format_qt_infrastructures_78 = new ol.format.GeoJSON();
var features_qt_infrastructures_78 = format_qt_infrastructures_78.readFeatures(json_qt_infrastructures_78, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_infrastructures_78 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_infrastructures_78.addFeatures(features_qt_infrastructures_78);
var lyr_qt_infrastructures_78 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_infrastructures_78, 
                style: style_qt_infrastructures_78,
                popuplayertitle: 'qt_infrastructures',
                interactive: true,
    title: 'qt_infrastructures<br />\
    <img src="styles/legend/qt_infrastructures_78_0.png" /> 12 - 21,6<br />\
    <img src="styles/legend/qt_infrastructures_78_1.png" /> 21,6 - 24,8<br />\
    <img src="styles/legend/qt_infrastructures_78_2.png" /> 24,8 - 63,2<br />\
    <img src="styles/legend/qt_infrastructures_78_3.png" /> 63,2 - 100<br />\
    <img src="styles/legend/qt_infrastructures_78_4.png" /> 100 - 140<br />' });
var format_qt_actors_79 = new ol.format.GeoJSON();
var features_qt_actors_79 = format_qt_actors_79.readFeatures(json_qt_actors_79, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_actors_79 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_actors_79.addFeatures(features_qt_actors_79);
var lyr_qt_actors_79 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_actors_79, 
                style: style_qt_actors_79,
                popuplayertitle: 'qt_actors',
                interactive: true,
    title: 'qt_actors<br />\
    <img src="styles/legend/qt_actors_79_0.png" /> company<br />\
    <img src="styles/legend/qt_actors_79_1.png" /> european_public_institution<br />\
    <img src="styles/legend/qt_actors_79_2.png" /> european_research_initiative<br />\
    <img src="styles/legend/qt_actors_79_3.png" /> hpc_research_center<br />\
    <img src="styles/legend/qt_actors_79_4.png" /> national_consortium<br />\
    <img src="styles/legend/qt_actors_79_5.png" /> <br />' });
var format_datacenter_80 = new ol.format.GeoJSON();
var features_datacenter_80 = format_datacenter_80.readFeatures(json_datacenter_80, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_datacenter_80 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_datacenter_80.addFeatures(features_datacenter_80);
var lyr_datacenter_80 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_datacenter_80, 
                style: style_datacenter_80,
                popuplayertitle: 'datacenter',
                interactive: true,
                title: '<img src="styles/legend/datacenter_80.png" /> datacenter'
            });
...
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_80,],
                                fold: 'open',
                                title: '01_DATI_INFRASTRUTTURA_DIGITALE'});
var group_quantum = new ol.layer.Group({
                                layers: [lyr_qt_relations_77,lyr_qt_infrastructures_78,lyr_qt_actors_79,],
                                fold: 'close',
                                title: 'quantum'});
var group_AI = new ol.layer.Group({
                                layers: [lyr_ai_relations_74,lyr_ai_factories_75,lyr_ai_actors_76,],
                                fold: 'close',
                                title: 'AI'});
var group_Supercomputer = new ol.layer.Group({
                                layers: [lyr_ai_compute_relations_72,lyr_ai_supercomputers_73,],
                                fold: 'close',
                                title: 'Supercomputer'});
...
lyr_ai_compute_relations_72.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_ai_supercomputers_73.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'country': 'country', 'city': 'city', 'host_entity': 'host_entity', 'linked_ai_factory_ids': 'linked_ai_factory_ids', 'linked_ai_factories': 'linked_ai_factories', 'system_role': 'system_role', 'system_class': 'system_class', 'status': 'status', 'sustained_pf': 'sustained_pf', 'peak_pf': 'peak_pf', 'ai_peak_pf': 'ai_peak_pf', 'accelerator_or_gpu': 'accelerator_or_gpu', 'cpu': 'cpu', 'storage': 'storage', 'supplier': 'supplier', 'applications': 'applications', 'source': 'source', 'coordinate_precision': 'coordinate_precision', 'notes': 'notes', });
lyr_ai_relations_74.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
...
lyr_ai_actors_76.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'actor_type': 'actor_type', 'country': 'country', 'city': 'city', 'main_domain': 'main_domain', 'role': 'role', 'related_factories': 'related_factories', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_qt_relations_77.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_qt_infrastructures_78.set('fieldAliases', {'id': 'id', 'name': 'name', 'host': 'host', 'city': 'city', 'country': 'country', 'technology': 'technology', 'platform': 'platform', 'topology': 'topology', 'qubits': 'qubits', 'supplier': 'supplier', 'hosting_supercomputer': 'hosting_supercomputer', 'power_consumption': 'power_consumption', 'cooling_system': 'cooling_system', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_qt_actors_79.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'actor_type': 'actor_type', 'city': 'city', 'country': 'country', 'main_domain': 'main_domain', 'platform': 'platform', 'role': 'role', 'developed_what': 'developed_what', 'related_infrastructures': 'related_infrastructures', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_datacenter_80.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'company': 'company', 'city': 'city', 'state': 'state', 'country': 'country', 'address': 'address', });
...
lyr_ai_compute_relations_72.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_supercomputers_73.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'host_entity': 'TextEdit', 'linked_ai_factory_ids': 'TextEdit', 'linked_ai_factories': 'TextEdit', 'system_role': 'TextEdit', 'system_class': 'TextEdit', 'status': 'TextEdit', 'sustained_pf': 'TextEdit', 'peak_pf': 'TextEdit', 'ai_peak_pf': 'TextEdit', 'accelerator_or_gpu': 'TextEdit', 'cpu': 'TextEdit', 'storage': 'TextEdit', 'supplier': 'TextEdit', 'applications': 'TextEdit', 'source': 'TextEdit', 'coordinate_precision': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_relations_74.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
...
lyr_ai_actors_76.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'main_domain': 'TextEdit', 'role': 'TextEdit', 'related_factories': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_relations_77.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_infrastructures_78.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'host': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'technology': 'TextEdit', 'platform': 'TextEdit', 'topology': 'TextEdit', 'qubits': 'Range', 'supplier': 'TextEdit', 'hosting_supercomputer': 'TextEdit', 'power_consumption': 'TextEdit', 'cooling_system': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_actors_79.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'main_domain': 'TextEdit', 'platform': 'TextEdit', 'role': 'TextEdit', 'developed_what': 'TextEdit', 'related_infrastructures': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_datacenter_80.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', 'company': 'TextEdit', 'city': 'TextEdit', 'state': 'TextEdit', 'country': 'TextEdit', 'address': 'TextEdit', });
...
lyr_ai_compute_relations_72.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_supercomputers_73.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'country': 'no label', 'city': 'no label', 'host_entity': 'no label', 'linked_ai_factory_ids': 'no label', 'linked_ai_factories': 'no label', 'system_role': 'no label', 'system_class': 'no label', 'status': 'no label', 'sustained_pf': 'no label', 'peak_pf': 'no label', 'ai_peak_pf': 'no label', 'accelerator_or_gpu': 'no label', 'cpu': 'no label', 'storage': 'no label', 'supplier': 'no label', 'applications': 'no label', 'source': 'no label', 'coordinate_precision': 'no label', 'notes': 'no label', });
lyr_ai_relations_74.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
...
lyr_ai_actors_76.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'country': 'no label', 'city': 'no label', 'main_domain': 'no label', 'role': 'no label', 'related_factories': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_relations_77.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_infrastructures_78.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'host': 'no label', 'city': 'no label', 'country': 'no label', 'technology': 'no label', 'platform': 'no label', 'topology': 'no label', 'qubits': 'no label', 'supplier': 'no label', 'hosting_supercomputer': 'no label', 'power_consumption': 'no label', 'cooling_system': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_actors_79.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'city': 'no label', 'country': 'no label', 'main_domain': 'no label', 'platform': 'no label', 'role': 'no label', 'developed_what': 'no label', 'related_infrastructures': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_datacenter_80.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'company': 'no label', 'city': 'no label', 'state': 'no label', 'country': 'no label', 'address': 'no label', });
