...
var format_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62 = new ol.format.GeoJSON();
var features_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62 = format_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62.readFeatures(json_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62.addFeatures(features_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62);
var lyr_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62, 
                style: style_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62,
                popuplayertitle: 'europe_fpga_infrastructures_pilot — European publicly documented FPGA-capable infrastructures — pilot dataset',
                interactive: true,
                title: '<img src="styles/legend/europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62.png" /> europe_fpga_infrastructures_pilot — European publicly documented FPGA-capable infrastructures — pilot dataset'
            });
...
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_61,lyr_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62,],
                                fold: 'open',
...
lyr_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62.set('fieldAliases', {'id': 'id', 'name': 'name', 'operator': 'operator', 'facility': 'facility', 'country': 'country', 'country_code': 'country_code', 'city_or_region': 'city_or_region', 'infrastructure_type': 'infrastructure_type', 'deployment_layer': 'deployment_layer', 'deployment_status': 'deployment_status', 'availability_end': 'availability_end', 'availability_start': 'availability_start', 'access_model': 'access_model', 'fpga_vendor': 'fpga_vendor', 'fpga_models': 'fpga_models', 'fpga_count': 'fpga_count', 'fpga_count_note': 'fpga_count_note', 'accelerators_per_instance_or_node': 'accelerators_per_instance_or_node', 'host_nodes': 'host_nodes', 'memory_note': 'memory_note', 'software_stack': 'software_stack', 'documented_workloads': 'documented_workloads', 'medical_ai_evidence': 'medical_ai_evidence', 'medical_ai_relevance': 'medical_ai_relevance', 'supports_custom_fpga_designs': 'supports_custom_fpga_designs', 'evidence_level': 'evidence_level', 'evidence_definition': 'evidence_definition', 'geometry_precision': 'geometry_precision', 'coordinate_note': 'coordinate_note', 'source_title': 'source_title', 'source_url': 'source_url', 'secondary_source_url': 'secondary_source_url', 'verified_on': 'verified_on', 'thesis_relevance': 'thesis_relevance', });
...
lyr_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'operator': 'TextEdit', 'facility': 'TextEdit', 'country': 'TextEdit', 'country_code': 'TextEdit', 'city_or_region': 'TextEdit', 'infrastructure_type': 'TextEdit', 'deployment_layer': 'TextEdit', 'deployment_status': 'TextEdit', 'availability_end': 'DateTime', 'availability_start': 'DateTime', 'access_model': 'TextEdit', 'fpga_vendor': 'TextEdit', 'fpga_models': 'List', 'fpga_count': 'Range', 'fpga_count_note': 'TextEdit', 'accelerators_per_instance_or_node': 'TextEdit', 'host_nodes': 'Range', 'memory_note': 'TextEdit', 'software_stack': 'List', 'documented_workloads': 'List', 'medical_ai_evidence': 'TextEdit', 'medical_ai_relevance': 'TextEdit', 'supports_custom_fpga_designs': 'TextEdit', 'evidence_level': 'TextEdit', 'evidence_definition': 'TextEdit', 'geometry_precision': 'TextEdit', 'coordinate_note': 'TextEdit', 'source_title': 'TextEdit', 'source_url': 'TextEdit', 'secondary_source_url': 'TextEdit', 'verified_on': 'DateTime', 'thesis_relevance': 'TextEdit', });
...
lyr_europe_fpga_infrastructures_pilotEuropeanpubliclydocumentedFPGAcapableinfrastructurespilotdataset_62.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'operator': 'no label', 'facility': 'no label', 'country': 'no label', 'country_code': 'no label', 'city_or_region': 'no label', 'infrastructure_type': 'no label', 'deployment_layer': 'no label', 'deployment_status': 'no label', 'availability_end': 'no label', 'availability_start': 'no label', 'access_model': 'no label', 'fpga_vendor': 'no label', 'fpga_models': 'no label', 'fpga_count': 'no label', 'fpga_count_note': 'no label', 'accelerators_per_instance_or_node': 'no label', 'host_nodes': 'no label', 'memory_note': 'no label', 'software_stack': 'no label', 'documented_workloads': 'no label', 'medical_ai_evidence': 'no label', 'medical_ai_relevance': 'no label', 'supports_custom_fpga_designs': 'no label', 'evidence_level': 'no label', 'evidence_definition': 'no label', 'geometry_precision': 'no label', 'coordinate_note': 'no label', 'source_title': 'no label', 'source_url': 'no label', 'secondary_source_url': 'no label', 'verified_on': 'no label', 'thesis_relevance': 'no label', });
