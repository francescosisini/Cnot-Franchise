...
var format_stanza_Aliceroom_Alice_4 = new ol.format.GeoJSON();
var features_stanza_Aliceroom_Alice_4 = format_stanza_Aliceroom_Alice_4.readFeatures(json_stanza_Aliceroom_Alice_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_stanza_Aliceroom_Alice_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_stanza_Aliceroom_Alice_4.addFeatures(features_stanza_Aliceroom_Alice_4);
var lyr_stanza_Aliceroom_Alice_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_stanza_Aliceroom_Alice_4, 
                style: style_stanza_Aliceroom_Alice_4,
                popuplayertitle: 'stanza_Alice — room_Alice',
                interactive: true,
                title: '<img src="styles/legend/stanza_Aliceroom_Alice_4.png" /> stanza_Alice — room_Alice'
            });
...
lyr_stanza_Aliceroom_Alice_4.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'artifact_url': 'artifact_url', 'show_label': 'show_label', });
lyr_stanza_Aliceroom_Alice_5.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'artifact_url': 'artifact_url', 'show_label': 'show_label', });
...
lyr_stanza_Aliceroom_Alice_4.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'artifact_url': 'TextEdit', 'show_label': 'CheckBox', });
lyr_stanza_Aliceroom_Alice_5.set('fieldImages', {'label': '', 'nome': '', 'feature_role': '', 'source': '', 'center_x': '', 'center_y': '', 'tipo': '', 'descrizione': '', 'style': '', 'universo': '', 'categoria': '', 'owner': '', 'artifact_url': '', 'show_label': '', });
...
lyr_stanza_Aliceroom_Alice_4.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'artifact_url': 'no label', 'show_label': 'no label', });
lyr_stanza_Aliceroom_Alice_5.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'artifact_url': 'no label', 'show_label': 'no label', });
