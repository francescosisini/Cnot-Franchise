...
var format_amenity_school_ferrara_4 = new ol.format.GeoJSON();
var features_amenity_school_ferrara_4 = format_amenity_school_ferrara_4.readFeatures(json_amenity_school_ferrara_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_amenity_school_ferrara_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_amenity_school_ferrara_4.addFeatures(features_amenity_school_ferrara_4);
var lyr_amenity_school_ferrara_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_amenity_school_ferrara_4, 
                style: style_amenity_school_ferrara_4,
                popuplayertitle: 'amenity_school_ferrara',
                interactive: true,
                title: '<img src="styles/legend/amenity_school_ferrara_4.png" /> amenity_school_ferrara'
            });
...
var group_Zonadimenticata = new ol.layer.Group({
                                layers: [lyr_building_9,lyr_building_10,],
                                fold: 'open',
                                title: 'Zona dimenticata'});
var group_Topografia = new ol.layer.Group({
                                layers: [lyr_highway_7,lyr_highway_8,],
                                fold: 'close',
                                title: 'Topografia'});
var group_Strutture_dismesse = new ol.layer.Group({
                                layers: [lyr_amenity_school_ferrara_3,lyr_amenity_school_ferrara_4,lyr_convitto_base_localConvittoCardinalMoraesempiobase_5,lyr_convitto_base_localConvittoCardinalMoraesempiobase_6,],
                                fold: 'open',
...
lyr_tiny_house_0.setVisible(true);lyr_Drone_port_1.setVisible(true);lyr_building_2.setVisible(true);lyr_amenity_school_ferrara_3.setVisible(true);lyr_amenity_school_ferrara_4.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_5.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_6.setVisible(true);lyr_highway_7.setVisible(true);lyr_highway_8.setVisible(true);lyr_building_9.setVisible(true);lyr_building_10.setVisible(true);lyr_telecamere_11.setVisible(true);lyr_highway_traffic_signals_ferrara_12.setVisible(true);lyr_Nuclear_power_plant_database_13.setVisible(true);lyr_Solarl_power_plant_database_14.setVisible(true);lyr_Wind_power_plant_database_15.setVisible(true);lyr_europe_16.setVisible(true);lyr_targets_17.setVisible(true);
var layersList = [group_tinyhouses,group_Narrativa,group_Strutture_dismesse,group_Topografia,group_Zonadimenticata,group_Sorveglianza,group_02_ENERGIA,lyr_europe_16,lyr_targets_17];
...
lyr_building_9.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'addr:street': 'addr:street', 'addr:housenumber': 'addr:housenumber', });
lyr_building_10.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'building': 'building', 'religion': 'religion', 'denomination': 'denomination', 'amenity': 'amenity', 'name': 'name', });
...
lyr_building_9.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'addr:street': '', 'addr:housenumber': '', });
lyr_building_10.set('fieldImages', {'fid': '', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'building': 'TextEdit', 'religion': 'TextEdit', 'denomination': 'TextEdit', 'amenity': 'TextEdit', 'name': 'TextEdit', });
