...
var format_cnot_quantum_reactor_story_points_51 = new ol.format.GeoJSON();
var features_cnot_quantum_reactor_story_points_51 = format_cnot_quantum_reactor_story_points_51.readFeatures(json_cnot_quantum_reactor_story_points_51, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnot_quantum_reactor_story_points_51 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnot_quantum_reactor_story_points_51.addFeatures(features_cnot_quantum_reactor_story_points_51);
var lyr_cnot_quantum_reactor_story_points_51 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnot_quantum_reactor_story_points_51, 
                style: style_cnot_quantum_reactor_story_points_51,
                popuplayertitle: 'cnot_quantum_reactor_story_points',
                interactive: true,
                title: '<img src="styles/legend/cnot_quantum_reactor_story_points_51.png" /> cnot_quantum_reactor_story_points'
            });
var format_01_hydrogen_production_52 = new ol.format.GeoJSON();
var features_01_hydrogen_production_52 = format_01_hydrogen_production_52.readFeatures(json_01_hydrogen_production_52, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_01_hydrogen_production_52 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_01_hydrogen_production_52.addFeatures(features_01_hydrogen_production_52);
var lyr_01_hydrogen_production_52 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_01_hydrogen_production_52, 
                style: style_01_hydrogen_production_52,
                popuplayertitle: '01_hydrogen_production',
                interactive: true,
                title: '<img src="styles/legend/01_hydrogen_production_52.png" /> 01_hydrogen_production'
            });
var format_02_hydrogen_conversion_53 = new ol.format.GeoJSON();
var features_02_hydrogen_conversion_53 = format_02_hydrogen_conversion_53.readFeatures(json_02_hydrogen_conversion_53, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_02_hydrogen_conversion_53 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_02_hydrogen_conversion_53.addFeatures(features_02_hydrogen_conversion_53);
var lyr_02_hydrogen_conversion_53 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_02_hydrogen_conversion_53, 
                style: style_02_hydrogen_conversion_53,
                popuplayertitle: '02_hydrogen_conversion',
                interactive: true,
                title: '<img src="styles/legend/02_hydrogen_conversion_53.png" /> 02_hydrogen_conversion'
            });
var format_03_hydrogen_import_54 = new ol.format.GeoJSON();
var features_03_hydrogen_import_54 = format_03_hydrogen_import_54.readFeatures(json_03_hydrogen_import_54, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_03_hydrogen_import_54 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_03_hydrogen_import_54.addFeatures(features_03_hydrogen_import_54);
var lyr_03_hydrogen_import_54 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_03_hydrogen_import_54, 
                style: style_03_hydrogen_import_54,
                popuplayertitle: '03_hydrogen_import',
                interactive: true,
                title: '<img src="styles/legend/03_hydrogen_import_54.png" /> 03_hydrogen_import'
            });
var format_04_hydrogen_transport_55 = new ol.format.GeoJSON();
var features_04_hydrogen_transport_55 = format_04_hydrogen_transport_55.readFeatures(json_04_hydrogen_transport_55, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_04_hydrogen_transport_55 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_04_hydrogen_transport_55.addFeatures(features_04_hydrogen_transport_55);
var lyr_04_hydrogen_transport_55 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_04_hydrogen_transport_55, 
                style: style_04_hydrogen_transport_55,
                popuplayertitle: '04_hydrogen_transport',
                interactive: true,
                title: '<img src="styles/legend/04_hydrogen_transport_55.png" /> 04_hydrogen_transport'
            });
var format_05_hydrogen_storage_56 = new ol.format.GeoJSON();
var features_05_hydrogen_storage_56 = format_05_hydrogen_storage_56.readFeatures(json_05_hydrogen_storage_56, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_05_hydrogen_storage_56 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_05_hydrogen_storage_56.addFeatures(features_05_hydrogen_storage_56);
var lyr_05_hydrogen_storage_56 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_05_hydrogen_storage_56, 
                style: style_05_hydrogen_storage_56,
                popuplayertitle: '05_hydrogen_storage',
                interactive: true,
                title: '<img src="styles/legend/05_hydrogen_storage_56.png" /> 05_hydrogen_storage'
            });
var format_06_hydrogen_use_57 = new ol.format.GeoJSON();
var features_06_hydrogen_use_57 = format_06_hydrogen_use_57.readFeatures(json_06_hydrogen_use_57, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_06_hydrogen_use_57 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_06_hydrogen_use_57.addFeatures(features_06_hydrogen_use_57);
var lyr_06_hydrogen_use_57 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_06_hydrogen_use_57, 
                style: style_06_hydrogen_use_57,
                popuplayertitle: '06_hydrogen_use',
                interactive: true,
                title: '<img src="styles/legend/06_hydrogen_use_57.png" /> 06_hydrogen_use'
            });
var format_07_hydrogen_valleys_58 = new ol.format.GeoJSON();
var features_07_hydrogen_valleys_58 = format_07_hydrogen_valleys_58.readFeatures(json_07_hydrogen_valleys_58, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_07_hydrogen_valleys_58 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_07_hydrogen_valleys_58.addFeatures(features_07_hydrogen_valleys_58);
var lyr_07_hydrogen_valleys_58 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_07_hydrogen_valleys_58, 
                style: style_07_hydrogen_valleys_58,
                popuplayertitle: '07_hydrogen_valleys',
                interactive: true,
                title: '<img src="styles/legend/07_hydrogen_valleys_58.png" /> 07_hydrogen_valleys'
            });
var format_hydrogen_cycle_master_59 = new ol.format.GeoJSON();
var features_hydrogen_cycle_master_59 = format_hydrogen_cycle_master_59.readFeatures(json_hydrogen_cycle_master_59, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_hydrogen_cycle_master_59 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_hydrogen_cycle_master_59.addFeatures(features_hydrogen_cycle_master_59);
var lyr_hydrogen_cycle_master_59 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_hydrogen_cycle_master_59, 
                style: style_hydrogen_cycle_master_59,
                popuplayertitle: 'hydrogen_cycle_master',
                interactive: true,
                title: '<img src="styles/legend/hydrogen_cycle_master_59.png" /> hydrogen_cycle_master'
            });
var format_hydrogen_cycle_master_60 = new ol.format.GeoJSON();
var features_hydrogen_cycle_master_60 = format_hydrogen_cycle_master_60.readFeatures(json_hydrogen_cycle_master_60, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_hydrogen_cycle_master_60 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_hydrogen_cycle_master_60.addFeatures(features_hydrogen_cycle_master_60);
var lyr_hydrogen_cycle_master_60 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_hydrogen_cycle_master_60, 
                style: style_hydrogen_cycle_master_60,
                popuplayertitle: 'hydrogen_cycle_master',
                interactive: true,
                title: '<img src="styles/legend/hydrogen_cycle_master_60.png" /> hydrogen_cycle_master'
            });
var format_nuclear_reactors_europe_all_61 = new ol.format.GeoJSON();
var features_nuclear_reactors_europe_all_61 = format_nuclear_reactors_europe_all_61.readFeatures(json_nuclear_reactors_europe_all_61, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_nuclear_reactors_europe_all_61 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_nuclear_reactors_europe_all_61.addFeatures(features_nuclear_reactors_europe_all_61);
var lyr_nuclear_reactors_europe_all_61 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_nuclear_reactors_europe_all_61, 
                style: style_nuclear_reactors_europe_all_61,
                popuplayertitle: 'nuclear_reactors_europe_all',
                interactive: true,
                title: '<img src="styles/legend/nuclear_reactors_europe_all_61.png" /> nuclear_reactors_europe_all'
            });
var format_energy_opsd_all_except_nuclear_62 = new ol.format.GeoJSON();
var features_energy_opsd_all_except_nuclear_62 = format_energy_opsd_all_except_nuclear_62.readFeatures(json_energy_opsd_all_except_nuclear_62, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_energy_opsd_all_except_nuclear_62 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_energy_opsd_all_except_nuclear_62.addFeatures(features_energy_opsd_all_except_nuclear_62);
var lyr_energy_opsd_all_except_nuclear_62 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_energy_opsd_all_except_nuclear_62, 
                style: style_energy_opsd_all_except_nuclear_62,
                popuplayertitle: 'energy_opsd_all_except_nuclear',
                interactive: true,
    title: 'energy_opsd_all_except_nuclear<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_0.png" /> Coal<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_1.png" /> Hydro<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_2.png" /> Lignite<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_3.png" /> Natural gas<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_4.png" /> Oil<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_5.png" /> Other<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_6.png" /> Waste<br />\
    <img src="styles/legend/energy_opsd_all_except_nuclear_62_7.png" /> <br />' });
var format_01_uranium_extraction_63 = new ol.format.GeoJSON();
var features_01_uranium_extraction_63 = format_01_uranium_extraction_63.readFeatures(json_01_uranium_extraction_63, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_01_uranium_extraction_63 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_01_uranium_extraction_63.addFeatures(features_01_uranium_extraction_63);
var lyr_01_uranium_extraction_63 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_01_uranium_extraction_63, 
                style: style_01_uranium_extraction_63,
                popuplayertitle: '01_uranium_extraction',
                interactive: true,
                title: '<img src="styles/legend/01_uranium_extraction_63.png" /> 01_uranium_extraction'
            });
var format_02_uranium_conversion_64 = new ol.format.GeoJSON();
var features_02_uranium_conversion_64 = format_02_uranium_conversion_64.readFeatures(json_02_uranium_conversion_64, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_02_uranium_conversion_64 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_02_uranium_conversion_64.addFeatures(features_02_uranium_conversion_64);
var lyr_02_uranium_conversion_64 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_02_uranium_conversion_64, 
                style: style_02_uranium_conversion_64,
                popuplayertitle: '02_uranium_conversion',
                interactive: true,
                title: '<img src="styles/legend/02_uranium_conversion_64.png" /> 02_uranium_conversion'
            });
var format_03_uranium_enrichment_65 = new ol.format.GeoJSON();
var features_03_uranium_enrichment_65 = format_03_uranium_enrichment_65.readFeatures(json_03_uranium_enrichment_65, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_03_uranium_enrichment_65 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_03_uranium_enrichment_65.addFeatures(features_03_uranium_enrichment_65);
var lyr_03_uranium_enrichment_65 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_03_uranium_enrichment_65, 
                style: style_03_uranium_enrichment_65,
                popuplayertitle: '03_uranium_enrichment',
                interactive: true,
                title: '<img src="styles/legend/03_uranium_enrichment_65.png" /> 03_uranium_enrichment'
            });
var format_04_fuel_fabrication_66 = new ol.format.GeoJSON();
var features_04_fuel_fabrication_66 = format_04_fuel_fabrication_66.readFeatures(json_04_fuel_fabrication_66, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_04_fuel_fabrication_66 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_04_fuel_fabrication_66.addFeatures(features_04_fuel_fabrication_66);
var lyr_04_fuel_fabrication_66 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_04_fuel_fabrication_66, 
                style: style_04_fuel_fabrication_66,
                popuplayertitle: '04_fuel_fabrication',
                interactive: true,
                title: '<img src="styles/legend/04_fuel_fabrication_66.png" /> 04_fuel_fabrication'
            });
var format_05_reprocessing_recycling_67 = new ol.format.GeoJSON();
var features_05_reprocessing_recycling_67 = format_05_reprocessing_recycling_67.readFeatures(json_05_reprocessing_recycling_67, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_05_reprocessing_recycling_67 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_05_reprocessing_recycling_67.addFeatures(features_05_reprocessing_recycling_67);
var lyr_05_reprocessing_recycling_67 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_05_reprocessing_recycling_67, 
                style: style_05_reprocessing_recycling_67,
                popuplayertitle: '05_reprocessing_recycling',
                interactive: true,
                title: '<img src="styles/legend/05_reprocessing_recycling_67.png" /> 05_reprocessing_recycling'
            });
var format_06_interim_storage_68 = new ol.format.GeoJSON();
var features_06_interim_storage_68 = format_06_interim_storage_68.readFeatures(json_06_interim_storage_68, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_06_interim_storage_68 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_06_interim_storage_68.addFeatures(features_06_interim_storage_68);
var lyr_06_interim_storage_68 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_06_interim_storage_68, 
                style: style_06_interim_storage_68,
                popuplayertitle: '06_interim_storage',
                interactive: true,
                title: '<img src="styles/legend/06_interim_storage_68.png" /> 06_interim_storage'
            });
var format_07_geological_repositories_69 = new ol.format.GeoJSON();
var features_07_geological_repositories_69 = format_07_geological_repositories_69.readFeatures(json_07_geological_repositories_69, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_07_geological_repositories_69 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_07_geological_repositories_69.addFeatures(features_07_geological_repositories_69);
var lyr_07_geological_repositories_69 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_07_geological_repositories_69, 
                style: style_07_geological_repositories_69,
                popuplayertitle: '07_geological_repositories',
                interactive: true,
                title: '<img src="styles/legend/07_geological_repositories_69.png" /> 07_geological_repositories'
            });
var format_08_nuclear_research_70 = new ol.format.GeoJSON();
var features_08_nuclear_research_70 = format_08_nuclear_research_70.readFeatures(json_08_nuclear_research_70, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_08_nuclear_research_70 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_08_nuclear_research_70.addFeatures(features_08_nuclear_research_70);
var lyr_08_nuclear_research_70 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_08_nuclear_research_70, 
                style: style_08_nuclear_research_70,
                popuplayertitle: '08_nuclear_research',
                interactive: true,
                title: '<img src="styles/legend/08_nuclear_research_70.png" /> 08_nuclear_research'
            });
var format_09_nuclear_power_switzerland_71 = new ol.format.GeoJSON();
var features_09_nuclear_power_switzerland_71 = format_09_nuclear_power_switzerland_71.readFeatures(json_09_nuclear_power_switzerland_71, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_09_nuclear_power_switzerland_71 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_09_nuclear_power_switzerland_71.addFeatures(features_09_nuclear_power_switzerland_71);
var lyr_09_nuclear_power_switzerland_71 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_09_nuclear_power_switzerland_71, 
                style: style_09_nuclear_power_switzerland_71,
                popuplayertitle: '09_nuclear_power_switzerland',
                interactive: true,
                title: '<img src="styles/legend/09_nuclear_power_switzerland_71.png" /> 09_nuclear_power_switzerland'
            });
var format_01_robotics_research_72 = new ol.format.GeoJSON();
var features_01_robotics_research_72 = format_01_robotics_research_72.readFeatures(json_01_robotics_research_72, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_01_robotics_research_72 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_01_robotics_research_72.addFeatures(features_01_robotics_research_72);
var lyr_01_robotics_research_72 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_01_robotics_research_72, 
                style: style_01_robotics_research_72,
                popuplayertitle: '01_robotics_research',
                interactive: true,
                title: '<img src="styles/legend/01_robotics_research_72.png" /> 01_robotics_research'
            });
var format_02_robotics_components_73 = new ol.format.GeoJSON();
var features_02_robotics_components_73 = format_02_robotics_components_73.readFeatures(json_02_robotics_components_73, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_02_robotics_components_73 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_02_robotics_components_73.addFeatures(features_02_robotics_components_73);
var lyr_02_robotics_components_73 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_02_robotics_components_73, 
                style: style_02_robotics_components_73,
                popuplayertitle: '02_robotics_components',
                interactive: true,
                title: '<img src="styles/legend/02_robotics_components_73.png" /> 02_robotics_components'
            });
var format_03_robot_manufacturing_74 = new ol.format.GeoJSON();
var features_03_robot_manufacturing_74 = format_03_robot_manufacturing_74.readFeatures(json_03_robot_manufacturing_74, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_03_robot_manufacturing_74 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_03_robot_manufacturing_74.addFeatures(features_03_robot_manufacturing_74);
var lyr_03_robot_manufacturing_74 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_03_robot_manufacturing_74, 
                style: style_03_robot_manufacturing_74,
                popuplayertitle: '03_robot_manufacturing',
                interactive: true,
                title: '<img src="styles/legend/03_robot_manufacturing_74.png" /> 03_robot_manufacturing'
            });
var format_ai_compute_relations_75 = new ol.format.GeoJSON();
var features_ai_compute_relations_75 = format_ai_compute_relations_75.readFeatures(json_ai_compute_relations_75, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_compute_relations_75 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_compute_relations_75.addFeatures(features_ai_compute_relations_75);
var lyr_ai_compute_relations_75 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_compute_relations_75, 
                style: style_ai_compute_relations_75,
                popuplayertitle: 'ai_compute_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_compute_relations_75.png" /> ai_compute_relations'
            });
var format_ai_supercomputers_76 = new ol.format.GeoJSON();
var features_ai_supercomputers_76 = format_ai_supercomputers_76.readFeatures(json_ai_supercomputers_76, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_supercomputers_76 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_supercomputers_76.addFeatures(features_ai_supercomputers_76);
var lyr_ai_supercomputers_76 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_supercomputers_76, 
                style: style_ai_supercomputers_76,
                popuplayertitle: 'ai_supercomputers',
                interactive: true,
                title: '<img src="styles/legend/ai_supercomputers_76.png" /> ai_supercomputers'
            });
var format_ai_relations_77 = new ol.format.GeoJSON();
var features_ai_relations_77 = format_ai_relations_77.readFeatures(json_ai_relations_77, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_relations_77 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_relations_77.addFeatures(features_ai_relations_77);
var lyr_ai_relations_77 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_relations_77, 
                style: style_ai_relations_77,
                popuplayertitle: 'ai_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_relations_77.png" /> ai_relations'
            });
var format_ai_factories_78 = new ol.format.GeoJSON();
var features_ai_factories_78 = format_ai_factories_78.readFeatures(json_ai_factories_78, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_factories_78 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_factories_78.addFeatures(features_ai_factories_78);
var lyr_ai_factories_78 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_factories_78, 
                style: style_ai_factories_78,
                popuplayertitle: 'ai_factories',
                interactive: true,
                title: '<img src="styles/legend/ai_factories_78.png" /> ai_factories'
            });
var format_ai_actors_79 = new ol.format.GeoJSON();
var features_ai_actors_79 = format_ai_actors_79.readFeatures(json_ai_actors_79, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_actors_79 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_actors_79.addFeatures(features_ai_actors_79);
var lyr_ai_actors_79 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_actors_79, 
                style: style_ai_actors_79,
                popuplayertitle: 'ai_actors',
                interactive: true,
    title: 'ai_actors<br />\
    <img src="styles/legend/ai_actors_79_0.png" /> <br />\
    <img src="styles/legend/ai_actors_79_1.png" /> ai_hpc_integration<br />\
    <img src="styles/legend/ai_actors_79_2.png" /> ai_policy_regulation<br />\
    <img src="styles/legend/ai_actors_79_3.png" /> hpc_ai_infrastructure<br />' });
var format_qt_relations_80 = new ol.format.GeoJSON();
var features_qt_relations_80 = format_qt_relations_80.readFeatures(json_qt_relations_80, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_relations_80 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_relations_80.addFeatures(features_qt_relations_80);
var lyr_qt_relations_80 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_relations_80, 
                style: style_qt_relations_80,
                popuplayertitle: 'qt_relations',
                interactive: true,
    title: 'qt_relations<br />\
    <img src="styles/legend/qt_relations_80_0.png" /> component_supplier_for<br />\
    <img src="styles/legend/qt_relations_80_1.png" /> hosts<br />\
    <img src="styles/legend/qt_relations_80_2.png" /> hosts_or_operates<br />\
    <img src="styles/legend/qt_relations_80_3.png" /> supplier_of<br />\
    <img src="styles/legend/qt_relations_80_4.png" /> <br />' });
var format_qt_infrastructures_81 = new ol.format.GeoJSON();
var features_qt_infrastructures_81 = format_qt_infrastructures_81.readFeatures(json_qt_infrastructures_81, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_infrastructures_81 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_infrastructures_81.addFeatures(features_qt_infrastructures_81);
var lyr_qt_infrastructures_81 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_infrastructures_81, 
                style: style_qt_infrastructures_81,
                popuplayertitle: 'qt_infrastructures',
                interactive: true,
    title: 'qt_infrastructures<br />\
    <img src="styles/legend/qt_infrastructures_81_0.png" /> 12 - 21,6<br />\
    <img src="styles/legend/qt_infrastructures_81_1.png" /> 21,6 - 24,8<br />\
    <img src="styles/legend/qt_infrastructures_81_2.png" /> 24,8 - 63,2<br />\
    <img src="styles/legend/qt_infrastructures_81_3.png" /> 63,2 - 100<br />\
    <img src="styles/legend/qt_infrastructures_81_4.png" /> 100 - 140<br />' });
var format_qt_actors_82 = new ol.format.GeoJSON();
var features_qt_actors_82 = format_qt_actors_82.readFeatures(json_qt_actors_82, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_actors_82 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_actors_82.addFeatures(features_qt_actors_82);
var lyr_qt_actors_82 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_actors_82, 
                style: style_qt_actors_82,
                popuplayertitle: 'qt_actors',
                interactive: true,
    title: 'qt_actors<br />\
    <img src="styles/legend/qt_actors_82_0.png" /> company<br />\
    <img src="styles/legend/qt_actors_82_1.png" /> european_public_institution<br />\
    <img src="styles/legend/qt_actors_82_2.png" /> european_research_initiative<br />\
    <img src="styles/legend/qt_actors_82_3.png" /> hpc_research_center<br />\
    <img src="styles/legend/qt_actors_82_4.png" /> national_consortium<br />\
    <img src="styles/legend/qt_actors_82_5.png" /> <br />' });
var format_datacenter_83 = new ol.format.GeoJSON();
var features_datacenter_83 = format_datacenter_83.readFeatures(json_datacenter_83, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_datacenter_83 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_datacenter_83.addFeatures(features_datacenter_83);
var lyr_datacenter_83 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_datacenter_83, 
                style: style_datacenter_83,
                popuplayertitle: 'datacenter',
                interactive: true,
                title: '<img src="styles/legend/datacenter_83.png" /> datacenter'
            });
var format_cnoteurope_84 = new ol.format.GeoJSON();
var features_cnoteurope_84 = format_cnoteurope_84.readFeatures(json_cnoteurope_84, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnoteurope_84 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnoteurope_84.addFeatures(features_cnoteurope_84);
var lyr_cnoteurope_84 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnoteurope_84, 
                style: style_cnoteurope_84,
                popuplayertitle: 'cnot — europe',
                interactive: true,
                title: '<img src="styles/legend/cnoteurope_84.png" /> cnot — europe'
            });
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_83,],
                                fold: 'open',
                                title: '01_DATI_INFRASTRUTTURA_DIGITALE'});
var group_quantum = new ol.layer.Group({
                                layers: [lyr_qt_relations_80,lyr_qt_infrastructures_81,lyr_qt_actors_82,],
                                fold: 'close',
                                title: 'quantum'});
var group_AI = new ol.layer.Group({
                                layers: [lyr_ai_relations_77,lyr_ai_factories_78,lyr_ai_actors_79,],
                                fold: 'close',
                                title: 'AI'});
var group_Supercomputer = new ol.layer.Group({
                                layers: [lyr_ai_compute_relations_75,lyr_ai_supercomputers_76,],
                                fold: 'close',
                                title: 'Supercomputer'});
var group_Robotics = new ol.layer.Group({
                                layers: [lyr_01_robotics_research_72,lyr_02_robotics_components_73,lyr_03_robot_manufacturing_74,],
                                fold: 'open',
                                title: 'Robotics'});
var group_02_ENERGIA = new ol.layer.Group({
                                layers: [lyr_nuclear_reactors_europe_all_61,lyr_energy_opsd_all_except_nuclear_62,lyr_01_uranium_extraction_63,lyr_02_uranium_conversion_64,lyr_03_uranium_enrichment_65,lyr_04_fuel_fabrication_66,lyr_05_reprocessing_recycling_67,lyr_06_interim_storage_68,lyr_07_geological_repositories_69,lyr_08_nuclear_research_70,lyr_09_nuclear_power_switzerland_71,],
                                fold: 'open',
                                title: '02_ENERGIA'});
var group_H2 = new ol.layer.Group({
                                layers: [lyr_01_hydrogen_production_52,lyr_02_hydrogen_conversion_53,lyr_03_hydrogen_import_54,lyr_04_hydrogen_transport_55,lyr_05_hydrogen_storage_56,lyr_06_hydrogen_use_57,lyr_07_hydrogen_valleys_58,lyr_hydrogen_cycle_master_59,lyr_hydrogen_cycle_master_60,],
                                fold: 'open',
                                title: 'H2'});
...
var group_Narrativa = new ol.layer.Group({
                                layers: [lyr_cnot_quantum_reactor_story_points_51,],
                                fold: 'close',
                                title: 'Narrativa'});
...
lyr_cnot_quantum_reactor_story_points_51.set('fieldAliases', {'id': 'id', 'name': 'name', 'story': 'story', 'chapter': 'chapter', 'location': 'location', 'country': 'country', 'related_layer': 'related_layer', 'description': 'description', 'coordinate_precision': 'coordinate_precision', });
lyr_01_hydrogen_production_52.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_02_hydrogen_conversion_53.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_03_hydrogen_import_54.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_04_hydrogen_transport_55.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_05_hydrogen_storage_56.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_06_hydrogen_use_57.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_07_hydrogen_valleys_58.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_hydrogen_cycle_master_59.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_hydrogen_cycle_master_60.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'operator': 'operator', 'functions': 'functions', 'technology': 'technology', 'status': 'status', 'story_function_it': 'story_function_it', 'layer': 'layer', 'period': 'period', });
lyr_nuclear_reactors_europe_all_61.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'country_code': 'country_code', 'status': 'status', 'status_class': 'status_class', 'reactor_type': 'reactor_type', 'reactor_model': 'reactor_model', 'construction_start_at': 'construction_start_at', 'operational_from': 'operational_from', 'operational_to': 'operational_to', 'temporal_start': 'temporal_start', 'temporal_end': 'temporal_end', 'capacity_mwe': 'capacity_mwe', 'last_updated_at': 'last_updated_at', 'source': 'source', 'iaea_id': 'iaea_id', 'dataset_region': 'dataset_region', 'geometry_note': 'geometry_note', });
lyr_energy_opsd_all_except_nuclear_62.set('fieldAliases', {'plant_id': 'plant_id', 'name': 'name', 'country': 'country', 'capacity_mw': 'capacity_mw', 'energy_source': 'energy_source', 'energy_group': 'energy_group', 'technology': 'technology', 'status': 'status', 'commissioned': 'commissioned', 'shutdown': 'shutdown', 'is_shutdown': 'is_shutdown', 'temporal_start': 'temporal_start', 'temporal_end': 'temporal_end', 'temporal_end_source': 'temporal_end_source', 'temporal_basis': 'temporal_basis', 'company': 'company', 'city': 'city', 'state': 'state', 'eic_code': 'eic_code', 'energy_source_level_1': 'energy_source_level_1', 'energy_source_level_2': 'energy_source_level_2', 'energy_source_level_3': 'energy_source_level_3', 'original_source': 'original_source', 'source_dataset': 'source_dataset', 'source_url': 'source_url', });
lyr_01_uranium_extraction_63.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_02_uranium_conversion_64.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_03_uranium_enrichment_65.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_04_fuel_fabrication_66.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_05_reprocessing_recycling_67.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_06_interim_storage_68.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_07_geological_repositories_69.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_08_nuclear_research_70.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_09_nuclear_power_switzerland_71.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_01_robotics_research_72.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'city': 'city', 'stage': 'stage', 'category': 'category', 'organisation': 'organisation', 'function': 'function', 'description': 'description', 'address': 'address', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_02_robotics_components_73.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'city': 'city', 'stage': 'stage', 'category': 'category', 'organisation': 'organisation', 'function': 'function', 'description': 'description', 'address': 'address', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_03_robot_manufacturing_74.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'city': 'city', 'stage': 'stage', 'category': 'category', 'organisation': 'organisation', 'function': 'function', 'description': 'description', 'address': 'address', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_ai_compute_relations_75.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_ai_supercomputers_76.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'country': 'country', 'city': 'city', 'host_entity': 'host_entity', 'linked_ai_factory_ids': 'linked_ai_factory_ids', 'linked_ai_factories': 'linked_ai_factories', 'system_role': 'system_role', 'system_class': 'system_class', 'status': 'status', 'sustained_pf': 'sustained_pf', 'peak_pf': 'peak_pf', 'ai_peak_pf': 'ai_peak_pf', 'accelerator_or_gpu': 'accelerator_or_gpu', 'cpu': 'cpu', 'storage': 'storage', 'supplier': 'supplier', 'applications': 'applications', 'source': 'source', 'coordinate_precision': 'coordinate_precision', 'notes': 'notes', });
lyr_ai_relations_77.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_ai_factories_78.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'country': 'country', 'city': 'city', 'factory_type': 'factory_type', 'selection_batch': 'selection_batch', 'host_entity': 'host_entity', 'supercomputer_or_system': 'supercomputer_or_system', 'compute_note': 'compute_note', 'key_sectors': 'key_sectors', 'partner_countries': 'partner_countries', 'antennas': 'antennas', 'services_available_from': 'services_available_from', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_ai_actors_79.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'actor_type': 'actor_type', 'country': 'country', 'city': 'city', 'main_domain': 'main_domain', 'role': 'role', 'related_factories': 'related_factories', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_qt_relations_80.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_qt_infrastructures_81.set('fieldAliases', {'id': 'id', 'name': 'name', 'host': 'host', 'city': 'city', 'country': 'country', 'technology': 'technology', 'platform': 'platform', 'topology': 'topology', 'qubits': 'qubits', 'supplier': 'supplier', 'hosting_supercomputer': 'hosting_supercomputer', 'power_consumption': 'power_consumption', 'cooling_system': 'cooling_system', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_qt_actors_82.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'actor_type': 'actor_type', 'city': 'city', 'country': 'country', 'main_domain': 'main_domain', 'platform': 'platform', 'role': 'role', 'developed_what': 'developed_what', 'related_infrastructures': 'related_infrastructures', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_datacenter_83.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'company': 'company', 'city': 'city', 'state': 'state', 'country': 'country', 'address': 'address', });
lyr_cnoteurope_84.set('fieldAliases', {'fid': 'fid', 'featurecla': 'featurecla', 'scalerank': 'scalerank', 'labelrank': 'labelrank', 'sovereignt': 'sovereignt', 'sov_a3': 'sov_a3', 'adm0_dif': 'adm0_dif', 'level': 'level', 'type': 'type', 'tlc': 'tlc', 'admin': 'admin', 'adm0_a3': 'adm0_a3', 'geou_dif': 'geou_dif', 'geounit': 'geounit', 'gu_a3': 'gu_a3', 'su_dif': 'su_dif', 'subunit': 'subunit', 'su_a3': 'su_a3', 'brk_diff': 'brk_diff', 'name': 'name', 'name_long': 'name_long', 'brk_a3': 'brk_a3', 'brk_name': 'brk_name', 'brk_group': 'brk_group', 'abbrev': 'abbrev', 'postal': 'postal', 'formal_en': 'formal_en', 'formal_fr': 'formal_fr', 'name_ciawf': 'name_ciawf', 'note_adm0': 'note_adm0', 'note_brk': 'note_brk', 'name_sort': 'name_sort', 'name_alt': 'name_alt', 'mapcolor7': 'mapcolor7', 'mapcolor8': 'mapcolor8', 'mapcolor9': 'mapcolor9', 'mapcolor13': 'mapcolor13', 'pop_est': 'pop_est', 'pop_rank': 'pop_rank', 'pop_year': 'pop_year', 'gdp_md': 'gdp_md', 'gdp_year': 'gdp_year', 'economy': 'economy', 'income_grp': 'income_grp', 'fips_10': 'fips_10', 'iso_a2': 'iso_a2', 'iso_a2_eh': 'iso_a2_eh', 'iso_a3': 'iso_a3', 'iso_a3_eh': 'iso_a3_eh', 'iso_n3': 'iso_n3', 'iso_n3_eh': 'iso_n3_eh', 'un_a3': 'un_a3', 'wb_a2': 'wb_a2', 'wb_a3': 'wb_a3', 'woe_id': 'woe_id', 'woe_id_eh': 'woe_id_eh', 'woe_note': 'woe_note', 'adm0_iso': 'adm0_iso', 'adm0_diff': 'adm0_diff', 'adm0_tlc': 'adm0_tlc', 'adm0_a3_us': 'adm0_a3_us', 'adm0_a3_fr': 'adm0_a3_fr', 'adm0_a3_ru': 'adm0_a3_ru', 'adm0_a3_es': 'adm0_a3_es', 'adm0_a3_cn': 'adm0_a3_cn', 'adm0_a3_tw': 'adm0_a3_tw', 'adm0_a3_in': 'adm0_a3_in', 'adm0_a3_np': 'adm0_a3_np', 'adm0_a3_pk': 'adm0_a3_pk', 'adm0_a3_de': 'adm0_a3_de', 'adm0_a3_gb': 'adm0_a3_gb', 'adm0_a3_br': 'adm0_a3_br', 'adm0_a3_il': 'adm0_a3_il', 'adm0_a3_ps': 'adm0_a3_ps', 'adm0_a3_sa': 'adm0_a3_sa', 'adm0_a3_eg': 'adm0_a3_eg', 'adm0_a3_ma': 'adm0_a3_ma', 'adm0_a3_pt': 'adm0_a3_pt', 'adm0_a3_ar': 'adm0_a3_ar', 'adm0_a3_jp': 'adm0_a3_jp', 'adm0_a3_ko': 'adm0_a3_ko', 'adm0_a3_vn': 'adm0_a3_vn', 'adm0_a3_tr': 'adm0_a3_tr', 'adm0_a3_id': 'adm0_a3_id', 'adm0_a3_pl': 'adm0_a3_pl', 'adm0_a3_gr': 'adm0_a3_gr', 'adm0_a3_it': 'adm0_a3_it', 'adm0_a3_nl': 'adm0_a3_nl', 'adm0_a3_se': 'adm0_a3_se', 'adm0_a3_bd': 'adm0_a3_bd', 'adm0_a3_ua': 'adm0_a3_ua', 'adm0_a3_un': 'adm0_a3_un', 'adm0_a3_wb': 'adm0_a3_wb', 'continent': 'continent', 'region_un': 'region_un', 'subregion': 'subregion', 'region_wb': 'region_wb', 'name_len': 'name_len', 'long_len': 'long_len', 'abbrev_len': 'abbrev_len', 'tiny': 'tiny', 'homepart': 'homepart', 'min_zoom': 'min_zoom', 'min_label': 'min_label', 'max_label': 'max_label', 'label_x': 'label_x', 'label_y': 'label_y', 'ne_id': 'ne_id', 'wikidataid': 'wikidataid', 'name_ar': 'name_ar', 'name_bn': 'name_bn', 'name_de': 'name_de', 'name_en': 'name_en', 'name_es': 'name_es', 'name_fa': 'name_fa', 'name_fr': 'name_fr', 'name_el': 'name_el', 'name_he': 'name_he', 'name_hi': 'name_hi', 'name_hu': 'name_hu', 'name_id': 'name_id', 'name_it': 'name_it', 'name_ja': 'name_ja', 'name_ko': 'name_ko', 'name_nl': 'name_nl', 'name_pl': 'name_pl', 'name_pt': 'name_pt', 'name_ru': 'name_ru', 'name_sv': 'name_sv', 'name_tr': 'name_tr', 'name_uk': 'name_uk', 'name_ur': 'name_ur', 'name_vi': 'name_vi', 'name_zh': 'name_zh', 'name_zht': 'name_zht', 'fclass_iso': 'fclass_iso', 'tlc_diff': 'tlc_diff', 'fclass_tlc': 'fclass_tlc', 'fclass_us': 'fclass_us', 'fclass_fr': 'fclass_fr', 'fclass_ru': 'fclass_ru', 'fclass_es': 'fclass_es', 'fclass_cn': 'fclass_cn', 'fclass_tw': 'fclass_tw', 'fclass_in': 'fclass_in', 'fclass_np': 'fclass_np', 'fclass_pk': 'fclass_pk', 'fclass_de': 'fclass_de', 'fclass_gb': 'fclass_gb', 'fclass_br': 'fclass_br', 'fclass_il': 'fclass_il', 'fclass_ps': 'fclass_ps', 'fclass_sa': 'fclass_sa', 'fclass_eg': 'fclass_eg', 'fclass_ma': 'fclass_ma', 'fclass_pt': 'fclass_pt', 'fclass_ar': 'fclass_ar', 'fclass_jp': 'fclass_jp', 'fclass_ko': 'fclass_ko', 'fclass_vn': 'fclass_vn', 'fclass_tr': 'fclass_tr', 'fclass_id': 'fclass_id', 'fclass_pl': 'fclass_pl', 'fclass_gr': 'fclass_gr', 'fclass_it': 'fclass_it', 'fclass_nl': 'fclass_nl', 'fclass_se': 'fclass_se', 'fclass_bd': 'fclass_bd', 'fclass_ua': 'fclass_ua', 'filename': 'filename', });
...
lyr_cnot_quantum_reactor_story_points_51.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'story': 'TextEdit', 'chapter': 'TextEdit', 'location': 'TextEdit', 'country': 'TextEdit', 'related_layer': 'TextEdit', 'description': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_01_hydrogen_production_52.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_02_hydrogen_conversion_53.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_03_hydrogen_import_54.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_04_hydrogen_transport_55.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_05_hydrogen_storage_56.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_06_hydrogen_use_57.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_07_hydrogen_valleys_58.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_hydrogen_cycle_master_59.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
lyr_hydrogen_cycle_master_60.set('fieldImages', {'id': '', 'name': '', 'country': '', 'country_code': '', 'operator': '', 'functions': '', 'technology': '', 'status': '', 'story_function_it': '', 'layer': '', 'period': '', });
...
lyr_energy_opsd_all_except_nuclear_62.set('fieldImages', {'plant_id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'capacity_mw': 'TextEdit', 'energy_source': 'TextEdit', 'energy_group': 'TextEdit', 'technology': 'TextEdit', 'status': 'TextEdit', 'commissioned': 'Range', 'shutdown': 'TextEdit', 'is_shutdown': 'CheckBox', 'temporal_start': 'DateTime', 'temporal_end': 'DateTime', 'temporal_end_source': 'TextEdit', 'temporal_basis': 'TextEdit', 'company': 'TextEdit', 'city': 'TextEdit', 'state': 'TextEdit', 'eic_code': 'TextEdit', 'energy_source_level_1': 'TextEdit', 'energy_source_level_2': 'TextEdit', 'energy_source_level_3': 'TextEdit', 'original_source': 'TextEdit', 'source_dataset': 'TextEdit', 'source_url': 'TextEdit', });
lyr_01_uranium_extraction_63.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_02_uranium_conversion_64.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_03_uranium_enrichment_65.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_04_fuel_fabrication_66.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_05_reprocessing_recycling_67.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_06_interim_storage_68.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_07_geological_repositories_69.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_08_nuclear_research_70.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_09_nuclear_power_switzerland_71.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_01_robotics_research_72.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'stage': 'TextEdit', 'category': 'TextEdit', 'organisation': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'address': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_02_robotics_components_73.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'stage': 'TextEdit', 'category': 'TextEdit', 'organisation': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'address': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_03_robot_manufacturing_74.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'stage': 'TextEdit', 'category': 'TextEdit', 'organisation': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'address': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_ai_compute_relations_75.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_supercomputers_76.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'host_entity': 'TextEdit', 'linked_ai_factory_ids': 'TextEdit', 'linked_ai_factories': 'TextEdit', 'system_role': 'TextEdit', 'system_class': 'TextEdit', 'status': 'TextEdit', 'sustained_pf': 'TextEdit', 'peak_pf': 'TextEdit', 'ai_peak_pf': 'TextEdit', 'accelerator_or_gpu': 'TextEdit', 'cpu': 'TextEdit', 'storage': 'TextEdit', 'supplier': 'TextEdit', 'applications': 'TextEdit', 'source': 'TextEdit', 'coordinate_precision': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_relations_77.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_factories_78.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'factory_type': 'TextEdit', 'selection_batch': 'TextEdit', 'host_entity': 'TextEdit', 'supercomputer_or_system': 'TextEdit', 'compute_note': 'TextEdit', 'key_sectors': 'TextEdit', 'partner_countries': 'TextEdit', 'antennas': 'TextEdit', 'services_available_from': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_actors_79.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'main_domain': 'TextEdit', 'role': 'TextEdit', 'related_factories': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_relations_80.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_infrastructures_81.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'host': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'technology': 'TextEdit', 'platform': 'TextEdit', 'topology': 'TextEdit', 'qubits': 'Range', 'supplier': 'TextEdit', 'hosting_supercomputer': 'TextEdit', 'power_consumption': 'TextEdit', 'cooling_system': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_actors_82.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'main_domain': 'TextEdit', 'platform': 'TextEdit', 'role': 'TextEdit', 'developed_what': 'TextEdit', 'related_infrastructures': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_datacenter_83.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', 'company': 'TextEdit', 'city': 'TextEdit', 'state': 'TextEdit', 'country': 'TextEdit', 'address': 'TextEdit', });
lyr_cnoteurope_84.set('fieldImages', {'fid': 'TextEdit', 'featurecla': 'TextEdit', 'scalerank': 'Range', 'labelrank': 'Range', 'sovereignt': 'TextEdit', 'sov_a3': 'TextEdit', 'adm0_dif': 'Range', 'level': 'Range', 'type': 'TextEdit', 'tlc': 'TextEdit', 'admin': 'TextEdit', 'adm0_a3': 'TextEdit', 'geou_dif': 'Range', 'geounit': 'TextEdit', 'gu_a3': 'TextEdit', 'su_dif': 'Range', 'subunit': 'TextEdit', 'su_a3': 'TextEdit', 'brk_diff': 'Range', 'name': 'TextEdit', 'name_long': 'TextEdit', 'brk_a3': 'TextEdit', 'brk_name': 'TextEdit', 'brk_group': 'TextEdit', 'abbrev': 'TextEdit', 'postal': 'TextEdit', 'formal_en': 'TextEdit', 'formal_fr': 'TextEdit', 'name_ciawf': 'TextEdit', 'note_adm0': 'TextEdit', 'note_brk': 'TextEdit', 'name_sort': 'TextEdit', 'name_alt': 'TextEdit', 'mapcolor7': 'Range', 'mapcolor8': 'Range', 'mapcolor9': 'Range', 'mapcolor13': 'Range', 'pop_est': 'Range', 'pop_rank': 'Range', 'pop_year': 'Range', 'gdp_md': 'Range', 'gdp_year': 'Range', 'economy': 'TextEdit', 'income_grp': 'TextEdit', 'fips_10': 'TextEdit', 'iso_a2': 'TextEdit', 'iso_a2_eh': 'TextEdit', 'iso_a3': 'TextEdit', 'iso_a3_eh': 'TextEdit', 'iso_n3': 'TextEdit', 'iso_n3_eh': 'TextEdit', 'un_a3': 'TextEdit', 'wb_a2': 'TextEdit', 'wb_a3': 'TextEdit', 'woe_id': 'Range', 'woe_id_eh': 'Range', 'woe_note': 'TextEdit', 'adm0_iso': 'TextEdit', 'adm0_diff': 'TextEdit', 'adm0_tlc': 'TextEdit', 'adm0_a3_us': 'TextEdit', 'adm0_a3_fr': 'TextEdit', 'adm0_a3_ru': 'TextEdit', 'adm0_a3_es': 'TextEdit', 'adm0_a3_cn': 'TextEdit', 'adm0_a3_tw': 'TextEdit', 'adm0_a3_in': 'TextEdit', 'adm0_a3_np': 'TextEdit', 'adm0_a3_pk': 'TextEdit', 'adm0_a3_de': 'TextEdit', 'adm0_a3_gb': 'TextEdit', 'adm0_a3_br': 'TextEdit', 'adm0_a3_il': 'TextEdit', 'adm0_a3_ps': 'TextEdit', 'adm0_a3_sa': 'TextEdit', 'adm0_a3_eg': 'TextEdit', 'adm0_a3_ma': 'TextEdit', 'adm0_a3_pt': 'TextEdit', 'adm0_a3_ar': 'TextEdit', 'adm0_a3_jp': 'TextEdit', 'adm0_a3_ko': 'TextEdit', 'adm0_a3_vn': 'TextEdit', 'adm0_a3_tr': 'TextEdit', 'adm0_a3_id': 'TextEdit', 'adm0_a3_pl': 'TextEdit', 'adm0_a3_gr': 'TextEdit', 'adm0_a3_it': 'TextEdit', 'adm0_a3_nl': 'TextEdit', 'adm0_a3_se': 'TextEdit', 'adm0_a3_bd': 'TextEdit', 'adm0_a3_ua': 'TextEdit', 'adm0_a3_un': 'Range', 'adm0_a3_wb': 'Range', 'continent': 'TextEdit', 'region_un': 'TextEdit', 'subregion': 'TextEdit', 'region_wb': 'TextEdit', 'name_len': 'Range', 'long_len': 'Range', 'abbrev_len': 'Range', 'tiny': 'Range', 'homepart': 'Range', 'min_zoom': 'Range', 'min_label': 'TextEdit', 'max_label': 'TextEdit', 'label_x': 'TextEdit', 'label_y': 'TextEdit', 'ne_id': 'Range', 'wikidataid': 'TextEdit', 'name_ar': 'TextEdit', 'name_bn': 'TextEdit', 'name_de': 'TextEdit', 'name_en': 'TextEdit', 'name_es': 'TextEdit', 'name_fa': 'TextEdit', 'name_fr': 'TextEdit', 'name_el': 'TextEdit', 'name_he': 'TextEdit', 'name_hi': 'TextEdit', 'name_hu': 'TextEdit', 'name_id': 'TextEdit', 'name_it': 'TextEdit', 'name_ja': 'TextEdit', 'name_ko': 'TextEdit', 'name_nl': 'TextEdit', 'name_pl': 'TextEdit', 'name_pt': 'TextEdit', 'name_ru': 'TextEdit', 'name_sv': 'TextEdit', 'name_tr': 'TextEdit', 'name_uk': 'TextEdit', 'name_ur': 'TextEdit', 'name_vi': 'TextEdit', 'name_zh': 'TextEdit', 'name_zht': 'TextEdit', 'fclass_iso': 'TextEdit', 'tlc_diff': 'TextEdit', 'fclass_tlc': 'TextEdit', 'fclass_us': 'TextEdit', 'fclass_fr': 'TextEdit', 'fclass_ru': 'TextEdit', 'fclass_es': 'TextEdit', 'fclass_cn': 'TextEdit', 'fclass_tw': 'TextEdit', 'fclass_in': 'TextEdit', 'fclass_np': 'TextEdit', 'fclass_pk': 'TextEdit', 'fclass_de': 'TextEdit', 'fclass_gb': 'TextEdit', 'fclass_br': 'TextEdit', 'fclass_il': 'TextEdit', 'fclass_ps': 'TextEdit', 'fclass_sa': 'TextEdit', 'fclass_eg': 'TextEdit', 'fclass_ma': 'TextEdit', 'fclass_pt': 'TextEdit', 'fclass_ar': 'TextEdit', 'fclass_jp': 'TextEdit', 'fclass_ko': 'TextEdit', 'fclass_vn': 'TextEdit', 'fclass_tr': 'TextEdit', 'fclass_id': 'TextEdit', 'fclass_pl': 'TextEdit', 'fclass_gr': 'TextEdit', 'fclass_it': 'TextEdit', 'fclass_nl': 'TextEdit', 'fclass_se': 'TextEdit', 'fclass_bd': 'TextEdit', 'fclass_ua': 'TextEdit', 'filename': 'TextEdit', });
...
lyr_cnot_quantum_reactor_story_points_51.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'story': 'no label', 'chapter': 'no label', 'location': 'no label', 'country': 'no label', 'related_layer': 'no label', 'description': 'no label', 'coordinate_precision': 'no label', });
lyr_01_hydrogen_production_52.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_02_hydrogen_conversion_53.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_03_hydrogen_import_54.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_04_hydrogen_transport_55.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_05_hydrogen_storage_56.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_06_hydrogen_use_57.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_07_hydrogen_valleys_58.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_hydrogen_cycle_master_59.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
lyr_hydrogen_cycle_master_60.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'country_code': 'no label', 'operator': 'no label', 'functions': 'no label', 'technology': 'no label', 'status': 'no label', 'story_function_it': 'no label', 'layer': 'no label', 'period': 'no label', });
...
lyr_energy_opsd_all_except_nuclear_62.set('fieldLabels', {'plant_id': 'no label', 'name': 'no label', 'country': 'no label', 'capacity_mw': 'no label', 'energy_source': 'no label', 'energy_group': 'no label', 'technology': 'no label', 'status': 'no label', 'commissioned': 'no label', 'shutdown': 'no label', 'is_shutdown': 'no label', 'temporal_start': 'no label', 'temporal_end': 'no label', 'temporal_end_source': 'no label', 'temporal_basis': 'no label', 'company': 'no label', 'city': 'no label', 'state': 'no label', 'eic_code': 'no label', 'energy_source_level_1': 'no label', 'energy_source_level_2': 'no label', 'energy_source_level_3': 'no label', 'original_source': 'no label', 'source_dataset': 'no label', 'source_url': 'no label', });
lyr_01_uranium_extraction_63.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_02_uranium_conversion_64.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_03_uranium_enrichment_65.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_04_fuel_fabrication_66.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_05_reprocessing_recycling_67.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_06_interim_storage_68.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_07_geological_repositories_69.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_08_nuclear_research_70.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_09_nuclear_power_switzerland_71.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_01_robotics_research_72.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'city': 'no label', 'stage': 'no label', 'category': 'no label', 'organisation': 'no label', 'function': 'no label', 'description': 'no label', 'address': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_02_robotics_components_73.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'city': 'no label', 'stage': 'no label', 'category': 'no label', 'organisation': 'no label', 'function': 'no label', 'description': 'no label', 'address': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_03_robot_manufacturing_74.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'city': 'no label', 'stage': 'no label', 'category': 'no label', 'organisation': 'no label', 'function': 'no label', 'description': 'no label', 'address': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_ai_compute_relations_75.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_supercomputers_76.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'country': 'no label', 'city': 'no label', 'host_entity': 'no label', 'linked_ai_factory_ids': 'no label', 'linked_ai_factories': 'no label', 'system_role': 'no label', 'system_class': 'no label', 'status': 'no label', 'sustained_pf': 'no label', 'peak_pf': 'no label', 'ai_peak_pf': 'no label', 'accelerator_or_gpu': 'no label', 'cpu': 'no label', 'storage': 'no label', 'supplier': 'no label', 'applications': 'no label', 'source': 'no label', 'coordinate_precision': 'no label', 'notes': 'no label', });
lyr_ai_relations_77.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_factories_78.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'country': 'no label', 'city': 'no label', 'factory_type': 'no label', 'selection_batch': 'no label', 'host_entity': 'no label', 'supercomputer_or_system': 'no label', 'compute_note': 'no label', 'key_sectors': 'no label', 'partner_countries': 'no label', 'antennas': 'no label', 'services_available_from': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_actors_79.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'country': 'no label', 'city': 'no label', 'main_domain': 'no label', 'role': 'no label', 'related_factories': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_relations_80.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_infrastructures_81.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'host': 'no label', 'city': 'no label', 'country': 'no label', 'technology': 'no label', 'platform': 'no label', 'topology': 'no label', 'qubits': 'no label', 'supplier': 'no label', 'hosting_supercomputer': 'no label', 'power_consumption': 'no label', 'cooling_system': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_actors_82.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'city': 'no label', 'country': 'no label', 'main_domain': 'no label', 'platform': 'no label', 'role': 'no label', 'developed_what': 'no label', 'related_infrastructures': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_datacenter_83.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'company': 'no label', 'city': 'no label', 'state': 'no label', 'country': 'no label', 'address': 'no label', });
lyr_cnoteurope_84.set('fieldLabels', {'fid': 'no label', 'featurecla': 'no label', 'scalerank': 'no label', 'labelrank': 'no label', 'sovereignt': 'no label', 'sov_a3': 'no label', 'adm0_dif': 'no label', 'level': 'no label', 'type': 'no label', 'tlc': 'no label', 'admin': 'no label', 'adm0_a3': 'no label', 'geou_dif': 'no label', 'geounit': 'no label', 'gu_a3': 'no label', 'su_dif': 'no label', 'subunit': 'no label', 'su_a3': 'no label', 'brk_diff': 'no label', 'name': 'no label', 'name_long': 'no label', 'brk_a3': 'no label', 'brk_name': 'no label', 'brk_group': 'no label', 'abbrev': 'no label', 'postal': 'no label', 'formal_en': 'no label', 'formal_fr': 'no label', 'name_ciawf': 'no label', 'note_adm0': 'no label', 'note_brk': 'no label', 'name_sort': 'no label', 'name_alt': 'no label', 'mapcolor7': 'no label', 'mapcolor8': 'no label', 'mapcolor9': 'no label', 'mapcolor13': 'no label', 'pop_est': 'no label', 'pop_rank': 'no label', 'pop_year': 'no label', 'gdp_md': 'no label', 'gdp_year': 'no label', 'economy': 'no label', 'income_grp': 'no label', 'fips_10': 'no label', 'iso_a2': 'no label', 'iso_a2_eh': 'no label', 'iso_a3': 'no label', 'iso_a3_eh': 'no label', 'iso_n3': 'no label', 'iso_n3_eh': 'no label', 'un_a3': 'no label', 'wb_a2': 'no label', 'wb_a3': 'no label', 'woe_id': 'no label', 'woe_id_eh': 'no label', 'woe_note': 'no label', 'adm0_iso': 'no label', 'adm0_diff': 'no label', 'adm0_tlc': 'no label', 'adm0_a3_us': 'no label', 'adm0_a3_fr': 'no label', 'adm0_a3_ru': 'no label', 'adm0_a3_es': 'no label', 'adm0_a3_cn': 'no label', 'adm0_a3_tw': 'no label', 'adm0_a3_in': 'no label', 'adm0_a3_np': 'no label', 'adm0_a3_pk': 'no label', 'adm0_a3_de': 'no label', 'adm0_a3_gb': 'no label', 'adm0_a3_br': 'no label', 'adm0_a3_il': 'no label', 'adm0_a3_ps': 'no label', 'adm0_a3_sa': 'no label', 'adm0_a3_eg': 'no label', 'adm0_a3_ma': 'no label', 'adm0_a3_pt': 'no label', 'adm0_a3_ar': 'no label', 'adm0_a3_jp': 'no label', 'adm0_a3_ko': 'no label', 'adm0_a3_vn': 'no label', 'adm0_a3_tr': 'no label', 'adm0_a3_id': 'no label', 'adm0_a3_pl': 'no label', 'adm0_a3_gr': 'no label', 'adm0_a3_it': 'no label', 'adm0_a3_nl': 'no label', 'adm0_a3_se': 'no label', 'adm0_a3_bd': 'no label', 'adm0_a3_ua': 'no label', 'adm0_a3_un': 'no label', 'adm0_a3_wb': 'no label', 'continent': 'no label', 'region_un': 'no label', 'subregion': 'no label', 'region_wb': 'no label', 'name_len': 'no label', 'long_len': 'no label', 'abbrev_len': 'no label', 'tiny': 'no label', 'homepart': 'no label', 'min_zoom': 'no label', 'min_label': 'no label', 'max_label': 'no label', 'label_x': 'no label', 'label_y': 'no label', 'ne_id': 'no label', 'wikidataid': 'no label', 'name_ar': 'no label', 'name_bn': 'no label', 'name_de': 'no label', 'name_en': 'no label', 'name_es': 'no label', 'name_fa': 'no label', 'name_fr': 'no label', 'name_el': 'no label', 'name_he': 'no label', 'name_hi': 'no label', 'name_hu': 'no label', 'name_id': 'no label', 'name_it': 'no label', 'name_ja': 'no label', 'name_ko': 'no label', 'name_nl': 'no label', 'name_pl': 'no label', 'name_pt': 'no label', 'name_ru': 'no label', 'name_sv': 'no label', 'name_tr': 'no label', 'name_uk': 'no label', 'name_ur': 'no label', 'name_vi': 'no label', 'name_zh': 'no label', 'name_zht': 'no label', 'fclass_iso': 'no label', 'tlc_diff': 'no label', 'fclass_tlc': 'no label', 'fclass_us': 'no label', 'fclass_fr': 'no label', 'fclass_ru': 'no label', 'fclass_es': 'no label', 'fclass_cn': 'no label', 'fclass_tw': 'no label', 'fclass_in': 'no label', 'fclass_np': 'no label', 'fclass_pk': 'no label', 'fclass_de': 'no label', 'fclass_gb': 'no label', 'fclass_br': 'no label', 'fclass_il': 'no label', 'fclass_ps': 'no label', 'fclass_sa': 'no label', 'fclass_eg': 'no label', 'fclass_ma': 'no label', 'fclass_pt': 'no label', 'fclass_ar': 'no label', 'fclass_jp': 'no label', 'fclass_ko': 'no label', 'fclass_vn': 'no label', 'fclass_tr': 'no label', 'fclass_id': 'no label', 'fclass_pl': 'no label', 'fclass_gr': 'no label', 'fclass_it': 'no label', 'fclass_nl': 'no label', 'fclass_se': 'no label', 'fclass_bd': 'no label', 'fclass_ua': 'no label', 'filename': 'no label', });
lyr_cnoteurope_84.on('precompose', function(evt) {
