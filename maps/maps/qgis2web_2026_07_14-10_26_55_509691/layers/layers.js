...
lyr_fpga_infrastructures_europe_62.set('fieldImages', {'id': 'TextEdit', 'site_name': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'operator': 'TextEdit', 'infra_type': 'TextEdit', 'status': 'TextEdit', 'location_type': 'TextEdit', 'access_model': 'TextEdit', 'fpga_vendor': 'TextEdit', 'fpga_model': 'TextEdit', 'fpga_count': 'Range', 'count_known': 'CheckBox', 'medical_ai': 'TextEdit', 'story_order': 'Range', 'story_phase': 'TextEdit', 'source_url': 'TextEdit', 'verified_on': 'DateTime', });
