...
var format_FilieraAlimentarepuntodidistribuzione_1 = new ol.format.GeoJSON();
var features_FilieraAlimentarepuntodidistribuzione_1 = format_FilieraAlimentarepuntodidistribuzione_1.readFeatures(json_FilieraAlimentarepuntodidistribuzione_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FilieraAlimentarepuntodidistribuzione_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FilieraAlimentarepuntodidistribuzione_1.addFeatures(features_FilieraAlimentarepuntodidistribuzione_1);
var lyr_FilieraAlimentarepuntodidistribuzione_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FilieraAlimentarepuntodidistribuzione_1, 
                style: style_FilieraAlimentarepuntodidistribuzione_1,
                popuplayertitle: 'Filiera Alimentare: punto di distribuzione',
                interactive: true,
                title: '<img src="styles/legend/FilieraAlimentarepuntodidistribuzione_1.png" /> Filiera Alimentare: punto di distribuzione'
            });
var format_alice_prologostory_points_2 = new ol.format.GeoJSON();
var features_alice_prologostory_points_2 = format_alice_prologostory_points_2.readFeatures(json_alice_prologostory_points_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_alice_prologostory_points_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_alice_prologostory_points_2.addFeatures(features_alice_prologostory_points_2);
var lyr_alice_prologostory_points_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_alice_prologostory_points_2, 
                style: style_alice_prologostory_points_2,
                popuplayertitle: 'alice_prologo — story_points',
                interactive: true,
                title: '<img src="styles/legend/alice_prologostory_points_2.png" /> alice_prologo — story_points'
            });
var format_casa_caterina_3 = new ol.format.GeoJSON();
var features_casa_caterina_3 = format_casa_caterina_3.readFeatures(json_casa_caterina_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_casa_caterina_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_casa_caterina_3.addFeatures(features_casa_caterina_3);
var lyr_casa_caterina_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_casa_caterina_3, 
                style: style_casa_caterina_3,
                popuplayertitle: 'casa_caterina',
                interactive: true,
                title: '<img src="styles/legend/casa_caterina_3.png" /> casa_caterina'
            });
var format_casa_caterina_4 = new ol.format.GeoJSON();
var features_casa_caterina_4 = format_casa_caterina_4.readFeatures(json_casa_caterina_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_casa_caterina_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_casa_caterina_4.addFeatures(features_casa_caterina_4);
var lyr_casa_caterina_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_casa_caterina_4, 
                style: style_casa_caterina_4,
                popuplayertitle: 'casa_caterina',
                interactive: true,
                title: '<img src="styles/legend/casa_caterina_4.png" /> casa_caterina'
            });
var format_tiny_laura_5 = new ol.format.GeoJSON();
var features_tiny_laura_5 = format_tiny_laura_5.readFeatures(json_tiny_laura_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_tiny_laura_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tiny_laura_5.addFeatures(features_tiny_laura_5);
var lyr_tiny_laura_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tiny_laura_5, 
                style: style_tiny_laura_5,
                popuplayertitle: 'tiny_laura',
                interactive: true,
                title: '<img src="styles/legend/tiny_laura_5.png" /> tiny_laura'
            });
var format_tiny_laura_6 = new ol.format.GeoJSON();
var features_tiny_laura_6 = format_tiny_laura_6.readFeatures(json_tiny_laura_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_tiny_laura_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tiny_laura_6.addFeatures(features_tiny_laura_6);
var lyr_tiny_laura_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tiny_laura_6, 
                style: style_tiny_laura_6,
                popuplayertitle: 'tiny_laura',
                interactive: true,
                title: '<img src="styles/legend/tiny_laura_6.png" /> tiny_laura'
            });
var format_stanza_Aliceroom_Alice_7 = new ol.format.GeoJSON();
var features_stanza_Aliceroom_Alice_7 = format_stanza_Aliceroom_Alice_7.readFeatures(json_stanza_Aliceroom_Alice_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_stanza_Aliceroom_Alice_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_stanza_Aliceroom_Alice_7.addFeatures(features_stanza_Aliceroom_Alice_7);
var lyr_stanza_Aliceroom_Alice_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_stanza_Aliceroom_Alice_7, 
                style: style_stanza_Aliceroom_Alice_7,
                popuplayertitle: 'stanza_Alice — room_Alice',
                interactive: true,
                title: '<img src="styles/legend/stanza_Aliceroom_Alice_7.png" /> stanza_Alice — room_Alice'
            });
var format_stanza_Aliceroom_Alice_8 = new ol.format.GeoJSON();
var features_stanza_Aliceroom_Alice_8 = format_stanza_Aliceroom_Alice_8.readFeatures(json_stanza_Aliceroom_Alice_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_stanza_Aliceroom_Alice_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_stanza_Aliceroom_Alice_8.addFeatures(features_stanza_Aliceroom_Alice_8);
var lyr_stanza_Aliceroom_Alice_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_stanza_Aliceroom_Alice_8, 
                style: style_stanza_Aliceroom_Alice_8,
                popuplayertitle: 'stanza_Alice — room_Alice',
                interactive: true,
                title: '<img src="styles/legend/stanza_Aliceroom_Alice_8.png" /> stanza_Alice — room_Alice'
            });
var format_legacy_infrastructure_2050_9 = new ol.format.GeoJSON();
var features_legacy_infrastructure_2050_9 = format_legacy_infrastructure_2050_9.readFeatures(json_legacy_infrastructure_2050_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_legacy_infrastructure_2050_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_legacy_infrastructure_2050_9.addFeatures(features_legacy_infrastructure_2050_9);
var lyr_legacy_infrastructure_2050_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_legacy_infrastructure_2050_9, 
                style: style_legacy_infrastructure_2050_9,
                popuplayertitle: 'legacy_infrastructure_2050',
                interactive: true,
                title: '<img src="styles/legend/legacy_infrastructure_2050_9.png" /> legacy_infrastructure_2050'
            });
var format_cnot17_events_10 = new ol.format.GeoJSON();
var features_cnot17_events_10 = format_cnot17_events_10.readFeatures(json_cnot17_events_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnot17_events_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnot17_events_10.addFeatures(features_cnot17_events_10);
var lyr_cnot17_events_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnot17_events_10, 
                style: style_cnot17_events_10,
                popuplayertitle: 'cnot17_events',
                interactive: true,
                title: '<img src="styles/legend/cnot17_events_10.png" /> cnot17_events'
            });
var format_visa_data_flows_11 = new ol.format.GeoJSON();
var features_visa_data_flows_11 = format_visa_data_flows_11.readFeatures(json_visa_data_flows_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_visa_data_flows_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_visa_data_flows_11.addFeatures(features_visa_data_flows_11);
var lyr_visa_data_flows_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_visa_data_flows_11, 
                style: style_visa_data_flows_11,
                popuplayertitle: 'visa_data_flows',
                interactive: true,
                title: '<img src="styles/legend/visa_data_flows_11.png" /> visa_data_flows'
            });
...
var format_convitto_base_localConvittoCardinalMoraesempiobase_14 = new ol.format.GeoJSON();
var features_convitto_base_localConvittoCardinalMoraesempiobase_14 = format_convitto_base_localConvittoCardinalMoraesempiobase_14.readFeatures(json_convitto_base_localConvittoCardinalMoraesempiobase_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_14.addFeatures(features_convitto_base_localConvittoCardinalMoraesempiobase_14);
var lyr_convitto_base_localConvittoCardinalMoraesempiobase_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_14, 
                style: style_convitto_base_localConvittoCardinalMoraesempiobase_14,
                popuplayertitle: 'convitto_base_local — Convitto Cardinal Mora - esempio base',
                interactive: true,
                title: '<img src="styles/legend/convitto_base_localConvittoCardinalMoraesempiobase_14.png" /> convitto_base_local — Convitto Cardinal Mora - esempio base'
            });
var format_cnotstrade_1_15 = new ol.format.GeoJSON();
var features_cnotstrade_1_15 = format_cnotstrade_1_15.readFeatures(json_cnotstrade_1_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_1_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_1_15.addFeatures(features_cnotstrade_1_15);
var lyr_cnotstrade_1_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_1_15, 
                style: style_cnotstrade_1_15,
                popuplayertitle: 'cnot — strade_1',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_1_15.png" /> cnot — strade_1'
            });
var format_cnotbuilding_16 = new ol.format.GeoJSON();
var features_cnotbuilding_16 = format_cnotbuilding_16.readFeatures(json_cnotbuilding_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotbuilding_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotbuilding_16.addFeatures(features_cnotbuilding_16);
var lyr_cnotbuilding_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotbuilding_16, 
                style: style_cnotbuilding_16,
                popuplayertitle: 'cnot — building',
                interactive: true,
                title: '<img src="styles/legend/cnotbuilding_16.png" /> cnot — building'
            });
var format_cnotstrade_2_17 = new ol.format.GeoJSON();
var features_cnotstrade_2_17 = format_cnotstrade_2_17.readFeatures(json_cnotstrade_2_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_2_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_2_17.addFeatures(features_cnotstrade_2_17);
var lyr_cnotstrade_2_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_2_17, 
                style: style_cnotstrade_2_17,
                popuplayertitle: 'cnot — strade_2',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_2_17.png" /> cnot — strade_2'
            });
...
var format_highway_20 = new ol.format.GeoJSON();
var features_highway_20 = format_highway_20.readFeatures(json_highway_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_highway_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_highway_20.addFeatures(features_highway_20);
var lyr_highway_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_highway_20, 
                style: style_highway_20,
                popuplayertitle: 'highway',
                interactive: true,
                title: '<img src="styles/legend/highway_20.png" /> highway'
            });
...
var format_building_22 = new ol.format.GeoJSON();
var features_building_22 = format_building_22.readFeatures(json_building_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_building_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_building_22.addFeatures(features_building_22);
var lyr_building_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_building_22, 
                style: style_building_22,
                popuplayertitle: 'building',
                interactive: true,
                title: '<img src="styles/legend/building_22.png" /> building'
            });
var format_cnotEdifici_23 = new ol.format.GeoJSON();
var features_cnotEdifici_23 = format_cnotEdifici_23.readFeatures(json_cnotEdifici_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotEdifici_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotEdifici_23.addFeatures(features_cnotEdifici_23);
var lyr_cnotEdifici_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotEdifici_23, 
                style: style_cnotEdifici_23,
                popuplayertitle: 'cnot — Edifici',
                interactive: true,
                title: '<img src="styles/legend/cnotEdifici_23.png" /> cnot — Edifici'
            });
var format_Telecamere_24 = new ol.format.GeoJSON();
var features_Telecamere_24 = format_Telecamere_24.readFeatures(json_Telecamere_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Telecamere_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Telecamere_24.addFeatures(features_Telecamere_24);
var lyr_Telecamere_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Telecamere_24, 
                style: style_Telecamere_24,
                popuplayertitle: 'Telecamere',
                interactive: true,
                title: '<img src="styles/legend/Telecamere_24.png" /> Telecamere'
            });
var format_Semafori_25 = new ol.format.GeoJSON();
var features_Semafori_25 = format_Semafori_25.readFeatures(json_Semafori_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Semafori_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Semafori_25.addFeatures(features_Semafori_25);
var lyr_Semafori_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Semafori_25, 
                style: style_Semafori_25,
                popuplayertitle: 'Semafori',
                interactive: true,
                title: '<img src="styles/legend/Semafori_25.png" /> Semafori'
            });
var format_cnotTinyhouses_26 = new ol.format.GeoJSON();
var features_cnotTinyhouses_26 = format_cnotTinyhouses_26.readFeatures(json_cnotTinyhouses_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotTinyhouses_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotTinyhouses_26.addFeatures(features_cnotTinyhouses_26);
var lyr_cnotTinyhouses_26 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotTinyhouses_26, 
                style: style_cnotTinyhouses_26,
                popuplayertitle: 'cnot — Tiny houses',
                interactive: true,
                title: '<img src="styles/legend/cnotTinyhouses_26.png" /> cnot — Tiny houses'
            });
var format_cnotparcheggiodroni_27 = new ol.format.GeoJSON();
var features_cnotparcheggiodroni_27 = format_cnotparcheggiodroni_27.readFeatures(json_cnotparcheggiodroni_27, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotparcheggiodroni_27 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotparcheggiodroni_27.addFeatures(features_cnotparcheggiodroni_27);
var lyr_cnotparcheggiodroni_27 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotparcheggiodroni_27, 
                style: style_cnotparcheggiodroni_27,
                popuplayertitle: 'cnot — parcheggio droni',
                interactive: true,
                title: '<img src="styles/legend/cnotparcheggiodroni_27.png" /> cnot — parcheggio droni'
            });
var format_ai_relations_28 = new ol.format.GeoJSON();
var features_ai_relations_28 = format_ai_relations_28.readFeatures(json_ai_relations_28, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_relations_28 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_relations_28.addFeatures(features_ai_relations_28);
var lyr_ai_relations_28 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_relations_28, 
                style: style_ai_relations_28,
                popuplayertitle: 'ai_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_relations_28.png" /> ai_relations'
            });
var format_ai_factories_29 = new ol.format.GeoJSON();
var features_ai_factories_29 = format_ai_factories_29.readFeatures(json_ai_factories_29, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_factories_29 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_factories_29.addFeatures(features_ai_factories_29);
var lyr_ai_factories_29 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_factories_29, 
                style: style_ai_factories_29,
                popuplayertitle: 'ai_factories',
                interactive: true,
                title: '<img src="styles/legend/ai_factories_29.png" /> ai_factories'
            });
var format_ai_actors_30 = new ol.format.GeoJSON();
var features_ai_actors_30 = format_ai_actors_30.readFeatures(json_ai_actors_30, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_actors_30 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_actors_30.addFeatures(features_ai_actors_30);
var lyr_ai_actors_30 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_actors_30, 
                style: style_ai_actors_30,
                popuplayertitle: 'ai_actors',
                interactive: true,
    title: 'ai_actors<br />\
    <img src="styles/legend/ai_actors_30_0.png" /> <br />\
    <img src="styles/legend/ai_actors_30_1.png" /> ai_hpc_integration<br />\
    <img src="styles/legend/ai_actors_30_2.png" /> ai_policy_regulation<br />\
    <img src="styles/legend/ai_actors_30_3.png" /> hpc_ai_infrastructure<br />' });
var format_qt_relations_31 = new ol.format.GeoJSON();
var features_qt_relations_31 = format_qt_relations_31.readFeatures(json_qt_relations_31, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_relations_31 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_relations_31.addFeatures(features_qt_relations_31);
var lyr_qt_relations_31 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_relations_31, 
                style: style_qt_relations_31,
                popuplayertitle: 'qt_relations',
                interactive: true,
    title: 'qt_relations<br />\
    <img src="styles/legend/qt_relations_31_0.png" /> component_supplier_for<br />\
    <img src="styles/legend/qt_relations_31_1.png" /> hosts<br />\
    <img src="styles/legend/qt_relations_31_2.png" /> hosts_or_operates<br />\
    <img src="styles/legend/qt_relations_31_3.png" /> supplier_of<br />\
    <img src="styles/legend/qt_relations_31_4.png" /> <br />' });
var format_qt_infrastructures_32 = new ol.format.GeoJSON();
var features_qt_infrastructures_32 = format_qt_infrastructures_32.readFeatures(json_qt_infrastructures_32, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_infrastructures_32 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_infrastructures_32.addFeatures(features_qt_infrastructures_32);
var lyr_qt_infrastructures_32 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_infrastructures_32, 
                style: style_qt_infrastructures_32,
                popuplayertitle: 'qt_infrastructures',
                interactive: true,
    title: 'qt_infrastructures<br />\
    <img src="styles/legend/qt_infrastructures_32_0.png" /> 12 - 21,6<br />\
    <img src="styles/legend/qt_infrastructures_32_1.png" /> 21,6 - 24,8<br />\
    <img src="styles/legend/qt_infrastructures_32_2.png" /> 24,8 - 63,2<br />\
    <img src="styles/legend/qt_infrastructures_32_3.png" /> 63,2 - 100<br />\
    <img src="styles/legend/qt_infrastructures_32_4.png" /> 100 - 140<br />' });
var format_qt_actors_33 = new ol.format.GeoJSON();
var features_qt_actors_33 = format_qt_actors_33.readFeatures(json_qt_actors_33, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_actors_33 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_actors_33.addFeatures(features_qt_actors_33);
var lyr_qt_actors_33 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_actors_33, 
                style: style_qt_actors_33,
                popuplayertitle: 'qt_actors',
                interactive: true,
    title: 'qt_actors<br />\
    <img src="styles/legend/qt_actors_33_0.png" /> company<br />\
    <img src="styles/legend/qt_actors_33_1.png" /> european_public_institution<br />\
    <img src="styles/legend/qt_actors_33_2.png" /> european_research_initiative<br />\
    <img src="styles/legend/qt_actors_33_3.png" /> hpc_research_center<br />\
    <img src="styles/legend/qt_actors_33_4.png" /> national_consortium<br />\
    <img src="styles/legend/qt_actors_33_5.png" /> <br />' });
var format_cnoteurope_34 = new ol.format.GeoJSON();
var features_cnoteurope_34 = format_cnoteurope_34.readFeatures(json_cnoteurope_34, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnoteurope_34 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnoteurope_34.addFeatures(features_cnoteurope_34);
var lyr_cnoteurope_34 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnoteurope_34, 
                style: style_cnoteurope_34,
                popuplayertitle: 'cnot — europe',
                interactive: true,
                title: '<img src="styles/legend/cnoteurope_34.png" /> cnot — europe'
            });
...
var group_quantum = new ol.layer.Group({
                                layers: [lyr_qt_relations_31,lyr_qt_infrastructures_32,lyr_qt_actors_33,],
                                fold: 'close',
                                title: 'quantum'});
var group_AI = new ol.layer.Group({
                                layers: [lyr_ai_relations_28,lyr_ai_factories_29,lyr_ai_actors_30,],
                                fold: 'close',
                                title: 'AI'});
...
var group_tinyhouses = new ol.layer.Group({
                                layers: [lyr_cnotTinyhouses_26,lyr_cnotparcheggiodroni_27,],
                                fold: 'close',
                                title: 'tiny houses'});
var group_Sorveglianza = new ol.layer.Group({
                                layers: [lyr_Telecamere_24,lyr_Semafori_25,],
                                fold: 'close',
                                title: 'Sorveglianza'});
var group_Zonadimenticata = new ol.layer.Group({
                                layers: [lyr_cnotEdifici_23,],
                                fold: 'close',
                                title: 'Zona dimenticata'});
var group_Topografia = new ol.layer.Group({
                                layers: [lyr_cnotstrade_1_15,lyr_cnotbuilding_16,lyr_cnotstrade_2_17,lyr_highway_18,lyr_highway_19,lyr_highway_20,lyr_building_21,lyr_building_22,],
                                fold: 'close',
                                title: 'Topografia'});
var group_Strutture_dismesse = new ol.layer.Group({
                                layers: [lyr_convitto_base_localConvittoCardinalMoraesempiobase_13,lyr_convitto_base_localConvittoCardinalMoraesempiobase_14,],
                                fold: 'close',
                                title: 'Strutture_dismesse'});
var group_2041 = new ol.layer.Group({
                                layers: [lyr_building_12,],
                                fold: 'open',
                                title: '2041'});
var group_TimelineCNOT17 = new ol.layer.Group({
                                layers: [lyr_legacy_infrastructure_2050_9,lyr_cnot17_events_10,lyr_visa_data_flows_11,],
                                fold: 'close',
                                title: 'Timeline CNOT 1.7'});
var group_casepersonaggi = new ol.layer.Group({
                                layers: [lyr_casa_caterina_3,lyr_casa_caterina_4,lyr_tiny_laura_5,lyr_tiny_laura_6,lyr_stanza_Aliceroom_Alice_7,lyr_stanza_Aliceroom_Alice_8,],
                                fold: 'close',
                                title: 'case personaggi'});
var group_stories = new ol.layer.Group({
                                layers: [lyr_alice_prologostory_points_2,],
                                fold: 'close',
                                title: 'stories'});
var group_distribuzionecibo = new ol.layer.Group({
                                layers: [lyr_FilieraAlimentarepuntodidistribuzione_1,],
                                fold: 'open',
...
lyr_ne_10m_admin_0_countries_0.setVisible(true);lyr_FilieraAlimentarepuntodidistribuzione_1.setVisible(true);lyr_alice_prologostory_points_2.setVisible(true);lyr_casa_caterina_3.setVisible(true);lyr_casa_caterina_4.setVisible(true);lyr_tiny_laura_5.setVisible(true);lyr_tiny_laura_6.setVisible(true);lyr_stanza_Aliceroom_Alice_7.setVisible(true);lyr_stanza_Aliceroom_Alice_8.setVisible(true);lyr_legacy_infrastructure_2050_9.setVisible(true);lyr_cnot17_events_10.setVisible(true);lyr_visa_data_flows_11.setVisible(true);lyr_building_12.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_13.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_14.setVisible(true);lyr_cnotstrade_1_15.setVisible(true);lyr_cnotbuilding_16.setVisible(true);lyr_cnotstrade_2_17.setVisible(true);lyr_highway_18.setVisible(true);lyr_highway_19.setVisible(true);lyr_highway_20.setVisible(true);lyr_building_21.setVisible(true);lyr_building_22.setVisible(true);lyr_cnotEdifici_23.setVisible(true);lyr_Telecamere_24.setVisible(true);lyr_Semafori_25.setVisible(true);lyr_cnotTinyhouses_26.setVisible(true);lyr_cnotparcheggiodroni_27.setVisible(true);lyr_ai_relations_28.setVisible(true);lyr_ai_factories_29.setVisible(true);lyr_ai_actors_30.setVisible(true);lyr_qt_relations_31.setVisible(true);lyr_qt_infrastructures_32.setVisible(true);lyr_qt_actors_33.setVisible(true);lyr_cnoteurope_34.setVisible(true);
var layersList = [group_paesi,group_distribuzionecibo,group_stories,group_casepersonaggi,group_TimelineCNOT17,group_2041,group_Strutture_dismesse,group_Topografia,group_Zonadimenticata,group_Sorveglianza,group_tinyhouses,group_AI,group_quantum,lyr_cnoteurope_34];
...
lyr_FilieraAlimentarepuntodidistribuzione_1.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'Nome': 'Nome', });
lyr_alice_prologostory_points_2.set('fieldAliases', {'id': 'id', 'reader_type': 'reader_type', 'kind': 'kind', 'story_title': 'story_title', 'story_url': 'story_url', 'target': 'target', });
lyr_casa_caterina_3.set('fieldAliases', {'label': 'label', 'segmento': 'segmento', 'tipo': 'tipo', 'universo': 'universo', 'descrizione': 'descrizione', 'show_label': 'show_label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', });
lyr_casa_caterina_4.set('fieldAliases', {'label': 'label', 'segmento': 'segmento', 'tipo': 'tipo', 'universo': 'universo', 'descrizione': 'descrizione', 'show_label': 'show_label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', });
lyr_tiny_laura_5.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'show_label': 'show_label', });
lyr_tiny_laura_6.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'show_label': 'show_label', });
lyr_stanza_Aliceroom_Alice_7.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'spatial_url': 'spatial_url', 'url_label': 'url_label', 'story_url': 'story_url', 'story_title': 'story_title', 'show_label': 'show_label', });
lyr_stanza_Aliceroom_Alice_8.set('fieldAliases', {'label': 'label', 'nome': 'nome', 'feature_role': 'feature_role', 'source': 'source', 'center_x': 'center_x', 'center_y': 'center_y', 'tipo': 'tipo', 'descrizione': 'descrizione', 'style': 'style', 'universo': 'universo', 'categoria': 'categoria', 'owner': 'owner', 'spatial_url': 'spatial_url', 'url_label': 'url_label', 'story_url': 'story_url', 'story_title': 'story_title', 'show_label': 'show_label', });
lyr_legacy_infrastructure_2050_9.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'stato': 'stato', 'proprietario': 'proprietario', 'livello_rischio': 'livello_rischio', 'funzione_narrativa': 'funzione_narrativa', 'note': 'note', 'anno_obsolescenza': 'anno_obsolescenza', 'anno_origine': 'anno_origine', });
lyr_cnot17_events_10.set('fieldAliases', {'fid': 'fid', 'event_id': 'event_id', 'titolo': 'titolo', 'timestamp_story': 'timestamp_story', 'capitolo': 'capitolo', 'luogo': 'luogo', 'personaggi': 'personaggi', 'tipo_evento': 'tipo_evento', 'oggetto_coinvolto': 'oggetto_coinvolto', 'stato_prima': 'stato_prima', 'stato_dopo': 'stato_dopo', 'conseguenza': 'conseguenza', 'visibile_al_lettore': 'visibile_al_lettore', 'note': 'note', 'artifact_json': 'artifact_json', });
lyr_visa_data_flows_11.set('fieldAliases', {'fid': 'fid', 'flow_id': 'flow_id', 'nome': 'nome', 'origine': 'origine', 'destinazione': 'destinazione', 'timestamp_story': 'timestamp_story', 'protocollo_narrativo': 'protocollo_narrativo', 'criticita': 'criticita', 'stato': 'stato', 'funzione_narrativa': 'funzione_narrativa', 'Note': 'Note', });
lyr_building_12.set('fieldAliases', {});
...
lyr_FilieraAlimentarepuntodidistribuzione_1.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'Nome': 'TextEdit', });
lyr_alice_prologostory_points_2.set('fieldImages', {'id': 'TextEdit', 'reader_type': '', 'kind': 'TextEdit', 'story_title': '', 'story_url': '', 'target': 'TextEdit', });
lyr_casa_caterina_3.set('fieldImages', {'label': 'TextEdit', 'segmento': 'Range', 'tipo': 'TextEdit', 'universo': 'TextEdit', 'descrizione': 'TextEdit', 'show_label': 'CheckBox', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', });
lyr_casa_caterina_4.set('fieldImages', {'label': 'TextEdit', 'segmento': 'Range', 'tipo': 'TextEdit', 'universo': 'TextEdit', 'descrizione': 'TextEdit', 'show_label': 'CheckBox', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', });
lyr_tiny_laura_5.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'show_label': 'CheckBox', });
lyr_tiny_laura_6.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'show_label': 'CheckBox', });
lyr_stanza_Aliceroom_Alice_7.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'spatial_url': 'TextEdit', 'url_label': 'TextEdit', 'story_url': '', 'story_title': '', 'show_label': 'CheckBox', });
lyr_stanza_Aliceroom_Alice_8.set('fieldImages', {'label': 'TextEdit', 'nome': 'TextEdit', 'feature_role': 'TextEdit', 'source': 'TextEdit', 'center_x': 'TextEdit', 'center_y': 'TextEdit', 'tipo': 'TextEdit', 'descrizione': 'TextEdit', 'style': 'TextEdit', 'universo': 'TextEdit', 'categoria': 'TextEdit', 'owner': 'TextEdit', 'spatial_url': 'TextEdit', 'url_label': 'TextEdit', 'story_url': '', 'story_title': '', 'show_label': 'CheckBox', });
lyr_legacy_infrastructure_2050_9.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'stato': 'TextEdit', 'proprietario': 'TextEdit', 'livello_rischio': 'TextEdit', 'funzione_narrativa': 'TextEdit', 'note': 'TextEdit', 'anno_obsolescenza': 'Range', 'anno_origine': 'Range', });
lyr_cnot17_events_10.set('fieldImages', {'fid': '', 'event_id': '', 'titolo': '', 'timestamp_story': '', 'capitolo': '', 'luogo': '', 'personaggi': '', 'tipo_evento': '', 'oggetto_coinvolto': '', 'stato_prima': '', 'stato_dopo': '', 'conseguenza': '', 'visibile_al_lettore': '', 'note': '', 'artifact_json': '', });
lyr_visa_data_flows_11.set('fieldImages', {'fid': 'TextEdit', 'flow_id': 'TextEdit', 'nome': 'TextEdit', 'origine': 'TextEdit', 'destinazione': 'TextEdit', 'timestamp_story': 'TextEdit', 'protocollo_narrativo': 'TextEdit', 'criticita': 'TextEdit', 'stato': 'TextEdit', 'funzione_narrativa': 'TextEdit', 'Note': 'TextEdit', });
lyr_building_12.set('fieldImages', {});
...
lyr_highway_19.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'turn:lanes': '', 'covered': '', 'footway:surface': '', 'cycleway:surface': '', 'tactile_paving': '', 'shelter': '', 'public_transport': '', 'network': '', 'bus': '', 'bin': '', 'bench': '', 'horse': '', 'cycleway': '', 'level': '', 'toilets': '', 'turn:lanes:forward': '', 'wheelchair': '', 'source:maxspeed': '', 'shoulder': '', 'embankment': '', 'maxweight:signed': '', 'turn:lanes:backward': '', 'loc_name': '', 'lanes:forward': '', 'lanes:backward': '', 'cycleway:left': '', 'width': '', 'sidewalk:both': '', 'lit': '', 'tunnel': '', 'junction': '', 'tracktype': '', 'access': '', 'lane_markings': '', 'sidewalk': '', 'cycleway:both': '', 'cycleway:right': '', 'segregated': '', 'foot': '', 'bicycle': '', 'service': '', 'layer': '', 'bridge': '', 'toll': '', 'surface': '', 'smoothness': '', 'ref': '', 'oneway': '', 'maxspeed': '', 'lanes': '', 'name': '', });
lyr_highway_20.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', });
lyr_building_21.set('fieldImages', {'fid': '', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'addr:city': 'TextEdit', 'power': 'TextEdit', 'design': 'TextEdit', 'amenity': 'TextEdit', 'shop': 'TextEdit', 'name': 'TextEdit', 'addr:street': 'TextEdit', 'addr:housenumber': 'TextEdit', 'addr:housename': 'TextEdit', 'entrance': 'TextEdit', 'barrier': 'TextEdit', });
lyr_building_22.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'building': 'TextEdit', 'takeaway': 'TextEdit', 'drive_through': 'TextEdit', 'brand:wikipedia': 'TextEdit', 'ref:mise': 'TextEdit', 'fuel:octane_95': 'TextEdit', 'fuel:octane_100': 'TextEdit', 'fuel:lpg': 'TextEdit', 'fuel:diesel': 'TextEdit', 'fuel:GTL_diesel': 'TextEdit', 'wikipedia': 'TextEdit', 'layer': 'TextEdit', 'power': 'TextEdit', 'generator:source': 'TextEdit', 'generator:output:electricity': 'TextEdit', 'website': 'TextEdit', 'branch': 'TextEdit', 'wheelchair': 'TextEdit', 'second_hand': 'TextEdit', 'safety_inspection': 'TextEdit', 'repair': 'TextEdit', 'rental': 'TextEdit', 'payment:visa_electron': 'TextEdit', 'payment:visa_debit': 'TextEdit', 'payment:visa': 'TextEdit', 'payment:notes': 'TextEdit', 'payment:mastercard': 'TextEdit', 'payment:maestro': 'TextEdit', 'payment:diners_club': 'TextEdit', 'payment:contactless': 'TextEdit', 'payment:coins': 'TextEdit', 'payment:bancomat': 'TextEdit', 'parts': 'TextEdit', 'clothes': 'TextEdit', 'addr:province': 'TextEdit', 'man_made': 'TextEdit', 'cuisine': 'TextEdit', 'addr:postcode': 'TextEdit', 'ruins': 'TextEdit', 'wikidata': 'TextEdit', 'religion': 'TextEdit', 'amenity': 'TextEdit', 'industrial': 'TextEdit', 'tourism': 'TextEdit', 'brand:wikidata': 'TextEdit', 'height': 'TextEdit', 'building:levels': 'TextEdit', 'addr:city': 'TextEdit', 'brand': 'TextEdit', 'name': 'TextEdit', 'shop': 'TextEdit', 'operator': 'TextEdit', 'addr:street': 'TextEdit', 'addr:housenumber': 'TextEdit', 'type': 'TextEdit', });
lyr_cnotEdifici_23.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'building': 'TextEdit', 'religion': 'TextEdit', 'denomination': 'TextEdit', 'amenity': 'TextEdit', 'name': 'TextEdit', });
lyr_Telecamere_24.set('fieldImages', {'fid': '', 'id': '', 'nome': '', 'tipo': '', 'note': '', });
lyr_Semafori_25.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'crossing:island': '', 'supervised': '', 'traffic_signals:direction': '', 'traffic_signals': '', 'traffic_signals:vibration': '', 'traffic_signals:sound': '', 'tactile_paving': '', 'crossing': '', 'button_operated': '', 'source:def': '', 'name': '', });
lyr_cnotTinyhouses_26.set('fieldImages', {'fid': '', 'id': '', 'Proprietario': '', });
lyr_cnotparcheggiodroni_27.set('fieldImages', {'fid': '', });
lyr_ai_relations_28.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_factories_29.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'factory_type': 'TextEdit', 'selection_batch': 'TextEdit', 'host_entity': 'TextEdit', 'supercomputer_or_system': 'TextEdit', 'compute_note': 'TextEdit', 'key_sectors': 'TextEdit', 'partner_countries': 'TextEdit', 'antennas': 'TextEdit', 'services_available_from': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_actors_30.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'main_domain': 'TextEdit', 'role': 'TextEdit', 'related_factories': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_relations_31.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_infrastructures_32.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'host': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'technology': 'TextEdit', 'platform': 'TextEdit', 'topology': 'TextEdit', 'qubits': 'Range', 'supplier': 'TextEdit', 'hosting_supercomputer': 'TextEdit', 'power_consumption': 'TextEdit', 'cooling_system': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_actors_33.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'main_domain': 'TextEdit', 'platform': 'TextEdit', 'role': 'TextEdit', 'developed_what': 'TextEdit', 'related_infrastructures': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_cnoteurope_34.set('fieldImages', {'fid': 'TextEdit', 'featurecla': 'TextEdit', 'scalerank': 'Range', 'labelrank': 'Range', 'sovereignt': 'TextEdit', 'sov_a3': 'TextEdit', 'adm0_dif': 'Range', 'level': 'Range', 'type': 'TextEdit', 'tlc': 'TextEdit', 'admin': 'TextEdit', 'adm0_a3': 'TextEdit', 'geou_dif': 'Range', 'geounit': 'TextEdit', 'gu_a3': 'TextEdit', 'su_dif': 'Range', 'subunit': 'TextEdit', 'su_a3': 'TextEdit', 'brk_diff': 'Range', 'name': 'TextEdit', 'name_long': 'TextEdit', 'brk_a3': 'TextEdit', 'brk_name': 'TextEdit', 'brk_group': 'TextEdit', 'abbrev': 'TextEdit', 'postal': 'TextEdit', 'formal_en': 'TextEdit', 'formal_fr': 'TextEdit', 'name_ciawf': 'TextEdit', 'note_adm0': 'TextEdit', 'note_brk': 'TextEdit', 'name_sort': 'TextEdit', 'name_alt': 'TextEdit', 'mapcolor7': 'Range', 'mapcolor8': 'Range', 'mapcolor9': 'Range', 'mapcolor13': 'Range', 'pop_est': 'Range', 'pop_rank': 'Range', 'pop_year': 'Range', 'gdp_md': 'Range', 'gdp_year': 'Range', 'economy': 'TextEdit', 'income_grp': 'TextEdit', 'fips_10': 'TextEdit', 'iso_a2': 'TextEdit', 'iso_a2_eh': 'TextEdit', 'iso_a3': 'TextEdit', 'iso_a3_eh': 'TextEdit', 'iso_n3': 'TextEdit', 'iso_n3_eh': 'TextEdit', 'un_a3': 'TextEdit', 'wb_a2': 'TextEdit', 'wb_a3': 'TextEdit', 'woe_id': 'Range', 'woe_id_eh': 'Range', 'woe_note': 'TextEdit', 'adm0_iso': 'TextEdit', 'adm0_diff': 'TextEdit', 'adm0_tlc': 'TextEdit', 'adm0_a3_us': 'TextEdit', 'adm0_a3_fr': 'TextEdit', 'adm0_a3_ru': 'TextEdit', 'adm0_a3_es': 'TextEdit', 'adm0_a3_cn': 'TextEdit', 'adm0_a3_tw': 'TextEdit', 'adm0_a3_in': 'TextEdit', 'adm0_a3_np': 'TextEdit', 'adm0_a3_pk': 'TextEdit', 'adm0_a3_de': 'TextEdit', 'adm0_a3_gb': 'TextEdit', 'adm0_a3_br': 'TextEdit', 'adm0_a3_il': 'TextEdit', 'adm0_a3_ps': 'TextEdit', 'adm0_a3_sa': 'TextEdit', 'adm0_a3_eg': 'TextEdit', 'adm0_a3_ma': 'TextEdit', 'adm0_a3_pt': 'TextEdit', 'adm0_a3_ar': 'TextEdit', 'adm0_a3_jp': 'TextEdit', 'adm0_a3_ko': 'TextEdit', 'adm0_a3_vn': 'TextEdit', 'adm0_a3_tr': 'TextEdit', 'adm0_a3_id': 'TextEdit', 'adm0_a3_pl': 'TextEdit', 'adm0_a3_gr': 'TextEdit', 'adm0_a3_it': 'TextEdit', 'adm0_a3_nl': 'TextEdit', 'adm0_a3_se': 'TextEdit', 'adm0_a3_bd': 'TextEdit', 'adm0_a3_ua': 'TextEdit', 'adm0_a3_un': 'Range', 'adm0_a3_wb': 'Range', 'continent': 'TextEdit', 'region_un': 'TextEdit', 'subregion': 'TextEdit', 'region_wb': 'TextEdit', 'name_len': 'Range', 'long_len': 'Range', 'abbrev_len': 'Range', 'tiny': 'Range', 'homepart': 'Range', 'min_zoom': 'Range', 'min_label': 'TextEdit', 'max_label': 'TextEdit', 'label_x': 'TextEdit', 'label_y': 'TextEdit', 'ne_id': 'Range', 'wikidataid': 'TextEdit', 'name_ar': 'TextEdit', 'name_bn': 'TextEdit', 'name_de': 'TextEdit', 'name_en': 'TextEdit', 'name_es': 'TextEdit', 'name_fa': 'TextEdit', 'name_fr': 'TextEdit', 'name_el': 'TextEdit', 'name_he': 'TextEdit', 'name_hi': 'TextEdit', 'name_hu': 'TextEdit', 'name_id': 'TextEdit', 'name_it': 'TextEdit', 'name_ja': 'TextEdit', 'name_ko': 'TextEdit', 'name_nl': 'TextEdit', 'name_pl': 'TextEdit', 'name_pt': 'TextEdit', 'name_ru': 'TextEdit', 'name_sv': 'TextEdit', 'name_tr': 'TextEdit', 'name_uk': 'TextEdit', 'name_ur': 'TextEdit', 'name_vi': 'TextEdit', 'name_zh': 'TextEdit', 'name_zht': 'TextEdit', 'fclass_iso': 'TextEdit', 'tlc_diff': 'TextEdit', 'fclass_tlc': 'TextEdit', 'fclass_us': 'TextEdit', 'fclass_fr': 'TextEdit', 'fclass_ru': 'TextEdit', 'fclass_es': 'TextEdit', 'fclass_cn': 'TextEdit', 'fclass_tw': 'TextEdit', 'fclass_in': 'TextEdit', 'fclass_np': 'TextEdit', 'fclass_pk': 'TextEdit', 'fclass_de': 'TextEdit', 'fclass_gb': 'TextEdit', 'fclass_br': 'TextEdit', 'fclass_il': 'TextEdit', 'fclass_ps': 'TextEdit', 'fclass_sa': 'TextEdit', 'fclass_eg': 'TextEdit', 'fclass_ma': 'TextEdit', 'fclass_pt': 'TextEdit', 'fclass_ar': 'TextEdit', 'fclass_jp': 'TextEdit', 'fclass_ko': 'TextEdit', 'fclass_vn': 'TextEdit', 'fclass_tr': 'TextEdit', 'fclass_id': 'TextEdit', 'fclass_pl': 'TextEdit', 'fclass_gr': 'TextEdit', 'fclass_it': 'TextEdit', 'fclass_nl': 'TextEdit', 'fclass_se': 'TextEdit', 'fclass_bd': 'TextEdit', 'fclass_ua': 'TextEdit', 'filename': 'TextEdit', });
...
lyr_FilieraAlimentarepuntodidistribuzione_1.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'Nome': 'no label', });
lyr_alice_prologostory_points_2.set('fieldLabels', {'id': 'no label', 'reader_type': 'no label', 'kind': 'no label', 'story_title': 'no label', 'story_url': 'no label', 'target': 'no label', });
lyr_casa_caterina_3.set('fieldLabels', {'label': 'no label', 'segmento': 'no label', 'tipo': 'no label', 'universo': 'no label', 'descrizione': 'no label', 'show_label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', });
lyr_casa_caterina_4.set('fieldLabels', {'label': 'no label', 'segmento': 'no label', 'tipo': 'no label', 'universo': 'no label', 'descrizione': 'no label', 'show_label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', });
lyr_tiny_laura_5.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'show_label': 'no label', });
lyr_tiny_laura_6.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'show_label': 'no label', });
lyr_stanza_Aliceroom_Alice_7.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'spatial_url': 'no label', 'url_label': 'no label', 'story_url': 'no label', 'story_title': 'no label', 'show_label': 'no label', });
lyr_stanza_Aliceroom_Alice_8.set('fieldLabels', {'label': 'no label', 'nome': 'no label', 'feature_role': 'no label', 'source': 'no label', 'center_x': 'no label', 'center_y': 'no label', 'tipo': 'no label', 'descrizione': 'no label', 'style': 'no label', 'universo': 'no label', 'categoria': 'no label', 'owner': 'no label', 'spatial_url': 'no label', 'url_label': 'no label', 'story_url': 'no label', 'story_title': 'no label', 'show_label': 'no label', });
lyr_legacy_infrastructure_2050_9.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'nome': 'no label', 'tipo': 'no label', 'stato': 'no label', 'proprietario': 'no label', 'livello_rischio': 'no label', 'funzione_narrativa': 'no label', 'note': 'no label', 'anno_obsolescenza': 'no label', 'anno_origine': 'no label', });
lyr_cnot17_events_10.set('fieldLabels', {'fid': 'no label', 'event_id': 'no label', 'titolo': 'no label', 'timestamp_story': 'no label', 'capitolo': 'no label', 'luogo': 'no label', 'personaggi': 'no label', 'tipo_evento': 'no label', 'oggetto_coinvolto': 'no label', 'stato_prima': 'no label', 'stato_dopo': 'no label', 'conseguenza': 'no label', 'visibile_al_lettore': 'no label', 'note': 'no label', 'artifact_json': 'no label', });
lyr_visa_data_flows_11.set('fieldLabels', {'fid': 'no label', 'flow_id': 'no label', 'nome': 'no label', 'origine': 'no label', 'destinazione': 'no label', 'timestamp_story': 'no label', 'protocollo_narrativo': 'no label', 'criticita': 'no label', 'stato': 'no label', 'funzione_narrativa': 'no label', 'Note': 'no label', });
lyr_building_12.set('fieldLabels', {});
...
lyr_highway_18.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'tracktype': 'no label', 'informal': 'no label', 'public_transport': 'no label', 'network': 'no label', 'bus': 'no label', 'maxweight:signed': 'no label', 'cycleway:right': 'no label', 'ref': 'no label', 'sidewalk:both': 'no label', 'junction': 'no label', 'destination:forward': 'no label', 'destination:backward': 'no label', 'tunnel': 'no label', 'access': 'no label', 'service': 'no label', 'destination:symbol': 'no label', 'destination:colour': 'no label', 'destination': 'no label', 'turn:lanes': 'no label', 'segregated': 'no label', 'cutting': 'no label', 'sidewalk:right': 'no label', 'cycleway:both': 'no label', 'lane_markings': 'no label', 'oneway': 'no label', 'motor_vehicle': 'no label', 'layer': 'no label', 'horse': 'no label', 'foot': 'no label', 'bridge': 'no label', 'width': 'no label', 'surface': 'no label', 'source:maxspeed': 'no label', 'name': 'no label', 'maxspeed': 'no label', 'lit': 'no label', 'lanes': 'no label', 'bicycle': 'no label', });
lyr_highway_19.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'turn:lanes': 'no label', 'covered': 'no label', 'footway:surface': 'no label', 'cycleway:surface': 'no label', 'tactile_paving': 'no label', 'shelter': 'no label', 'public_transport': 'no label', 'network': 'no label', 'bus': 'no label', 'bin': 'no label', 'bench': 'no label', 'horse': 'no label', 'cycleway': 'no label', 'level': 'no label', 'toilets': 'no label', 'turn:lanes:forward': 'no label', 'wheelchair': 'no label', 'source:maxspeed': 'no label', 'shoulder': 'no label', 'embankment': 'no label', 'maxweight:signed': 'no label', 'turn:lanes:backward': 'no label', 'loc_name': 'no label', 'lanes:forward': 'no label', 'lanes:backward': 'no label', 'cycleway:left': 'no label', 'width': 'no label', 'sidewalk:both': 'no label', 'lit': 'no label', 'tunnel': 'no label', 'junction': 'no label', 'tracktype': 'no label', 'access': 'no label', 'lane_markings': 'no label', 'sidewalk': 'no label', 'cycleway:both': 'no label', 'cycleway:right': 'no label', 'segregated': 'no label', 'foot': 'no label', 'bicycle': 'no label', 'service': 'no label', 'layer': 'no label', 'bridge': 'no label', 'toll': 'no label', 'surface': 'no label', 'smoothness': 'no label', 'ref': 'no label', 'oneway': 'no label', 'maxspeed': 'no label', 'lanes': 'no label', 'name': 'no label', });
lyr_highway_20.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', });
lyr_building_21.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'addr:city': 'no label', 'power': 'no label', 'design': 'no label', 'amenity': 'no label', 'shop': 'no label', 'name': 'no label', 'addr:street': 'no label', 'addr:housenumber': 'no label', 'addr:housename': 'no label', 'entrance': 'no label', 'barrier': 'no label', });
lyr_building_22.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'building': 'no label', 'takeaway': 'no label', 'drive_through': 'no label', 'brand:wikipedia': 'no label', 'ref:mise': 'no label', 'fuel:octane_95': 'no label', 'fuel:octane_100': 'no label', 'fuel:lpg': 'no label', 'fuel:diesel': 'no label', 'fuel:GTL_diesel': 'no label', 'wikipedia': 'no label', 'layer': 'no label', 'power': 'no label', 'generator:source': 'no label', 'generator:output:electricity': 'no label', 'website': 'no label', 'branch': 'no label', 'wheelchair': 'no label', 'second_hand': 'no label', 'safety_inspection': 'no label', 'repair': 'no label', 'rental': 'no label', 'payment:visa_electron': 'no label', 'payment:visa_debit': 'no label', 'payment:visa': 'no label', 'payment:notes': 'no label', 'payment:mastercard': 'no label', 'payment:maestro': 'no label', 'payment:diners_club': 'no label', 'payment:contactless': 'no label', 'payment:coins': 'no label', 'payment:bancomat': 'no label', 'parts': 'no label', 'clothes': 'no label', 'addr:province': 'no label', 'man_made': 'no label', 'cuisine': 'no label', 'addr:postcode': 'no label', 'ruins': 'no label', 'wikidata': 'no label', 'religion': 'no label', 'amenity': 'no label', 'industrial': 'no label', 'tourism': 'no label', 'brand:wikidata': 'no label', 'height': 'no label', 'building:levels': 'no label', 'addr:city': 'no label', 'brand': 'no label', 'name': 'no label', 'shop': 'no label', 'operator': 'no label', 'addr:street': 'no label', 'addr:housenumber': 'no label', 'type': 'no label', });
lyr_cnotEdifici_23.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'building': 'no label', 'religion': 'no label', 'denomination': 'no label', 'amenity': 'no label', 'name': 'no label', });
lyr_Telecamere_24.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'nome': 'no label', 'tipo': 'no label', 'note': 'no label', });
lyr_Semafori_25.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'crossing:island': 'no label', 'supervised': 'no label', 'traffic_signals:direction': 'no label', 'traffic_signals': 'no label', 'traffic_signals:vibration': 'no label', 'traffic_signals:sound': 'no label', 'tactile_paving': 'no label', 'crossing': 'no label', 'button_operated': 'no label', 'source:def': 'no label', 'name': 'no label', });
lyr_cnotTinyhouses_26.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'Proprietario': 'no label', });
lyr_cnotparcheggiodroni_27.set('fieldLabels', {'fid': 'no label', });
lyr_ai_relations_28.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_factories_29.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'country': 'no label', 'city': 'no label', 'factory_type': 'no label', 'selection_batch': 'no label', 'host_entity': 'no label', 'supercomputer_or_system': 'no label', 'compute_note': 'no label', 'key_sectors': 'no label', 'partner_countries': 'no label', 'antennas': 'no label', 'services_available_from': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_actors_30.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'country': 'no label', 'city': 'no label', 'main_domain': 'no label', 'role': 'no label', 'related_factories': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_relations_31.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_infrastructures_32.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'host': 'no label', 'city': 'no label', 'country': 'no label', 'technology': 'no label', 'platform': 'no label', 'topology': 'no label', 'qubits': 'no label', 'supplier': 'no label', 'hosting_supercomputer': 'no label', 'power_consumption': 'no label', 'cooling_system': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_actors_33.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'city': 'no label', 'country': 'no label', 'main_domain': 'no label', 'platform': 'no label', 'role': 'no label', 'developed_what': 'no label', 'related_infrastructures': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_cnoteurope_34.set('fieldLabels', {'fid': 'no label', 'featurecla': 'no label', 'scalerank': 'no label', 'labelrank': 'no label', 'sovereignt': 'no label', 'sov_a3': 'no label', 'adm0_dif': 'no label', 'level': 'no label', 'type': 'no label', 'tlc': 'no label', 'admin': 'no label', 'adm0_a3': 'no label', 'geou_dif': 'no label', 'geounit': 'no label', 'gu_a3': 'no label', 'su_dif': 'no label', 'subunit': 'no label', 'su_a3': 'no label', 'brk_diff': 'no label', 'name': 'no label', 'name_long': 'no label', 'brk_a3': 'no label', 'brk_name': 'no label', 'brk_group': 'no label', 'abbrev': 'no label', 'postal': 'no label', 'formal_en': 'no label', 'formal_fr': 'no label', 'name_ciawf': 'no label', 'note_adm0': 'no label', 'note_brk': 'no label', 'name_sort': 'no label', 'name_alt': 'no label', 'mapcolor7': 'no label', 'mapcolor8': 'no label', 'mapcolor9': 'no label', 'mapcolor13': 'no label', 'pop_est': 'no label', 'pop_rank': 'no label', 'pop_year': 'no label', 'gdp_md': 'no label', 'gdp_year': 'no label', 'economy': 'no label', 'income_grp': 'no label', 'fips_10': 'no label', 'iso_a2': 'no label', 'iso_a2_eh': 'no label', 'iso_a3': 'no label', 'iso_a3_eh': 'no label', 'iso_n3': 'no label', 'iso_n3_eh': 'no label', 'un_a3': 'no label', 'wb_a2': 'no label', 'wb_a3': 'no label', 'woe_id': 'no label', 'woe_id_eh': 'no label', 'woe_note': 'no label', 'adm0_iso': 'no label', 'adm0_diff': 'no label', 'adm0_tlc': 'no label', 'adm0_a3_us': 'no label', 'adm0_a3_fr': 'no label', 'adm0_a3_ru': 'no label', 'adm0_a3_es': 'no label', 'adm0_a3_cn': 'no label', 'adm0_a3_tw': 'no label', 'adm0_a3_in': 'no label', 'adm0_a3_np': 'no label', 'adm0_a3_pk': 'no label', 'adm0_a3_de': 'no label', 'adm0_a3_gb': 'no label', 'adm0_a3_br': 'no label', 'adm0_a3_il': 'no label', 'adm0_a3_ps': 'no label', 'adm0_a3_sa': 'no label', 'adm0_a3_eg': 'no label', 'adm0_a3_ma': 'no label', 'adm0_a3_pt': 'no label', 'adm0_a3_ar': 'no label', 'adm0_a3_jp': 'no label', 'adm0_a3_ko': 'no label', 'adm0_a3_vn': 'no label', 'adm0_a3_tr': 'no label', 'adm0_a3_id': 'no label', 'adm0_a3_pl': 'no label', 'adm0_a3_gr': 'no label', 'adm0_a3_it': 'no label', 'adm0_a3_nl': 'no label', 'adm0_a3_se': 'no label', 'adm0_a3_bd': 'no label', 'adm0_a3_ua': 'no label', 'adm0_a3_un': 'no label', 'adm0_a3_wb': 'no label', 'continent': 'no label', 'region_un': 'no label', 'subregion': 'no label', 'region_wb': 'no label', 'name_len': 'no label', 'long_len': 'no label', 'abbrev_len': 'no label', 'tiny': 'no label', 'homepart': 'no label', 'min_zoom': 'no label', 'min_label': 'no label', 'max_label': 'no label', 'label_x': 'no label', 'label_y': 'no label', 'ne_id': 'no label', 'wikidataid': 'no label', 'name_ar': 'no label', 'name_bn': 'no label', 'name_de': 'no label', 'name_en': 'no label', 'name_es': 'no label', 'name_fa': 'no label', 'name_fr': 'no label', 'name_el': 'no label', 'name_he': 'no label', 'name_hi': 'no label', 'name_hu': 'no label', 'name_id': 'no label', 'name_it': 'no label', 'name_ja': 'no label', 'name_ko': 'no label', 'name_nl': 'no label', 'name_pl': 'no label', 'name_pt': 'no label', 'name_ru': 'no label', 'name_sv': 'no label', 'name_tr': 'no label', 'name_uk': 'no label', 'name_ur': 'no label', 'name_vi': 'no label', 'name_zh': 'no label', 'name_zht': 'no label', 'fclass_iso': 'no label', 'tlc_diff': 'no label', 'fclass_tlc': 'no label', 'fclass_us': 'no label', 'fclass_fr': 'no label', 'fclass_ru': 'no label', 'fclass_es': 'no label', 'fclass_cn': 'no label', 'fclass_tw': 'no label', 'fclass_in': 'no label', 'fclass_np': 'no label', 'fclass_pk': 'no label', 'fclass_de': 'no label', 'fclass_gb': 'no label', 'fclass_br': 'no label', 'fclass_il': 'no label', 'fclass_ps': 'no label', 'fclass_sa': 'no label', 'fclass_eg': 'no label', 'fclass_ma': 'no label', 'fclass_pt': 'no label', 'fclass_ar': 'no label', 'fclass_jp': 'no label', 'fclass_ko': 'no label', 'fclass_vn': 'no label', 'fclass_tr': 'no label', 'fclass_id': 'no label', 'fclass_pl': 'no label', 'fclass_gr': 'no label', 'fclass_it': 'no label', 'fclass_nl': 'no label', 'fclass_se': 'no label', 'fclass_bd': 'no label', 'fclass_ua': 'no label', 'filename': 'no label', });
lyr_cnoteurope_34.on('precompose', function(evt) {
