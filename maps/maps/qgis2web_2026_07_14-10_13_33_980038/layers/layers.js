...
var format_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62 = new ol.format.GeoJSON();
var features_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62 = format_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62.readFeatures(json_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62.addFeatures(features_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62);
var lyr_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62, 
                style: style_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62,
                popuplayertitle: 'fpga_infrastructures_europe_simple — fpga_infrastructures_europe',
                interactive: true,
                title: '<img src="styles/legend/fpga_infrastructures_europe_simplefpga_infrastructures_europe_62.png" /> fpga_infrastructures_europe_simple — fpga_infrastructures_europe'
            });
...
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_61,lyr_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62,],
                                fold: 'close',
...
lyr_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62.set('fieldAliases', {'id': 'id', 'site_name': 'site_name', 'city': 'city', 'country': 'country', 'operator': 'operator', 'infra_type': 'infra_type', 'status': 'status', 'location_type': 'location_type', 'access_model': 'access_model', 'fpga_vendor': 'fpga_vendor', 'fpga_model': 'fpga_model', 'fpga_count': 'fpga_count', 'count_known': 'count_known', 'medical_ai': 'medical_ai', 'story_order': 'story_order', 'story_phase': 'story_phase', 'source_url': 'source_url', 'verified_on': 'verified_on', });
...
lyr_fpga_infrastructures_europe_simplefpga_infrastructures_europe_62.set('fieldImages', {'id': '', 'site_name': '', 'city': '', 'country': '', 'operator': '', 'infra_type': '', 'status': '', 'location_type': '', 'access_model': '', 'fpga_vendor': '', 'fpga_model': '', 'fpga_count': '', 'count_known': '', 'medical_ai': '', 'story_order': '', 'story_phase': '', 'source_url': '', 'verified_on': '', });
