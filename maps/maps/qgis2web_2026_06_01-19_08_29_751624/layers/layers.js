...
var format_legacy_infrastructure_2050_0 = new ol.format.GeoJSON();
var features_legacy_infrastructure_2050_0 = format_legacy_infrastructure_2050_0.readFeatures(json_legacy_infrastructure_2050_0, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_legacy_infrastructure_2050_0 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_legacy_infrastructure_2050_0.addFeatures(features_legacy_infrastructure_2050_0);
var lyr_legacy_infrastructure_2050_0 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_legacy_infrastructure_2050_0, 
                style: style_legacy_infrastructure_2050_0,
                popuplayertitle: 'legacy_infrastructure_2050',
                interactive: true,
                title: '<img src="styles/legend/legacy_infrastructure_2050_0.png" /> legacy_infrastructure_2050'
            });
var format_cnot17_events_1 = new ol.format.GeoJSON();
var features_cnot17_events_1 = format_cnot17_events_1.readFeatures(json_cnot17_events_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnot17_events_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnot17_events_1.addFeatures(features_cnot17_events_1);
var lyr_cnot17_events_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnot17_events_1, 
                style: style_cnot17_events_1,
                popuplayertitle: 'cnot17_events',
                interactive: true,
                title: '<img src="styles/legend/cnot17_events_1.png" /> cnot17_events'
            });
var format_visa_data_flows_2 = new ol.format.GeoJSON();
var features_visa_data_flows_2 = format_visa_data_flows_2.readFeatures(json_visa_data_flows_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_visa_data_flows_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_visa_data_flows_2.addFeatures(features_visa_data_flows_2);
var lyr_visa_data_flows_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_visa_data_flows_2, 
                style: style_visa_data_flows_2,
                popuplayertitle: 'visa_data_flows',
                interactive: true,
                title: '<img src="styles/legend/visa_data_flows_2.png" /> visa_data_flows'
            });
...
var format_cnotscuole_4 = new ol.format.GeoJSON();
var features_cnotscuole_4 = format_cnotscuole_4.readFeatures(json_cnotscuole_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotscuole_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotscuole_4.addFeatures(features_cnotscuole_4);
var lyr_cnotscuole_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotscuole_4, 
                style: style_cnotscuole_4,
                popuplayertitle: 'cnot — scuole',
                interactive: true,
                title: '<img src="styles/legend/cnotscuole_4.png" /> cnot — scuole'
            });
var format_convitto_base_localConvittoCardinalMoraesempiobase_5 = new ol.format.GeoJSON();
var features_convitto_base_localConvittoCardinalMoraesempiobase_5 = format_convitto_base_localConvittoCardinalMoraesempiobase_5.readFeatures(json_convitto_base_localConvittoCardinalMoraesempiobase_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_5.addFeatures(features_convitto_base_localConvittoCardinalMoraesempiobase_5);
var lyr_convitto_base_localConvittoCardinalMoraesempiobase_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_5, 
                style: style_convitto_base_localConvittoCardinalMoraesempiobase_5,
                popuplayertitle: 'convitto_base_local — Convitto Cardinal Mora - esempio base',
                interactive: true,
                title: '<img src="styles/legend/convitto_base_localConvittoCardinalMoraesempiobase_5.png" /> convitto_base_local — Convitto Cardinal Mora - esempio base'
            });
var format_convitto_base_localConvittoCardinalMoraesempiobase_6 = new ol.format.GeoJSON();
var features_convitto_base_localConvittoCardinalMoraesempiobase_6 = format_convitto_base_localConvittoCardinalMoraesempiobase_6.readFeatures(json_convitto_base_localConvittoCardinalMoraesempiobase_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_6.addFeatures(features_convitto_base_localConvittoCardinalMoraesempiobase_6);
var lyr_convitto_base_localConvittoCardinalMoraesempiobase_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_6, 
                style: style_convitto_base_localConvittoCardinalMoraesempiobase_6,
                popuplayertitle: 'convitto_base_local — Convitto Cardinal Mora - esempio base',
                interactive: true,
                title: '<img src="styles/legend/convitto_base_localConvittoCardinalMoraesempiobase_6.png" /> convitto_base_local — Convitto Cardinal Mora - esempio base'
            });
var format_cnotstrade_1_7 = new ol.format.GeoJSON();
var features_cnotstrade_1_7 = format_cnotstrade_1_7.readFeatures(json_cnotstrade_1_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_1_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_1_7.addFeatures(features_cnotstrade_1_7);
var lyr_cnotstrade_1_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_1_7, 
                style: style_cnotstrade_1_7,
                popuplayertitle: 'cnot — strade_1',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_1_7.png" /> cnot — strade_1'
            });
var format_cnotbuilding_8 = new ol.format.GeoJSON();
var features_cnotbuilding_8 = format_cnotbuilding_8.readFeatures(json_cnotbuilding_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotbuilding_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotbuilding_8.addFeatures(features_cnotbuilding_8);
var lyr_cnotbuilding_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotbuilding_8, 
                style: style_cnotbuilding_8,
                popuplayertitle: 'cnot — building',
                interactive: true,
                title: '<img src="styles/legend/cnotbuilding_8.png" /> cnot — building'
            });
var format_cnotstrade_2_9 = new ol.format.GeoJSON();
var features_cnotstrade_2_9 = format_cnotstrade_2_9.readFeatures(json_cnotstrade_2_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_2_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_2_9.addFeatures(features_cnotstrade_2_9);
var lyr_cnotstrade_2_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_2_9, 
                style: style_cnotstrade_2_9,
                popuplayertitle: 'cnot — strade_2',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_2_9.png" /> cnot — strade_2'
            });
var format_cnotEdifici_10 = new ol.format.GeoJSON();
var features_cnotEdifici_10 = format_cnotEdifici_10.readFeatures(json_cnotEdifici_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotEdifici_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotEdifici_10.addFeatures(features_cnotEdifici_10);
var lyr_cnotEdifici_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotEdifici_10, 
                style: style_cnotEdifici_10,
                popuplayertitle: 'cnot — Edifici',
                interactive: true,
                title: '<img src="styles/legend/cnotEdifici_10.png" /> cnot — Edifici'
            });
...
var format_Semafori_12 = new ol.format.GeoJSON();
var features_Semafori_12 = format_Semafori_12.readFeatures(json_Semafori_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Semafori_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Semafori_12.addFeatures(features_Semafori_12);
var lyr_Semafori_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Semafori_12, 
                style: style_Semafori_12,
                popuplayertitle: 'Semafori',
                interactive: true,
                title: '<img src="styles/legend/Semafori_12.png" /> Semafori'
            });
var format_cnotTinyhouses_13 = new ol.format.GeoJSON();
var features_cnotTinyhouses_13 = format_cnotTinyhouses_13.readFeatures(json_cnotTinyhouses_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotTinyhouses_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotTinyhouses_13.addFeatures(features_cnotTinyhouses_13);
var lyr_cnotTinyhouses_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotTinyhouses_13, 
                style: style_cnotTinyhouses_13,
                popuplayertitle: 'cnot — Tiny houses',
                interactive: true,
                title: '<img src="styles/legend/cnotTinyhouses_13.png" /> cnot — Tiny houses'
            });
var format_cnotparcheggiodroni_14 = new ol.format.GeoJSON();
var features_cnotparcheggiodroni_14 = format_cnotparcheggiodroni_14.readFeatures(json_cnotparcheggiodroni_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotparcheggiodroni_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotparcheggiodroni_14.addFeatures(features_cnotparcheggiodroni_14);
var lyr_cnotparcheggiodroni_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotparcheggiodroni_14, 
                style: style_cnotparcheggiodroni_14,
                popuplayertitle: 'cnot — parcheggio droni',
                interactive: true,
                title: '<img src="styles/legend/cnotparcheggiodroni_14.png" /> cnot — parcheggio droni'
            });
var format_datacenter_15 = new ol.format.GeoJSON();
var features_datacenter_15 = format_datacenter_15.readFeatures(json_datacenter_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_datacenter_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_datacenter_15.addFeatures(features_datacenter_15);
var lyr_datacenter_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_datacenter_15, 
                style: style_datacenter_15,
                popuplayertitle: 'datacenter',
                interactive: true,
                title: '<img src="styles/legend/datacenter_15.png" /> datacenter'
            });
var format_cnoteurope_16 = new ol.format.GeoJSON();
var features_cnoteurope_16 = format_cnoteurope_16.readFeatures(json_cnoteurope_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnoteurope_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnoteurope_16.addFeatures(features_cnoteurope_16);
var lyr_cnoteurope_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnoteurope_16, 
                style: style_cnoteurope_16,
                popuplayertitle: 'cnot — europe',
                interactive: true,
                title: '<img src="styles/legend/cnoteurope_16.png" /> cnot — europe'
            });
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_15,],
                                fold: 'open',
...
var group_tinyhouses = new ol.layer.Group({
                                layers: [lyr_cnotTinyhouses_13,lyr_cnotparcheggiodroni_14,],
                                fold: 'close',
                                title: 'tiny houses'});
var group_Sorveglianza = new ol.layer.Group({
                                layers: [lyr_Telecamere_11,lyr_Semafori_12,],
                                fold: 'close',
                                title: 'Sorveglianza'});
var group_Zonadimenticata = new ol.layer.Group({
                                layers: [lyr_cnotEdifici_10,],
                                fold: 'close',
                                title: 'Zona dimenticata'});
var group_Topografia = new ol.layer.Group({
                                layers: [lyr_cnotstrade_1_7,lyr_cnotbuilding_8,lyr_cnotstrade_2_9,],
                                fold: 'close',
                                title: 'Topografia'});
var group_Strutture_dismesse = new ol.layer.Group({
                                layers: [lyr_cnotscuole_4,lyr_convitto_base_localConvittoCardinalMoraesempiobase_5,lyr_convitto_base_localConvittoCardinalMoraesempiobase_6,],
                                fold: 'close',
                                title: 'Strutture_dismesse'});
var group_Narrativa = new ol.layer.Group({
                                layers: [lyr_building_3,],
                                fold: 'open',
                                title: 'Narrativa'});
var group_TimelineCNOT17 = new ol.layer.Group({
                                layers: [lyr_legacy_infrastructure_2050_0,lyr_cnot17_events_1,lyr_visa_data_flows_2,],
                                fold: 'open',
                                title: 'Timeline CNOT 1.7'});

lyr_legacy_infrastructure_2050_0.setVisible(true);lyr_cnot17_events_1.setVisible(true);lyr_visa_data_flows_2.setVisible(true);lyr_building_3.setVisible(true);lyr_cnotscuole_4.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_5.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_6.setVisible(true);lyr_cnotstrade_1_7.setVisible(true);lyr_cnotbuilding_8.setVisible(true);lyr_cnotstrade_2_9.setVisible(true);lyr_cnotEdifici_10.setVisible(true);lyr_Telecamere_11.setVisible(true);lyr_Semafori_12.setVisible(true);lyr_cnotTinyhouses_13.setVisible(true);lyr_cnotparcheggiodroni_14.setVisible(true);lyr_datacenter_15.setVisible(true);lyr_cnoteurope_16.setVisible(true);
var layersList = [group_TimelineCNOT17,group_Narrativa,group_Strutture_dismesse,group_Topografia,group_Zonadimenticata,group_Sorveglianza,group_tinyhouses,group_01_DATI_INFRASTRUTTURA_DIGITALE,lyr_cnoteurope_16];
lyr_legacy_infrastructure_2050_0.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'stato': 'stato', 'proprietario': 'proprietario', 'livello_rischio': 'livello_rischio', 'funzione_narrativa': 'funzione_narrativa', 'note': 'note', 'anno_obsolescenza': 'anno_obsolescenza', 'anno_origine': 'anno_origine', });
...
lyr_visa_data_flows_2.set('fieldAliases', {'fid': 'fid', 'flow_id': 'flow_id', 'nome': 'nome', 'origine': 'origine', 'destinazione': 'destinazione', 'timestamp_story': 'timestamp_story', 'protocollo_narrativo': 'protocollo_narrativo', 'criticita': 'criticita', 'stato': 'stato', 'funzione_narrativa': 'funzione_narrativa', 'Note': 'Note', });
...
lyr_cnotEdifici_10.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'building': 'building', 'religion': 'religion', 'denomination': 'denomination', 'amenity': 'amenity', 'name': 'name', });
lyr_Telecamere_11.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'note': 'note', });
lyr_Semafori_12.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'crossing:island': 'crossing:island', 'supervised': 'supervised', 'traffic_signals:direction': 'traffic_signals:direction', 'traffic_signals': 'traffic_signals', 'traffic_signals:vibration': 'traffic_signals:vibration', 'traffic_signals:sound': 'traffic_signals:sound', 'tactile_paving': 'tactile_paving', 'crossing': 'crossing', 'button_operated': 'button_operated', 'source:def': 'source:def', 'name': 'name', });
lyr_cnotTinyhouses_13.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'Proprietario': 'Proprietario', });
lyr_cnotparcheggiodroni_14.set('fieldAliases', {'fid': 'fid', });
lyr_datacenter_15.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'company': 'company', 'city': 'city', 'state': 'state', 'country': 'country', 'address': 'address', });
...
lyr_legacy_infrastructure_2050_0.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'stato': 'TextEdit', 'proprietario': 'TextEdit', 'livello_rischio': 'TextEdit', 'funzione_narrativa': 'TextEdit', 'note': 'TextEdit', 'anno_obsolescenza': 'Range', 'anno_origine': 'Range', });
lyr_cnot17_events_1.set('fieldImages', {'fid': '', 'event_id': '', 'titolo': '', 'timestamp_story': '', 'capitolo': '', 'luogo': '', 'personaggi': '', 'tipo_evento': '', 'oggetto_coinvolto': '', 'stato_prima': '', 'stato_dopo': '', 'conseguenza': '', 'visibile_al_lettore': '', 'note': '', 'artifact_json': '', });
lyr_visa_data_flows_2.set('fieldImages', {'fid': 'TextEdit', 'flow_id': 'TextEdit', 'nome': 'TextEdit', 'origine': 'TextEdit', 'destinazione': 'TextEdit', 'timestamp_story': 'TextEdit', 'protocollo_narrativo': 'TextEdit', 'criticita': 'TextEdit', 'stato': 'TextEdit', 'funzione_narrativa': 'TextEdit', 'Note': 'TextEdit', });
...
lyr_cnotEdifici_10.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'building': 'TextEdit', 'religion': 'TextEdit', 'denomination': 'TextEdit', 'amenity': 'TextEdit', 'name': 'TextEdit', });
lyr_Telecamere_11.set('fieldImages', {'fid': '', 'id': '', 'nome': '', 'tipo': '', 'note': '', });
lyr_Semafori_12.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'crossing:island': '', 'supervised': '', 'traffic_signals:direction': '', 'traffic_signals': '', 'traffic_signals:vibration': '', 'traffic_signals:sound': '', 'tactile_paving': '', 'crossing': '', 'button_operated': '', 'source:def': '', 'name': '', });
lyr_cnotTinyhouses_13.set('fieldImages', {'fid': '', 'id': '', 'Proprietario': '', });
lyr_cnotparcheggiodroni_14.set('fieldImages', {'fid': '', });
lyr_datacenter_15.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', 'company': 'TextEdit', 'city': 'TextEdit', 'state': 'TextEdit', 'country': 'TextEdit', 'address': 'TextEdit', });
...
lyr_legacy_infrastructure_2050_0.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'nome': 'no label', 'tipo': 'no label', 'stato': 'no label', 'proprietario': 'no label', 'livello_rischio': 'no label', 'funzione_narrativa': 'no label', 'note': 'no label', 'anno_obsolescenza': 'no label', 'anno_origine': 'no label', });
...
lyr_cnotEdifici_10.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'building': 'no label', 'religion': 'no label', 'denomination': 'no label', 'amenity': 'no label', 'name': 'no label', });
lyr_Telecamere_11.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'nome': 'no label', 'tipo': 'no label', 'note': 'no label', });
lyr_Semafori_12.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'crossing:island': 'no label', 'supervised': 'no label', 'traffic_signals:direction': 'no label', 'traffic_signals': 'no label', 'traffic_signals:vibration': 'no label', 'traffic_signals:sound': 'no label', 'tactile_paving': 'no label', 'crossing': 'no label', 'button_operated': 'no label', 'source:def': 'no label', 'name': 'no label', });
lyr_cnotTinyhouses_13.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'Proprietario': 'no label', });
lyr_cnotparcheggiodroni_14.set('fieldLabels', {'fid': 'no label', });
lyr_datacenter_15.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'company': 'no label', 'city': 'no label', 'state': 'no label', 'country': 'no label', 'address': 'no label', });
...
lyr_cnoteurope_16.on('precompose', function(evt) {
