...
var format_02_uranium_conversion_51 = new ol.format.GeoJSON();
var features_02_uranium_conversion_51 = format_02_uranium_conversion_51.readFeatures(json_02_uranium_conversion_51, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_02_uranium_conversion_51 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_02_uranium_conversion_51.addFeatures(features_02_uranium_conversion_51);
var lyr_02_uranium_conversion_51 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_02_uranium_conversion_51, 
                style: style_02_uranium_conversion_51,
                popuplayertitle: '02_uranium_conversion',
                interactive: true,
                title: '<img src="styles/legend/02_uranium_conversion_51.png" /> 02_uranium_conversion'
            });
var format_03_uranium_enrichment_52 = new ol.format.GeoJSON();
var features_03_uranium_enrichment_52 = format_03_uranium_enrichment_52.readFeatures(json_03_uranium_enrichment_52, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_03_uranium_enrichment_52 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_03_uranium_enrichment_52.addFeatures(features_03_uranium_enrichment_52);
var lyr_03_uranium_enrichment_52 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_03_uranium_enrichment_52, 
                style: style_03_uranium_enrichment_52,
                popuplayertitle: '03_uranium_enrichment',
                interactive: true,
                title: '<img src="styles/legend/03_uranium_enrichment_52.png" /> 03_uranium_enrichment'
            });
var format_04_fuel_fabrication_53 = new ol.format.GeoJSON();
var features_04_fuel_fabrication_53 = format_04_fuel_fabrication_53.readFeatures(json_04_fuel_fabrication_53, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_04_fuel_fabrication_53 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_04_fuel_fabrication_53.addFeatures(features_04_fuel_fabrication_53);
var lyr_04_fuel_fabrication_53 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_04_fuel_fabrication_53, 
                style: style_04_fuel_fabrication_53,
                popuplayertitle: '04_fuel_fabrication',
                interactive: true,
                title: '<img src="styles/legend/04_fuel_fabrication_53.png" /> 04_fuel_fabrication'
            });
var format_05_reprocessing_recycling_54 = new ol.format.GeoJSON();
var features_05_reprocessing_recycling_54 = format_05_reprocessing_recycling_54.readFeatures(json_05_reprocessing_recycling_54, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_05_reprocessing_recycling_54 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_05_reprocessing_recycling_54.addFeatures(features_05_reprocessing_recycling_54);
var lyr_05_reprocessing_recycling_54 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_05_reprocessing_recycling_54, 
                style: style_05_reprocessing_recycling_54,
                popuplayertitle: '05_reprocessing_recycling',
                interactive: true,
                title: '<img src="styles/legend/05_reprocessing_recycling_54.png" /> 05_reprocessing_recycling'
            });
var format_06_interim_storage_55 = new ol.format.GeoJSON();
var features_06_interim_storage_55 = format_06_interim_storage_55.readFeatures(json_06_interim_storage_55, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_06_interim_storage_55 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_06_interim_storage_55.addFeatures(features_06_interim_storage_55);
var lyr_06_interim_storage_55 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_06_interim_storage_55, 
                style: style_06_interim_storage_55,
                popuplayertitle: '06_interim_storage',
                interactive: true,
                title: '<img src="styles/legend/06_interim_storage_55.png" /> 06_interim_storage'
            });
var format_07_geological_repositories_56 = new ol.format.GeoJSON();
var features_07_geological_repositories_56 = format_07_geological_repositories_56.readFeatures(json_07_geological_repositories_56, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_07_geological_repositories_56 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_07_geological_repositories_56.addFeatures(features_07_geological_repositories_56);
var lyr_07_geological_repositories_56 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_07_geological_repositories_56, 
                style: style_07_geological_repositories_56,
                popuplayertitle: '07_geological_repositories',
                interactive: true,
                title: '<img src="styles/legend/07_geological_repositories_56.png" /> 07_geological_repositories'
            });
var format_08_nuclear_research_57 = new ol.format.GeoJSON();
var features_08_nuclear_research_57 = format_08_nuclear_research_57.readFeatures(json_08_nuclear_research_57, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_08_nuclear_research_57 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_08_nuclear_research_57.addFeatures(features_08_nuclear_research_57);
var lyr_08_nuclear_research_57 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_08_nuclear_research_57, 
                style: style_08_nuclear_research_57,
                popuplayertitle: '08_nuclear_research',
                interactive: true,
                title: '<img src="styles/legend/08_nuclear_research_57.png" /> 08_nuclear_research'
            });
var format_09_nuclear_power_switzerland_58 = new ol.format.GeoJSON();
var features_09_nuclear_power_switzerland_58 = format_09_nuclear_power_switzerland_58.readFeatures(json_09_nuclear_power_switzerland_58, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_09_nuclear_power_switzerland_58 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_09_nuclear_power_switzerland_58.addFeatures(features_09_nuclear_power_switzerland_58);
var lyr_09_nuclear_power_switzerland_58 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_09_nuclear_power_switzerland_58, 
                style: style_09_nuclear_power_switzerland_58,
                popuplayertitle: '09_nuclear_power_switzerland',
                interactive: true,
                title: '<img src="styles/legend/09_nuclear_power_switzerland_58.png" /> 09_nuclear_power_switzerland'
            });
var format_ai_compute_relations_59 = new ol.format.GeoJSON();
var features_ai_compute_relations_59 = format_ai_compute_relations_59.readFeatures(json_ai_compute_relations_59, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_compute_relations_59 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_compute_relations_59.addFeatures(features_ai_compute_relations_59);
var lyr_ai_compute_relations_59 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_compute_relations_59, 
                style: style_ai_compute_relations_59,
                popuplayertitle: 'ai_compute_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_compute_relations_59.png" /> ai_compute_relations'
            });
var format_ai_supercomputers_60 = new ol.format.GeoJSON();
var features_ai_supercomputers_60 = format_ai_supercomputers_60.readFeatures(json_ai_supercomputers_60, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_supercomputers_60 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_supercomputers_60.addFeatures(features_ai_supercomputers_60);
var lyr_ai_supercomputers_60 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_supercomputers_60, 
                style: style_ai_supercomputers_60,
                popuplayertitle: 'ai_supercomputers',
                interactive: true,
                title: '<img src="styles/legend/ai_supercomputers_60.png" /> ai_supercomputers'
            });
var format_ai_relations_61 = new ol.format.GeoJSON();
var features_ai_relations_61 = format_ai_relations_61.readFeatures(json_ai_relations_61, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_relations_61 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_relations_61.addFeatures(features_ai_relations_61);
var lyr_ai_relations_61 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_relations_61, 
                style: style_ai_relations_61,
                popuplayertitle: 'ai_relations',
                interactive: true,
                title: '<img src="styles/legend/ai_relations_61.png" /> ai_relations'
            });
var format_ai_factories_62 = new ol.format.GeoJSON();
var features_ai_factories_62 = format_ai_factories_62.readFeatures(json_ai_factories_62, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_factories_62 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_factories_62.addFeatures(features_ai_factories_62);
var lyr_ai_factories_62 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_factories_62, 
                style: style_ai_factories_62,
                popuplayertitle: 'ai_factories',
                interactive: true,
                title: '<img src="styles/legend/ai_factories_62.png" /> ai_factories'
            });
var format_ai_actors_63 = new ol.format.GeoJSON();
var features_ai_actors_63 = format_ai_actors_63.readFeatures(json_ai_actors_63, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ai_actors_63 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ai_actors_63.addFeatures(features_ai_actors_63);
var lyr_ai_actors_63 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ai_actors_63, 
                style: style_ai_actors_63,
                popuplayertitle: 'ai_actors',
                interactive: true,
    title: 'ai_actors<br />\
    <img src="styles/legend/ai_actors_63_0.png" /> <br />\
    <img src="styles/legend/ai_actors_63_1.png" /> ai_hpc_integration<br />\
    <img src="styles/legend/ai_actors_63_2.png" /> ai_policy_regulation<br />\
    <img src="styles/legend/ai_actors_63_3.png" /> hpc_ai_infrastructure<br />' });
var format_qt_relations_64 = new ol.format.GeoJSON();
var features_qt_relations_64 = format_qt_relations_64.readFeatures(json_qt_relations_64, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_relations_64 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_relations_64.addFeatures(features_qt_relations_64);
var lyr_qt_relations_64 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_relations_64, 
                style: style_qt_relations_64,
                popuplayertitle: 'qt_relations',
                interactive: true,
    title: 'qt_relations<br />\
    <img src="styles/legend/qt_relations_64_0.png" /> component_supplier_for<br />\
    <img src="styles/legend/qt_relations_64_1.png" /> hosts<br />\
    <img src="styles/legend/qt_relations_64_2.png" /> hosts_or_operates<br />\
    <img src="styles/legend/qt_relations_64_3.png" /> supplier_of<br />\
    <img src="styles/legend/qt_relations_64_4.png" /> <br />' });
var format_qt_infrastructures_65 = new ol.format.GeoJSON();
var features_qt_infrastructures_65 = format_qt_infrastructures_65.readFeatures(json_qt_infrastructures_65, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_infrastructures_65 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_infrastructures_65.addFeatures(features_qt_infrastructures_65);
var lyr_qt_infrastructures_65 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_infrastructures_65, 
                style: style_qt_infrastructures_65,
                popuplayertitle: 'qt_infrastructures',
                interactive: true,
    title: 'qt_infrastructures<br />\
    <img src="styles/legend/qt_infrastructures_65_0.png" /> 12 - 21,6<br />\
    <img src="styles/legend/qt_infrastructures_65_1.png" /> 21,6 - 24,8<br />\
    <img src="styles/legend/qt_infrastructures_65_2.png" /> 24,8 - 63,2<br />\
    <img src="styles/legend/qt_infrastructures_65_3.png" /> 63,2 - 100<br />\
    <img src="styles/legend/qt_infrastructures_65_4.png" /> 100 - 140<br />' });
var format_qt_actors_66 = new ol.format.GeoJSON();
var features_qt_actors_66 = format_qt_actors_66.readFeatures(json_qt_actors_66, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_qt_actors_66 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_qt_actors_66.addFeatures(features_qt_actors_66);
var lyr_qt_actors_66 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_qt_actors_66, 
                style: style_qt_actors_66,
                popuplayertitle: 'qt_actors',
                interactive: true,
    title: 'qt_actors<br />\
    <img src="styles/legend/qt_actors_66_0.png" /> company<br />\
    <img src="styles/legend/qt_actors_66_1.png" /> european_public_institution<br />\
    <img src="styles/legend/qt_actors_66_2.png" /> european_research_initiative<br />\
    <img src="styles/legend/qt_actors_66_3.png" /> hpc_research_center<br />\
    <img src="styles/legend/qt_actors_66_4.png" /> national_consortium<br />\
    <img src="styles/legend/qt_actors_66_5.png" /> <br />' });
var format_datacenter_67 = new ol.format.GeoJSON();
var features_datacenter_67 = format_datacenter_67.readFeatures(json_datacenter_67, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_datacenter_67 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_datacenter_67.addFeatures(features_datacenter_67);
var lyr_datacenter_67 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_datacenter_67, 
                style: style_datacenter_67,
                popuplayertitle: 'datacenter',
                interactive: true,
                title: '<img src="styles/legend/datacenter_67.png" /> datacenter'
            });
var format_fpga_infrastructures_europe_68 = new ol.format.GeoJSON();
var features_fpga_infrastructures_europe_68 = format_fpga_infrastructures_europe_68.readFeatures(json_fpga_infrastructures_europe_68, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_fpga_infrastructures_europe_68 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_fpga_infrastructures_europe_68.addFeatures(features_fpga_infrastructures_europe_68);
var lyr_fpga_infrastructures_europe_68 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_fpga_infrastructures_europe_68, 
                style: style_fpga_infrastructures_europe_68,
                popuplayertitle: 'fpga_infrastructures_europe',
                interactive: true,
                title: '<img src="styles/legend/fpga_infrastructures_europe_68.png" /> fpga_infrastructures_europe'
            });
var format_cnoteurope_69 = new ol.format.GeoJSON();
var features_cnoteurope_69 = format_cnoteurope_69.readFeatures(json_cnoteurope_69, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnoteurope_69 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnoteurope_69.addFeatures(features_cnoteurope_69);
var lyr_cnoteurope_69 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnoteurope_69, 
                style: style_cnoteurope_69,
                popuplayertitle: 'cnot — europe',
                interactive: true,
                title: '<img src="styles/legend/cnoteurope_69.png" /> cnot — europe'
            });
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_67,lyr_fpga_infrastructures_europe_68,],
                                fold: 'open',
                                title: '01_DATI_INFRASTRUTTURA_DIGITALE'});
var group_quantum = new ol.layer.Group({
                                layers: [lyr_qt_relations_64,lyr_qt_infrastructures_65,lyr_qt_actors_66,],
                                fold: 'open',
                                title: 'quantum'});
var group_AI = new ol.layer.Group({
                                layers: [lyr_ai_relations_61,lyr_ai_factories_62,lyr_ai_actors_63,],
                                fold: 'open',
                                title: 'AI'});
var group_Supercomputer = new ol.layer.Group({
                                layers: [lyr_ai_compute_relations_59,lyr_ai_supercomputers_60,],
                                fold: 'open',
                                title: 'Supercomputer'});
var group_02_ENERGIA = new ol.layer.Group({
                                layers: [lyr_02_uranium_conversion_51,lyr_03_uranium_enrichment_52,lyr_04_fuel_fabrication_53,lyr_05_reprocessing_recycling_54,lyr_06_interim_storage_55,lyr_07_geological_repositories_56,lyr_08_nuclear_research_57,lyr_09_nuclear_power_switzerland_58,],
                                fold: 'open',
                                title: '02_ENERGIA'});
...
lyr_02_uranium_conversion_51.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_03_uranium_enrichment_52.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_04_fuel_fabrication_53.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_05_reprocessing_recycling_54.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_06_interim_storage_55.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_07_geological_repositories_56.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_08_nuclear_research_57.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_09_nuclear_power_switzerland_58.set('fieldAliases', {'id': 'id', 'name': 'name', 'country': 'country', 'category': 'category', 'subtype': 'subtype', 'status': 'status', 'operator': 'operator', 'function': 'function', 'description': 'description', 'source_label': 'source_label', 'source_url': 'source_url', 'coordinate_precision': 'coordinate_precision', });
lyr_ai_compute_relations_59.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_ai_supercomputers_60.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'country': 'country', 'city': 'city', 'host_entity': 'host_entity', 'linked_ai_factory_ids': 'linked_ai_factory_ids', 'linked_ai_factories': 'linked_ai_factories', 'system_role': 'system_role', 'system_class': 'system_class', 'status': 'status', 'sustained_pf': 'sustained_pf', 'peak_pf': 'peak_pf', 'ai_peak_pf': 'ai_peak_pf', 'accelerator_or_gpu': 'accelerator_or_gpu', 'cpu': 'cpu', 'storage': 'storage', 'supplier': 'supplier', 'applications': 'applications', 'source': 'source', 'coordinate_precision': 'coordinate_precision', 'notes': 'notes', });
lyr_ai_relations_61.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_ai_factories_62.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'country': 'country', 'city': 'city', 'factory_type': 'factory_type', 'selection_batch': 'selection_batch', 'host_entity': 'host_entity', 'supercomputer_or_system': 'supercomputer_or_system', 'compute_note': 'compute_note', 'key_sectors': 'key_sectors', 'partner_countries': 'partner_countries', 'antennas': 'antennas', 'services_available_from': 'services_available_from', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_ai_actors_63.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'actor_type': 'actor_type', 'country': 'country', 'city': 'city', 'main_domain': 'main_domain', 'role': 'role', 'related_factories': 'related_factories', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_qt_relations_64.set('fieldAliases', {'id': 'id', 'from_id': 'from_id', 'from_name': 'from_name', 'from_type': 'from_type', 'to_id': 'to_id', 'to_name': 'to_name', 'to_type': 'to_type', 'relation_type': 'relation_type', 'relation_label': 'relation_label', 'source': 'source', 'notes': 'notes', });
lyr_qt_infrastructures_65.set('fieldAliases', {'id': 'id', 'name': 'name', 'host': 'host', 'city': 'city', 'country': 'country', 'technology': 'technology', 'platform': 'platform', 'topology': 'topology', 'qubits': 'qubits', 'supplier': 'supplier', 'hosting_supercomputer': 'hosting_supercomputer', 'power_consumption': 'power_consumption', 'cooling_system': 'cooling_system', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_qt_actors_66.set('fieldAliases', {'id': 'id', 'name': 'name', 'short_name': 'short_name', 'actor_type': 'actor_type', 'city': 'city', 'country': 'country', 'main_domain': 'main_domain', 'platform': 'platform', 'role': 'role', 'developed_what': 'developed_what', 'related_infrastructures': 'related_infrastructures', 'status': 'status', 'coordinate_precision': 'coordinate_precision', 'source': 'source', 'notes': 'notes', });
lyr_datacenter_67.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'company': 'company', 'city': 'city', 'state': 'state', 'country': 'country', 'address': 'address', });
lyr_fpga_infrastructures_europe_68.set('fieldAliases', {'id': 'id', 'site_name': 'site_name', 'city': 'city', 'country': 'country', 'operator': 'operator', 'infra_type': 'infra_type', 'status': 'status', 'location_type': 'location_type', 'access_model': 'access_model', 'fpga_vendor': 'fpga_vendor', 'fpga_model': 'fpga_model', 'fpga_count': 'fpga_count', 'count_known': 'count_known', 'medical_ai': 'medical_ai', 'story_order': 'story_order', 'story_phase': 'story_phase', 'source_url': 'source_url', 'verified_on': 'verified_on', });
lyr_cnoteurope_69.set('fieldAliases', {'fid': 'fid', 'featurecla': 'featurecla', 'scalerank': 'scalerank', 'labelrank': 'labelrank', 'sovereignt': 'sovereignt', 'sov_a3': 'sov_a3', 'adm0_dif': 'adm0_dif', 'level': 'level', 'type': 'type', 'tlc': 'tlc', 'admin': 'admin', 'adm0_a3': 'adm0_a3', 'geou_dif': 'geou_dif', 'geounit': 'geounit', 'gu_a3': 'gu_a3', 'su_dif': 'su_dif', 'subunit': 'subunit', 'su_a3': 'su_a3', 'brk_diff': 'brk_diff', 'name': 'name', 'name_long': 'name_long', 'brk_a3': 'brk_a3', 'brk_name': 'brk_name', 'brk_group': 'brk_group', 'abbrev': 'abbrev', 'postal': 'postal', 'formal_en': 'formal_en', 'formal_fr': 'formal_fr', 'name_ciawf': 'name_ciawf', 'note_adm0': 'note_adm0', 'note_brk': 'note_brk', 'name_sort': 'name_sort', 'name_alt': 'name_alt', 'mapcolor7': 'mapcolor7', 'mapcolor8': 'mapcolor8', 'mapcolor9': 'mapcolor9', 'mapcolor13': 'mapcolor13', 'pop_est': 'pop_est', 'pop_rank': 'pop_rank', 'pop_year': 'pop_year', 'gdp_md': 'gdp_md', 'gdp_year': 'gdp_year', 'economy': 'economy', 'income_grp': 'income_grp', 'fips_10': 'fips_10', 'iso_a2': 'iso_a2', 'iso_a2_eh': 'iso_a2_eh', 'iso_a3': 'iso_a3', 'iso_a3_eh': 'iso_a3_eh', 'iso_n3': 'iso_n3', 'iso_n3_eh': 'iso_n3_eh', 'un_a3': 'un_a3', 'wb_a2': 'wb_a2', 'wb_a3': 'wb_a3', 'woe_id': 'woe_id', 'woe_id_eh': 'woe_id_eh', 'woe_note': 'woe_note', 'adm0_iso': 'adm0_iso', 'adm0_diff': 'adm0_diff', 'adm0_tlc': 'adm0_tlc', 'adm0_a3_us': 'adm0_a3_us', 'adm0_a3_fr': 'adm0_a3_fr', 'adm0_a3_ru': 'adm0_a3_ru', 'adm0_a3_es': 'adm0_a3_es', 'adm0_a3_cn': 'adm0_a3_cn', 'adm0_a3_tw': 'adm0_a3_tw', 'adm0_a3_in': 'adm0_a3_in', 'adm0_a3_np': 'adm0_a3_np', 'adm0_a3_pk': 'adm0_a3_pk', 'adm0_a3_de': 'adm0_a3_de', 'adm0_a3_gb': 'adm0_a3_gb', 'adm0_a3_br': 'adm0_a3_br', 'adm0_a3_il': 'adm0_a3_il', 'adm0_a3_ps': 'adm0_a3_ps', 'adm0_a3_sa': 'adm0_a3_sa', 'adm0_a3_eg': 'adm0_a3_eg', 'adm0_a3_ma': 'adm0_a3_ma', 'adm0_a3_pt': 'adm0_a3_pt', 'adm0_a3_ar': 'adm0_a3_ar', 'adm0_a3_jp': 'adm0_a3_jp', 'adm0_a3_ko': 'adm0_a3_ko', 'adm0_a3_vn': 'adm0_a3_vn', 'adm0_a3_tr': 'adm0_a3_tr', 'adm0_a3_id': 'adm0_a3_id', 'adm0_a3_pl': 'adm0_a3_pl', 'adm0_a3_gr': 'adm0_a3_gr', 'adm0_a3_it': 'adm0_a3_it', 'adm0_a3_nl': 'adm0_a3_nl', 'adm0_a3_se': 'adm0_a3_se', 'adm0_a3_bd': 'adm0_a3_bd', 'adm0_a3_ua': 'adm0_a3_ua', 'adm0_a3_un': 'adm0_a3_un', 'adm0_a3_wb': 'adm0_a3_wb', 'continent': 'continent', 'region_un': 'region_un', 'subregion': 'subregion', 'region_wb': 'region_wb', 'name_len': 'name_len', 'long_len': 'long_len', 'abbrev_len': 'abbrev_len', 'tiny': 'tiny', 'homepart': 'homepart', 'min_zoom': 'min_zoom', 'min_label': 'min_label', 'max_label': 'max_label', 'label_x': 'label_x', 'label_y': 'label_y', 'ne_id': 'ne_id', 'wikidataid': 'wikidataid', 'name_ar': 'name_ar', 'name_bn': 'name_bn', 'name_de': 'name_de', 'name_en': 'name_en', 'name_es': 'name_es', 'name_fa': 'name_fa', 'name_fr': 'name_fr', 'name_el': 'name_el', 'name_he': 'name_he', 'name_hi': 'name_hi', 'name_hu': 'name_hu', 'name_id': 'name_id', 'name_it': 'name_it', 'name_ja': 'name_ja', 'name_ko': 'name_ko', 'name_nl': 'name_nl', 'name_pl': 'name_pl', 'name_pt': 'name_pt', 'name_ru': 'name_ru', 'name_sv': 'name_sv', 'name_tr': 'name_tr', 'name_uk': 'name_uk', 'name_ur': 'name_ur', 'name_vi': 'name_vi', 'name_zh': 'name_zh', 'name_zht': 'name_zht', 'fclass_iso': 'fclass_iso', 'tlc_diff': 'tlc_diff', 'fclass_tlc': 'fclass_tlc', 'fclass_us': 'fclass_us', 'fclass_fr': 'fclass_fr', 'fclass_ru': 'fclass_ru', 'fclass_es': 'fclass_es', 'fclass_cn': 'fclass_cn', 'fclass_tw': 'fclass_tw', 'fclass_in': 'fclass_in', 'fclass_np': 'fclass_np', 'fclass_pk': 'fclass_pk', 'fclass_de': 'fclass_de', 'fclass_gb': 'fclass_gb', 'fclass_br': 'fclass_br', 'fclass_il': 'fclass_il', 'fclass_ps': 'fclass_ps', 'fclass_sa': 'fclass_sa', 'fclass_eg': 'fclass_eg', 'fclass_ma': 'fclass_ma', 'fclass_pt': 'fclass_pt', 'fclass_ar': 'fclass_ar', 'fclass_jp': 'fclass_jp', 'fclass_ko': 'fclass_ko', 'fclass_vn': 'fclass_vn', 'fclass_tr': 'fclass_tr', 'fclass_id': 'fclass_id', 'fclass_pl': 'fclass_pl', 'fclass_gr': 'fclass_gr', 'fclass_it': 'fclass_it', 'fclass_nl': 'fclass_nl', 'fclass_se': 'fclass_se', 'fclass_bd': 'fclass_bd', 'fclass_ua': 'fclass_ua', 'filename': 'filename', });
...
lyr_02_uranium_conversion_51.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_03_uranium_enrichment_52.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_04_fuel_fabrication_53.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_05_reprocessing_recycling_54.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_06_interim_storage_55.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_07_geological_repositories_56.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_08_nuclear_research_57.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_09_nuclear_power_switzerland_58.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'country': 'TextEdit', 'category': 'TextEdit', 'subtype': 'TextEdit', 'status': 'TextEdit', 'operator': 'TextEdit', 'function': 'TextEdit', 'description': 'TextEdit', 'source_label': 'TextEdit', 'source_url': 'TextEdit', 'coordinate_precision': 'TextEdit', });
lyr_ai_compute_relations_59.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
...
lyr_ai_relations_61.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_factories_62.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'factory_type': 'TextEdit', 'selection_batch': 'TextEdit', 'host_entity': 'TextEdit', 'supercomputer_or_system': 'TextEdit', 'compute_note': 'TextEdit', 'key_sectors': 'TextEdit', 'partner_countries': 'TextEdit', 'antennas': 'TextEdit', 'services_available_from': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_ai_actors_63.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'country': 'TextEdit', 'city': 'TextEdit', 'main_domain': 'TextEdit', 'role': 'TextEdit', 'related_factories': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_relations_64.set('fieldImages', {'id': 'TextEdit', 'from_id': 'TextEdit', 'from_name': 'TextEdit', 'from_type': 'TextEdit', 'to_id': 'TextEdit', 'to_name': 'TextEdit', 'to_type': 'TextEdit', 'relation_type': 'TextEdit', 'relation_label': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_infrastructures_65.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'host': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'technology': 'TextEdit', 'platform': 'TextEdit', 'topology': 'TextEdit', 'qubits': 'Range', 'supplier': 'TextEdit', 'hosting_supercomputer': 'TextEdit', 'power_consumption': 'TextEdit', 'cooling_system': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_qt_actors_66.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'short_name': 'TextEdit', 'actor_type': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'main_domain': 'TextEdit', 'platform': 'TextEdit', 'role': 'TextEdit', 'developed_what': 'TextEdit', 'related_infrastructures': 'TextEdit', 'status': 'TextEdit', 'coordinate_precision': 'TextEdit', 'source': 'TextEdit', 'notes': 'TextEdit', });
lyr_datacenter_67.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', 'company': 'TextEdit', 'city': 'TextEdit', 'state': 'TextEdit', 'country': 'TextEdit', 'address': 'TextEdit', });
lyr_fpga_infrastructures_europe_68.set('fieldImages', {'id': 'TextEdit', 'site_name': 'TextEdit', 'city': 'TextEdit', 'country': 'TextEdit', 'operator': 'TextEdit', 'infra_type': 'TextEdit', 'status': 'TextEdit', 'location_type': 'TextEdit', 'access_model': 'TextEdit', 'fpga_vendor': 'TextEdit', 'fpga_model': 'TextEdit', 'fpga_count': 'Range', 'count_known': 'CheckBox', 'medical_ai': 'TextEdit', 'story_order': 'Range', 'story_phase': 'TextEdit', 'source_url': 'TextEdit', 'verified_on': 'DateTime', });
lyr_cnoteurope_69.set('fieldImages', {'fid': 'TextEdit', 'featurecla': 'TextEdit', 'scalerank': 'Range', 'labelrank': 'Range', 'sovereignt': 'TextEdit', 'sov_a3': 'TextEdit', 'adm0_dif': 'Range', 'level': 'Range', 'type': 'TextEdit', 'tlc': 'TextEdit', 'admin': 'TextEdit', 'adm0_a3': 'TextEdit', 'geou_dif': 'Range', 'geounit': 'TextEdit', 'gu_a3': 'TextEdit', 'su_dif': 'Range', 'subunit': 'TextEdit', 'su_a3': 'TextEdit', 'brk_diff': 'Range', 'name': 'TextEdit', 'name_long': 'TextEdit', 'brk_a3': 'TextEdit', 'brk_name': 'TextEdit', 'brk_group': 'TextEdit', 'abbrev': 'TextEdit', 'postal': 'TextEdit', 'formal_en': 'TextEdit', 'formal_fr': 'TextEdit', 'name_ciawf': 'TextEdit', 'note_adm0': 'TextEdit', 'note_brk': 'TextEdit', 'name_sort': 'TextEdit', 'name_alt': 'TextEdit', 'mapcolor7': 'Range', 'mapcolor8': 'Range', 'mapcolor9': 'Range', 'mapcolor13': 'Range', 'pop_est': 'Range', 'pop_rank': 'Range', 'pop_year': 'Range', 'gdp_md': 'Range', 'gdp_year': 'Range', 'economy': 'TextEdit', 'income_grp': 'TextEdit', 'fips_10': 'TextEdit', 'iso_a2': 'TextEdit', 'iso_a2_eh': 'TextEdit', 'iso_a3': 'TextEdit', 'iso_a3_eh': 'TextEdit', 'iso_n3': 'TextEdit', 'iso_n3_eh': 'TextEdit', 'un_a3': 'TextEdit', 'wb_a2': 'TextEdit', 'wb_a3': 'TextEdit', 'woe_id': 'Range', 'woe_id_eh': 'Range', 'woe_note': 'TextEdit', 'adm0_iso': 'TextEdit', 'adm0_diff': 'TextEdit', 'adm0_tlc': 'TextEdit', 'adm0_a3_us': 'TextEdit', 'adm0_a3_fr': 'TextEdit', 'adm0_a3_ru': 'TextEdit', 'adm0_a3_es': 'TextEdit', 'adm0_a3_cn': 'TextEdit', 'adm0_a3_tw': 'TextEdit', 'adm0_a3_in': 'TextEdit', 'adm0_a3_np': 'TextEdit', 'adm0_a3_pk': 'TextEdit', 'adm0_a3_de': 'TextEdit', 'adm0_a3_gb': 'TextEdit', 'adm0_a3_br': 'TextEdit', 'adm0_a3_il': 'TextEdit', 'adm0_a3_ps': 'TextEdit', 'adm0_a3_sa': 'TextEdit', 'adm0_a3_eg': 'TextEdit', 'adm0_a3_ma': 'TextEdit', 'adm0_a3_pt': 'TextEdit', 'adm0_a3_ar': 'TextEdit', 'adm0_a3_jp': 'TextEdit', 'adm0_a3_ko': 'TextEdit', 'adm0_a3_vn': 'TextEdit', 'adm0_a3_tr': 'TextEdit', 'adm0_a3_id': 'TextEdit', 'adm0_a3_pl': 'TextEdit', 'adm0_a3_gr': 'TextEdit', 'adm0_a3_it': 'TextEdit', 'adm0_a3_nl': 'TextEdit', 'adm0_a3_se': 'TextEdit', 'adm0_a3_bd': 'TextEdit', 'adm0_a3_ua': 'TextEdit', 'adm0_a3_un': 'Range', 'adm0_a3_wb': 'Range', 'continent': 'TextEdit', 'region_un': 'TextEdit', 'subregion': 'TextEdit', 'region_wb': 'TextEdit', 'name_len': 'Range', 'long_len': 'Range', 'abbrev_len': 'Range', 'tiny': 'Range', 'homepart': 'Range', 'min_zoom': 'Range', 'min_label': 'TextEdit', 'max_label': 'TextEdit', 'label_x': 'TextEdit', 'label_y': 'TextEdit', 'ne_id': 'Range', 'wikidataid': 'TextEdit', 'name_ar': 'TextEdit', 'name_bn': 'TextEdit', 'name_de': 'TextEdit', 'name_en': 'TextEdit', 'name_es': 'TextEdit', 'name_fa': 'TextEdit', 'name_fr': 'TextEdit', 'name_el': 'TextEdit', 'name_he': 'TextEdit', 'name_hi': 'TextEdit', 'name_hu': 'TextEdit', 'name_id': 'TextEdit', 'name_it': 'TextEdit', 'name_ja': 'TextEdit', 'name_ko': 'TextEdit', 'name_nl': 'TextEdit', 'name_pl': 'TextEdit', 'name_pt': 'TextEdit', 'name_ru': 'TextEdit', 'name_sv': 'TextEdit', 'name_tr': 'TextEdit', 'name_uk': 'TextEdit', 'name_ur': 'TextEdit', 'name_vi': 'TextEdit', 'name_zh': 'TextEdit', 'name_zht': 'TextEdit', 'fclass_iso': 'TextEdit', 'tlc_diff': 'TextEdit', 'fclass_tlc': 'TextEdit', 'fclass_us': 'TextEdit', 'fclass_fr': 'TextEdit', 'fclass_ru': 'TextEdit', 'fclass_es': 'TextEdit', 'fclass_cn': 'TextEdit', 'fclass_tw': 'TextEdit', 'fclass_in': 'TextEdit', 'fclass_np': 'TextEdit', 'fclass_pk': 'TextEdit', 'fclass_de': 'TextEdit', 'fclass_gb': 'TextEdit', 'fclass_br': 'TextEdit', 'fclass_il': 'TextEdit', 'fclass_ps': 'TextEdit', 'fclass_sa': 'TextEdit', 'fclass_eg': 'TextEdit', 'fclass_ma': 'TextEdit', 'fclass_pt': 'TextEdit', 'fclass_ar': 'TextEdit', 'fclass_jp': 'TextEdit', 'fclass_ko': 'TextEdit', 'fclass_vn': 'TextEdit', 'fclass_tr': 'TextEdit', 'fclass_id': 'TextEdit', 'fclass_pl': 'TextEdit', 'fclass_gr': 'TextEdit', 'fclass_it': 'TextEdit', 'fclass_nl': 'TextEdit', 'fclass_se': 'TextEdit', 'fclass_bd': 'TextEdit', 'fclass_ua': 'TextEdit', 'filename': 'TextEdit', });
...
lyr_02_uranium_conversion_51.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_03_uranium_enrichment_52.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_04_fuel_fabrication_53.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_05_reprocessing_recycling_54.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_06_interim_storage_55.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_07_geological_repositories_56.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_08_nuclear_research_57.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_09_nuclear_power_switzerland_58.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'country': 'no label', 'category': 'no label', 'subtype': 'no label', 'status': 'no label', 'operator': 'no label', 'function': 'no label', 'description': 'no label', 'source_label': 'no label', 'source_url': 'no label', 'coordinate_precision': 'no label', });
lyr_ai_compute_relations_59.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
...
lyr_ai_relations_61.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_factories_62.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'country': 'no label', 'city': 'no label', 'factory_type': 'no label', 'selection_batch': 'no label', 'host_entity': 'no label', 'supercomputer_or_system': 'no label', 'compute_note': 'no label', 'key_sectors': 'no label', 'partner_countries': 'no label', 'antennas': 'no label', 'services_available_from': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_ai_actors_63.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'country': 'no label', 'city': 'no label', 'main_domain': 'no label', 'role': 'no label', 'related_factories': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_relations_64.set('fieldLabels', {'id': 'no label', 'from_id': 'no label', 'from_name': 'no label', 'from_type': 'no label', 'to_id': 'no label', 'to_name': 'no label', 'to_type': 'no label', 'relation_type': 'no label', 'relation_label': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_infrastructures_65.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'host': 'no label', 'city': 'no label', 'country': 'no label', 'technology': 'no label', 'platform': 'no label', 'topology': 'no label', 'qubits': 'no label', 'supplier': 'no label', 'hosting_supercomputer': 'no label', 'power_consumption': 'no label', 'cooling_system': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_qt_actors_66.set('fieldLabels', {'id': 'no label', 'name': 'no label', 'short_name': 'no label', 'actor_type': 'no label', 'city': 'no label', 'country': 'no label', 'main_domain': 'no label', 'platform': 'no label', 'role': 'no label', 'developed_what': 'no label', 'related_infrastructures': 'no label', 'status': 'no label', 'coordinate_precision': 'no label', 'source': 'no label', 'notes': 'no label', });
lyr_datacenter_67.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'company': 'no label', 'city': 'no label', 'state': 'no label', 'country': 'no label', 'address': 'no label', });
lyr_fpga_infrastructures_europe_68.set('fieldLabels', {'id': 'no label', 'site_name': 'no label', 'city': 'no label', 'country': 'no label', 'operator': 'no label', 'infra_type': 'no label', 'status': 'no label', 'location_type': 'no label', 'access_model': 'no label', 'fpga_vendor': 'no label', 'fpga_model': 'no label', 'fpga_count': 'no label', 'count_known': 'no label', 'medical_ai': 'no label', 'story_order': 'no label', 'story_phase': 'no label', 'source_url': 'no label', 'verified_on': 'no label', });
lyr_cnoteurope_69.set('fieldLabels', {'fid': 'no label', 'featurecla': 'no label', 'scalerank': 'no label', 'labelrank': 'no label', 'sovereignt': 'no label', 'sov_a3': 'no label', 'adm0_dif': 'no label', 'level': 'no label', 'type': 'no label', 'tlc': 'no label', 'admin': 'no label', 'adm0_a3': 'no label', 'geou_dif': 'no label', 'geounit': 'no label', 'gu_a3': 'no label', 'su_dif': 'no label', 'subunit': 'no label', 'su_a3': 'no label', 'brk_diff': 'no label', 'name': 'no label', 'name_long': 'no label', 'brk_a3': 'no label', 'brk_name': 'no label', 'brk_group': 'no label', 'abbrev': 'no label', 'postal': 'no label', 'formal_en': 'no label', 'formal_fr': 'no label', 'name_ciawf': 'no label', 'note_adm0': 'no label', 'note_brk': 'no label', 'name_sort': 'no label', 'name_alt': 'no label', 'mapcolor7': 'no label', 'mapcolor8': 'no label', 'mapcolor9': 'no label', 'mapcolor13': 'no label', 'pop_est': 'no label', 'pop_rank': 'no label', 'pop_year': 'no label', 'gdp_md': 'no label', 'gdp_year': 'no label', 'economy': 'no label', 'income_grp': 'no label', 'fips_10': 'no label', 'iso_a2': 'no label', 'iso_a2_eh': 'no label', 'iso_a3': 'no label', 'iso_a3_eh': 'no label', 'iso_n3': 'no label', 'iso_n3_eh': 'no label', 'un_a3': 'no label', 'wb_a2': 'no label', 'wb_a3': 'no label', 'woe_id': 'no label', 'woe_id_eh': 'no label', 'woe_note': 'no label', 'adm0_iso': 'no label', 'adm0_diff': 'no label', 'adm0_tlc': 'no label', 'adm0_a3_us': 'no label', 'adm0_a3_fr': 'no label', 'adm0_a3_ru': 'no label', 'adm0_a3_es': 'no label', 'adm0_a3_cn': 'no label', 'adm0_a3_tw': 'no label', 'adm0_a3_in': 'no label', 'adm0_a3_np': 'no label', 'adm0_a3_pk': 'no label', 'adm0_a3_de': 'no label', 'adm0_a3_gb': 'no label', 'adm0_a3_br': 'no label', 'adm0_a3_il': 'no label', 'adm0_a3_ps': 'no label', 'adm0_a3_sa': 'no label', 'adm0_a3_eg': 'no label', 'adm0_a3_ma': 'no label', 'adm0_a3_pt': 'no label', 'adm0_a3_ar': 'no label', 'adm0_a3_jp': 'no label', 'adm0_a3_ko': 'no label', 'adm0_a3_vn': 'no label', 'adm0_a3_tr': 'no label', 'adm0_a3_id': 'no label', 'adm0_a3_pl': 'no label', 'adm0_a3_gr': 'no label', 'adm0_a3_it': 'no label', 'adm0_a3_nl': 'no label', 'adm0_a3_se': 'no label', 'adm0_a3_bd': 'no label', 'adm0_a3_ua': 'no label', 'adm0_a3_un': 'no label', 'adm0_a3_wb': 'no label', 'continent': 'no label', 'region_un': 'no label', 'subregion': 'no label', 'region_wb': 'no label', 'name_len': 'no label', 'long_len': 'no label', 'abbrev_len': 'no label', 'tiny': 'no label', 'homepart': 'no label', 'min_zoom': 'no label', 'min_label': 'no label', 'max_label': 'no label', 'label_x': 'no label', 'label_y': 'no label', 'ne_id': 'no label', 'wikidataid': 'no label', 'name_ar': 'no label', 'name_bn': 'no label', 'name_de': 'no label', 'name_en': 'no label', 'name_es': 'no label', 'name_fa': 'no label', 'name_fr': 'no label', 'name_el': 'no label', 'name_he': 'no label', 'name_hi': 'no label', 'name_hu': 'no label', 'name_id': 'no label', 'name_it': 'no label', 'name_ja': 'no label', 'name_ko': 'no label', 'name_nl': 'no label', 'name_pl': 'no label', 'name_pt': 'no label', 'name_ru': 'no label', 'name_sv': 'no label', 'name_tr': 'no label', 'name_uk': 'no label', 'name_ur': 'no label', 'name_vi': 'no label', 'name_zh': 'no label', 'name_zht': 'no label', 'fclass_iso': 'no label', 'tlc_diff': 'no label', 'fclass_tlc': 'no label', 'fclass_us': 'no label', 'fclass_fr': 'no label', 'fclass_ru': 'no label', 'fclass_es': 'no label', 'fclass_cn': 'no label', 'fclass_tw': 'no label', 'fclass_in': 'no label', 'fclass_np': 'no label', 'fclass_pk': 'no label', 'fclass_de': 'no label', 'fclass_gb': 'no label', 'fclass_br': 'no label', 'fclass_il': 'no label', 'fclass_ps': 'no label', 'fclass_sa': 'no label', 'fclass_eg': 'no label', 'fclass_ma': 'no label', 'fclass_pt': 'no label', 'fclass_ar': 'no label', 'fclass_jp': 'no label', 'fclass_ko': 'no label', 'fclass_vn': 'no label', 'fclass_tr': 'no label', 'fclass_id': 'no label', 'fclass_pl': 'no label', 'fclass_gr': 'no label', 'fclass_it': 'no label', 'fclass_nl': 'no label', 'fclass_se': 'no label', 'fclass_bd': 'no label', 'fclass_ua': 'no label', 'filename': 'no label', });
lyr_cnoteurope_69.on('precompose', function(evt) {
