var size = 0;
var placement = 'point';
function categories_qt_relations_64(feature, value, size, resolution, labelText,
...
var style_qt_relations_64 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_qt_relations_64(feature, value, size, resolution, labelText,
