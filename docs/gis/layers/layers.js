...
var format_cnotscuole_3 = new ol.format.GeoJSON();
var features_cnotscuole_3 = format_cnotscuole_3.readFeatures(json_cnotscuole_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotscuole_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotscuole_3.addFeatures(features_cnotscuole_3);
var lyr_cnotscuole_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotscuole_3, 
                style: style_cnotscuole_3,
                popuplayertitle: 'cnot — scuole',
                interactive: true,
                title: '<img src="styles/legend/cnotscuole_3.png" /> cnot — scuole'
            });
var format_convitto_base_localConvittoCardinalMoraesempiobase_4 = new ol.format.GeoJSON();
var features_convitto_base_localConvittoCardinalMoraesempiobase_4 = format_convitto_base_localConvittoCardinalMoraesempiobase_4.readFeatures(json_convitto_base_localConvittoCardinalMoraesempiobase_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_4.addFeatures(features_convitto_base_localConvittoCardinalMoraesempiobase_4);
var lyr_convitto_base_localConvittoCardinalMoraesempiobase_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_convitto_base_localConvittoCardinalMoraesempiobase_4, 
                style: style_convitto_base_localConvittoCardinalMoraesempiobase_4,
                popuplayertitle: 'convitto_base_local — Convitto Cardinal Mora - esempio base',
                interactive: true,
                title: '<img src="styles/legend/convitto_base_localConvittoCardinalMoraesempiobase_4.png" /> convitto_base_local — Convitto Cardinal Mora - esempio base'
            });
...
var format_cnotstrade_1_6 = new ol.format.GeoJSON();
var features_cnotstrade_1_6 = format_cnotstrade_1_6.readFeatures(json_cnotstrade_1_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_1_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_1_6.addFeatures(features_cnotstrade_1_6);
var lyr_cnotstrade_1_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_1_6, 
                style: style_cnotstrade_1_6,
                popuplayertitle: 'cnot — strade_1',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_1_6.png" /> cnot — strade_1'
            });
var format_cnotbuilding_7 = new ol.format.GeoJSON();
var features_cnotbuilding_7 = format_cnotbuilding_7.readFeatures(json_cnotbuilding_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotbuilding_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotbuilding_7.addFeatures(features_cnotbuilding_7);
var lyr_cnotbuilding_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotbuilding_7, 
                style: style_cnotbuilding_7,
                popuplayertitle: 'cnot — building',
                interactive: true,
                title: '<img src="styles/legend/cnotbuilding_7.png" /> cnot — building'
            });
var format_cnotstrade_2_8 = new ol.format.GeoJSON();
var features_cnotstrade_2_8 = format_cnotstrade_2_8.readFeatures(json_cnotstrade_2_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotstrade_2_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotstrade_2_8.addFeatures(features_cnotstrade_2_8);
var lyr_cnotstrade_2_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotstrade_2_8, 
                style: style_cnotstrade_2_8,
                popuplayertitle: 'cnot — strade_2',
                interactive: true,
                title: '<img src="styles/legend/cnotstrade_2_8.png" /> cnot — strade_2'
            });
var format_cnotEdifici_9 = new ol.format.GeoJSON();
var features_cnotEdifici_9 = format_cnotEdifici_9.readFeatures(json_cnotEdifici_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotEdifici_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotEdifici_9.addFeatures(features_cnotEdifici_9);
var lyr_cnotEdifici_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotEdifici_9, 
                style: style_cnotEdifici_9,
                popuplayertitle: 'cnot — Edifici',
                interactive: true,
                title: '<img src="styles/legend/cnotEdifici_9.png" /> cnot — Edifici'
            });
var format_Telecamere_10 = new ol.format.GeoJSON();
var features_Telecamere_10 = format_Telecamere_10.readFeatures(json_Telecamere_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Telecamere_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Telecamere_10.addFeatures(features_Telecamere_10);
var lyr_Telecamere_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Telecamere_10, 
                style: style_Telecamere_10,
                popuplayertitle: 'Telecamere',
                interactive: true,
                title: '<img src="styles/legend/Telecamere_10.png" /> Telecamere'
            });
var format_Semafori_11 = new ol.format.GeoJSON();
var features_Semafori_11 = format_Semafori_11.readFeatures(json_Semafori_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Semafori_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Semafori_11.addFeatures(features_Semafori_11);
var lyr_Semafori_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Semafori_11, 
                style: style_Semafori_11,
                popuplayertitle: 'Semafori',
                interactive: true,
                title: '<img src="styles/legend/Semafori_11.png" /> Semafori'
            });
var format_cnotTinyhouses_12 = new ol.format.GeoJSON();
var features_cnotTinyhouses_12 = format_cnotTinyhouses_12.readFeatures(json_cnotTinyhouses_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotTinyhouses_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotTinyhouses_12.addFeatures(features_cnotTinyhouses_12);
var lyr_cnotTinyhouses_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotTinyhouses_12, 
                style: style_cnotTinyhouses_12,
                popuplayertitle: 'cnot — Tiny houses',
                interactive: true,
                title: '<img src="styles/legend/cnotTinyhouses_12.png" /> cnot — Tiny houses'
            });
var format_cnotparcheggiodroni_13 = new ol.format.GeoJSON();
var features_cnotparcheggiodroni_13 = format_cnotparcheggiodroni_13.readFeatures(json_cnotparcheggiodroni_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnotparcheggiodroni_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnotparcheggiodroni_13.addFeatures(features_cnotparcheggiodroni_13);
var lyr_cnotparcheggiodroni_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnotparcheggiodroni_13, 
                style: style_cnotparcheggiodroni_13,
                popuplayertitle: 'cnot — parcheggio droni',
                interactive: true,
                title: '<img src="styles/legend/cnotparcheggiodroni_13.png" /> cnot — parcheggio droni'
            });
var format_datacenter_14 = new ol.format.GeoJSON();
var features_datacenter_14 = format_datacenter_14.readFeatures(json_datacenter_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_datacenter_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_datacenter_14.addFeatures(features_datacenter_14);
var lyr_datacenter_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_datacenter_14, 
                style: style_datacenter_14,
                popuplayertitle: 'datacenter',
                interactive: true,
                title: '<img src="styles/legend/datacenter_14.png" /> datacenter'
            });
var format_cnoteurope_15 = new ol.format.GeoJSON();
var features_cnoteurope_15 = format_cnoteurope_15.readFeatures(json_cnoteurope_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cnoteurope_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cnoteurope_15.addFeatures(features_cnoteurope_15);
var lyr_cnoteurope_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cnoteurope_15, 
                style: style_cnoteurope_15,
                popuplayertitle: 'cnot — europe',
                interactive: true,
                title: '<img src="styles/legend/cnoteurope_15.png" /> cnot — europe'
            });
var group_01_DATI_INFRASTRUTTURA_DIGITALE = new ol.layer.Group({
                                layers: [lyr_datacenter_14,],
                                fold: 'open',
...
var group_tinyhouses = new ol.layer.Group({
                                layers: [lyr_cnotTinyhouses_12,lyr_cnotparcheggiodroni_13,],
                                fold: 'open',
                                title: 'tiny houses'});
var group_Sorveglianza = new ol.layer.Group({
                                layers: [lyr_Telecamere_10,lyr_Semafori_11,],
                                fold: 'open',
                                title: 'Sorveglianza'});
var group_Zonadimenticata = new ol.layer.Group({
                                layers: [lyr_cnotEdifici_9,],
                                fold: 'open',
                                title: 'Zona dimenticata'});
var group_Topografia = new ol.layer.Group({
                                layers: [lyr_cnotstrade_1_6,lyr_cnotbuilding_7,lyr_cnotstrade_2_8,],
                                fold: 'open',
                                title: 'Topografia'});
var group_Strutture_dismesse = new ol.layer.Group({
                                layers: [lyr_cnotscuole_3,lyr_convitto_base_localConvittoCardinalMoraesempiobase_4,lyr_convitto_base_localConvittoCardinalMoraesempiobase_5,],
                                fold: 'open',
                                title: 'Strutture_dismesse'});
var group_Narrativa = new ol.layer.Group({
                                layers: [lyr_building_2,],
                                fold: 'open',
                                title: 'Narrativa'});
var group_TimelineCNOT17 = new ol.layer.Group({
                                layers: [lyr_legacy_infrastructure_2050_0,lyr_cnot17_events_1,],
                                fold: 'open',
                                title: 'Timeline CNOT 1.7'});

lyr_legacy_infrastructure_2050_0.setVisible(true);lyr_cnot17_events_1.setVisible(true);lyr_building_2.setVisible(true);lyr_cnotscuole_3.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_4.setVisible(true);lyr_convitto_base_localConvittoCardinalMoraesempiobase_5.setVisible(true);lyr_cnotstrade_1_6.setVisible(true);lyr_cnotbuilding_7.setVisible(true);lyr_cnotstrade_2_8.setVisible(true);lyr_cnotEdifici_9.setVisible(true);lyr_Telecamere_10.setVisible(true);lyr_Semafori_11.setVisible(true);lyr_cnotTinyhouses_12.setVisible(true);lyr_cnotparcheggiodroni_13.setVisible(true);lyr_datacenter_14.setVisible(true);lyr_cnoteurope_15.setVisible(true);
var layersList = [group_TimelineCNOT17,group_Narrativa,group_Strutture_dismesse,group_Topografia,group_Zonadimenticata,group_Sorveglianza,group_tinyhouses,group_01_DATI_INFRASTRUTTURA_DIGITALE,lyr_cnoteurope_15];
...
lyr_cnot17_events_1.set('fieldAliases', {'fid': 'fid', 'event_id': 'event_id', 'titolo': 'titolo', 'timestamp_story': 'timestamp_story', 'capitolo': 'capitolo', 'luogo': 'luogo', 'personaggi': 'personaggi', 'tipo_evento': 'tipo_evento', 'oggetto_coinvolto': 'oggetto_coinvolto', 'stato_prima': 'stato_prima', 'stato_dopo': 'stato_dopo', 'conseguenza': 'conseguenza', 'visibile_al_lettore': 'visibile_al_lettore', 'note': 'note', });
...
lyr_cnotEdifici_9.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'building': 'building', 'religion': 'religion', 'denomination': 'denomination', 'amenity': 'amenity', 'name': 'name', });
lyr_Telecamere_10.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'note': 'note', });
...
lyr_cnot17_events_1.set('fieldLabels', {'fid': 'no label', 'event_id': 'no label', 'titolo': 'no label', 'timestamp_story': 'no label', 'capitolo': 'no label', 'luogo': 'no label', 'personaggi': 'no label', 'tipo_evento': 'no label', 'oggetto_coinvolto': 'no label', 'stato_prima': 'no label', 'stato_dopo': 'no label', 'conseguenza': 'no label', 'visibile_al_lettore': 'no label', 'note': 'no label', });
lyr_building_2.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'building': 'no label', 'layer': 'no label', 'tower:type': 'no label', 'tower:construction': 'no label', 'man_made': 'no label', 'roof:shape': 'no label', 'start_date': 'no label', 'shop': 'no label', 'operator': 'no label', 'brand:wikipedia': 'no label', 'brand:wikidata': 'no label', 'brand': 'no label', 'addr:street': 'no label', 'addr:housenumber': 'no label', 'addr:city': 'no label', 'leisure': 'no label', 'wikipedia': 'no label', 'wikidata': 'no label', 'roof:material': 'no label', 'religion': 'no label', 'historic': 'no label', 'denomination': 'no label', 'building:material': 'no label', 'name': 'no label', 'amenity': 'no label', 'building:levels': 'no label', 'height': 'no label', 'type': 'no label', });
lyr_cnotscuole_3.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'amenity': 'no label', 'roof:colour': 'no label', 'addr:housename': 'no label', 'barrier': 'no label', 'religion': 'no label', 'grades': 'no label', 'wheelchair': 'no label', 'toilets:wheelchair': 'no label', 'name_1': 'no label', 'website': 'no label', 'roof:levels': 'no label', 'addr:postcode': 'no label', 'isced:level': 'no label', 'addr:hamlet': 'no label', 'addr:street': 'no label', 'addr:housenumber': 'no label', 'addr:city': 'no label', 'name:etymology:wikidata': 'no label', 'wikidata': 'no label', 'roof:shape': 'no label', 'roof:material': 'no label', 'operator:type': 'no label', 'height': 'no label', 'building:material': 'no label', 'building:levels': 'no label', 'type': 'no label', 'name': 'no label', 'education': 'no label', 'building': 'no label', });
lyr_convitto_base_localConvittoCardinalMoraesempiobase_4.set('fieldLabels', {'nome': 'no label', 'tipo': 'no label', 'piano': 'no label', 'funzione': 'no label', 'spatial_url': 'no label', 'url_label': 'no label', 'note': 'no label', });
