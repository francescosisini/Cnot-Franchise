...
#Muro 1
##base
voxels += generate_rectangle((0, 0, 0), (1, 0, 0), (0, 0, 1), 80,3 , "222222")

voxels += generate_rectangle((0, 0, 3), (1, 0, 0), (0, 0, 1), 4,5 , "222222")
voxels += generate_rectangle((6, 0, 3), (1, 0, 0), (0, 0, 1), 9,5 , "222222")
voxels += generate_rectangle((12, 0, 3), (1, 0, 0), (0, 0, 1), 7,5 , "222222")
voxels += generate_rectangle((21, 0, 3), (1, 0, 0), (0, 0, 1), 9,5 , "222222")
voxels += generate_rectangle((26, 0, 3), (1, 0, 0), (0, 0, 1), 9,5 , "222222")
voxels += generate_rectangle((37, 0, 3), (1, 0, 0), (0, 0, 1), 9,5 , "222222")
voxels += generate_rectangle((46, 0, 3), (1, 0, 0), (0, 0, 1), 9,5 , "222222")
voxels += generate_rectangle((57, 0, 3), (1, 0, 0), (0, 0, 1), 7,5 , "222222")
voxels += generate_rectangle((66, 0, 3), (1, 0, 0), (0, 0, 1), 8,5 , "222222")
voxels += generate_rectangle((76, 0, 3), (1, 0, 0), (0, 0, 1), 4,5 , "222222")
#voxels += generate_line((0, 0, 1), (1, 0, 0), 22, "ffffaa")

voxels += generate_rectangle((0, 0, 8), (1, 0, 0), (0, 0, 1), 80,2 , "222222")
