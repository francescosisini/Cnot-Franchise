...
#Muro 1
##base
voxels += generate_rectangle((24, 36, 0), (1, 0, 0), (0, 0, 1), 6,10 , "007700")
voxels += generate_rectangle((32, 36, 0), (1, 0, 0), (0, 0, 1), 2,10 , "007700")
voxels += generate_rectangle((24, 36, 7), (1, 0, 0), (0, 0, 1), 10,3 , "007700")

# salva il file
output_file = "muro_b1.txt"
