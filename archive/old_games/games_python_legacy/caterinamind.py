...
MIN_NODE_DISTANCE = 120  # distanza minima tra nodi
...
arrow_colors = {
    pygame.K_1: (170, 0, 255),  # viola
    pygame.K_2: (0, 255, 0),         # Verde
    pygame.K_3: (255, 0, 102),    # Giallo
    pygame.K_4: (255, 255, 255)    # Bianco
}
...
def draw_legend(surface):
    ...
    title = font.render("Usa:", True, TEXT_COLOR)
    surface.blit(title, (20, 70))
    legend_items = [
    ...
    for i, (direction, color) in enumerate(legend_items):
        ...
        surface.blit(item_text, (20, 100 + i * 40))
...
#}
arrow_mapping = {
    pygame.K_1: 0,  # Tasto "1"
    pygame.K_2: 1,  # Tasto "2"
    pygame.K_3: 2,  # Tasto "3"
    pygame.K_4: 3   # Tasto "4"
}
