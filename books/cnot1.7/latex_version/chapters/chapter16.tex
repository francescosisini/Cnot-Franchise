...
\par\medskip
«Cosa hai trovato Laura?» Caterina prova a stare al gioco, ma la voce tradisce l'emozione, ha paura di non farcela, di non riuscire a partire, anche se forse ora è attratta anche  da quello che potrebbe trovare restando.\\
...
Prima che Laura possa continuare un led si accende sulla  cornice del monitor di fianco all'apertura ottica della telecamera. Si fa' seria un attimo, ma non dice nulla. Apre un secondo terminale e verifica i dispositivi connessi. Un sorriso, un comando. Invio.
\\
...
Sul monitor della polizia si compone lentamente una figura, byte a byte.\\
«Ci siamo! Sembrano più di una persona!»
L'immagine mostra due persone, forse due hacker mascherati, sembrano indossare vestiti degli stessi colori. La definizione non è ancora buona, ma ogni pochi secondi
emergono più dettagli. I due  hanno camice uguali, sembrano divise: «Sono due sembrano agenti, ma? Accidenti... Addio premio di produzione. Io chiudo capo.»
