...
\title{Cnot}
\author{Eiren Lysias \& Laura Sisini}
\date{\today}
...
\include{chapters/dichiarazione_ai_act}
\include{chapters/nota_secondaedizione}
...
\input{chapters/capitolo9}

\chapter{Ritorno alla Realtà}
\input{chapters/capitolo10}

\chapter{Fine?}
\input{chapters/capitolo11}
...
%\chapter{Timeline}
%\input{chapters/timeline1}
%\input{chapters/timeline2}
%\input{chapters/timeline3}
%\input{chapters/timeline4}
%\input{chapters/timeline5}
%\input{chapters/timeline6}
%\input{chapters/timeline7}
%\input{chapters/timeline8}
%\input{chapters/timeline9}
%\input{chapters/timeline10}
